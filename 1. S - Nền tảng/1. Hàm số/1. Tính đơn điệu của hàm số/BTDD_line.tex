...
\questionLinesManual{5}{2}{Cho hàm số \( y = f(x) \) có bảng xét dấu đạo hàm như sau:
\begin{center}
\begin{tikzpicture}
...
\questionLinesManual{5}{3}{Cho hàm số \( y = f(x) \) có đồ thị là đường cong hình bên. Hàm số đã cho đồng biến trên khoảng nào dưới đây?
\begin{center}
...
\questionLinesManual{5}{4}{Cho hàm số \( f(x) \) liên tục trên \( \mathbb{R} \) và có đồ thị như hình vẽ bên. Khẳng định nào sau đây là đúng?
\begin{center}
\begin{tikzpicture}[>=latex, scale=1]
    % Hệ trục tọa độ
    \draw[->] (-2.5,0) -- (2.5,0) node[below] {\small $x$};
...
\questionLinesManual{5}{5}{Cho hàm số \( y = x^3 - 3x^2 \). Mệnh đề nào dưới đây đúng?
...
\questionLinesManual{5}{6}{Cho hàm số \( y = f(x) \) có đạo hàm \( f'(x) = x^2 + 1 \), \( \forall x \in \mathbb{R} \). Mệnh đề nào dưới đây đúng?}{%
\begin{tasks}(2)
...
\questionLinesManual{5}{7}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \) và có đạo hàm  
\( f'(x) = (1 - x)^2 (x + 1)^3 (3 - x). \)  
...
\questionLinesManual{5}{8}{Cho hàm số \( y = f(x) \) có đạo hàm \( f'(x) = x(x - 2)^3 \), với mọi \( x \in \mathbb{R} \). Hàm số đã cho nghịch biến trên khoảng nào dưới đây?}{%
\begin{tasks}(4)
\task \((1; 3)\)
\task \((-1; 0)\)
\task \((0; 1)\)
...
\questionLinesManual{5}{9}{Hàm số nào dưới đây đồng biến trên khoảng \((-\infty;+\infty)\)?}{%
\begin{tasks}(4)
\task \(y = -x^3 - 2x + 1\)
\task \(y = \frac{x-2}{x+1}\)
\task \(y = 3x^3 + 3x - 2\)
...
\questionLinesManual{5}{10}{Cho hàm số \( y = f(x) \) xác định, có đạo hàm trên \( \mathbb{R} \) và \( f'(x) \) có đồ thị như hình vẽ bên dưới
\begin{center}
\begin{tikzpicture}[>=latex, scale=1]
    % Hệ trục tọa độ
