...
% --- CÂU 5 ---
\questionTrueFalse{15}{1}{Tiệm vải bà Giang đang tính toán các chi phí để vận hành xưởng và sản xuất \( x \) mét vải trong một tháng. Bà Giang chia chi phí thành 3 hạng mục chính: chi phí thuê xưởng là 8 triệu đồng, chi phí nguyên liệu để sản xuất một mét vải là 25 nghìn đồng, và chi phí bảo trì máy móc là \( 0,00001x^2 \) triệu đồng. Biết rằng giá vải tiệm yết của tiệm vải bà Giang là 100 nghìn đồng/mét vải và giả sử toàn bộ số vải sản xuất được thì đều được bán hết.}{
...
% --- CÂU 7 ---
\questionTrueFalse{15}{3}{Giá trị của một chiếc máy tính để bàn cao cấp (đơn vị: triệu đồng) được mô hình hóa bởi hàm số  
