...
% --- CÂU 26 ---
\questionLinesManual{5}{26}{Cho ba vectơ \(\vec{a}, \vec{b}, \vec{c}\). Điều kiện nào sau đây khẳng định \(\vec{a}, \vec{b}, \vec{c}\) đồng phẳng?}{%
    \begin{tasks}(1)
        \task Tồn tại ba số thực \(m, n, p\) thỏa mãn \(m + n + p = 0\) và \(m\vec{a} + n\vec{b} + p\vec{c} = \vec{0}\).
        \task Tồn tại ba số thực \(m, n, p\) thỏa mãn \(m + n + p \neq 0\) và \(m\vec{a} + n\vec{b} + p\vec{c} = \vec{0}\).
        \task Tồn tại ba số thực \(m, n, p\) sao cho \(m\vec{a} + n\vec{b} + p\vec{c} = \vec{0}\).
        \task Giá của \(\vec{a}, \vec{b}, \vec{c}\) đồng qui.
    \end{tasks}
}
...
% --- CÂU 32 ---
\questionLinesManual{5}{32}{Cho hình lăng trụ \(ABC.A'B'C'\) với \(G\) là trọng tâm của tam giác \(A'B'C'\). Đặt \(\vec{AA'} = \vec{a}, \vec{AB} = \vec{b}, \vec{AC} = \vec{c}\). Khi đó \(\vec{AG}\) bằng}{%
    \begin{tasks}(2)
...
% --- CÂU 33 ---
\questionLinesManual{5}{33}{Cho tam giác \(ABC\) có \(AB = 2; AC = 5\), gọi \(AD\) là phân giác trong của góc \(A\) (\(D\) thuộc cạnh \(BC\)). Mệnh đề nào sau đây đúng?}{%
    \begin{tasks}(2)
...
% --- CÂU 36 ---
\questionLinesManual{6}{36}{Cho tứ diện đều \(ABCD\), \(M\) là trung điểm của cạnh \(AB\) và \(G\) là trọng tâm của tam giác \(BCD\). Đặt \(\vec{AB} = \vec{b}, \vec{AC} = \vec{c}, \vec{AD} = \vec{d}\). Phân tích vectơ \(\vec{MG}\) theo \(\vec{d}, \vec{b}, \vec{c}\).}{%
    \begin{tasks}(2)
