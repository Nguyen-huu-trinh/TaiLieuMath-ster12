...
\begin{minipage}[c]{0.66\linewidth}
    ...
    \begin{itemize}
        ...
        \item $\vec{0}$ có điểm đầu trùng điểm cuối ($\vec{AA} = \vec{0}$), có độ dài bằng $0$, cùng phương và cùng hướng với mọi vectơ.
    \end{itemize}
\end{minipage}\hfill
\begin{minipage}[c]{0.32\linewidth}
    ...
    \begin{tikzpicture}[scale=0.75, font=\footnotesize]
        ...
        \draw[->, >=stealth, line width=1.4pt, amberorange] (A) -- (C1) node[midway, above left] {$\vec{AB}$};
...
\begin{minipage}[c]{0.66\linewidth}
    ...
    \begin{itemize}
        ...
        \item \textbf{Cùng hướng / Ngược hướng:} Khi hai vectơ đã cùng phương.
        \item \textbf{Bằng nhau:} $\vec{a} = \vec{b} \iff \vec{a}, \vec{b} \text{ cùng hướng và } |\vec{a}| = |\vec{b}|$.
    \end{itemize}
\end{minipage}\hfill
\begin{minipage}[c]{0.32\linewidth}
    \centering
    \begin{tikzpicture}[scale=0.72, font=\scriptsize]
        \draw[->, >=stealth, deepblue, thick] (0, 1.0) -- (2.2, 1.0);
        \draw[->, >=stealth, deepblue, thick] (0, 0.65) -- (2.2, 0.65);
        \node[deepblue, right] at (2.25, 0.82) {cùng hướng};

        \draw[->, >=stealth, accentred, thick] (0, 0.05) -- (2.2, 0.05);
        \draw[<-, >=stealth, accentred, thick] (0, -0.3) -- (2.2, -0.3);
        \node[accentred, right] at (2.25, -0.12) {ngược hướng};

        \draw[->, >=stealth, amberorange, line width=1.3pt] (0, -0.9) -- (2.0, -0.9) node[midway, above] {$\vec{a}$};
        \draw[->, >=stealth, amberorange, line width=1.3pt] (0, -1.35) -- (2.0, -1.35) node[midway, above] {$\vec{b}$};
        \node[amberorange, font=\bfseries\scriptsize, right] at (2.25, -1.12) {$\vec{a} = \vec{b}$};
    \end{tikzpicture}
\end{minipage}
...
\begin{minipage}[c]{0.32\linewidth}
    ...
    \begin{tikzpicture}[scale=0.75, font=\footnotesize]
        ...
        \draw[->, >=stealth, deepblue, thick] (A) -- (B) node[midway, above left] {$\vec{AB}$};
        \draw[->, >=stealth, deepblue, thick] (B) -- (C) node[midway, above right] {$\vec{BC}$};
        \draw[->, >=stealth, amberorange, line width=1.3pt] (A) -- (C) node[midway, below] {$\vec{AC}$};
...
\begin{minipage}[c]{0.32\linewidth}
    ...
    \begin{tikzpicture}[scale=0.75, font=\footnotesize]
        ...
        \draw[->, >=stealth, deepblue, thick] (A) -- (B) node[midway, below] {$\vec{AB}$};
        \draw[->, >=stealth, deepblue, thick] (A) -- (D) node[midway, above left] {$\vec{AD}$};
        \draw[->, >=stealth, amberorange, line width=1.3pt] (A) -- (C) node[midway, above] {$\vec{AC}$};
...
\noindent
\begin{minipage}[c]{0.66\linewidth}
    \textbf{\textcolor{amberorange}{5. Quy tắc hình hộp (Ba cạnh từ một đỉnh = Đường chéo)}}
    \begin{itemize}
        \item Cho hình hộp $ABCD.A'B'C'D'$:
        $$\vec{AB} + \vec{AD} + \vec{AA'} = \vec{AC'}$$
        \item Tổng ba vectơ cạnh chung đỉnh bằng vectơ đường chéo xuất phát từ đỉnh đó.
    \end{itemize}
\end{minipage}\hfill
\begin{minipage}[c]{0.32\linewidth}
    \centering
    \begin{tikzpicture}[scale=0.75, font=\footnotesize]
        ...
        \draw[->, >=stealth, deepblue, thick] (A) -- (B) node[below left] {$\vec{AB}$};
        \draw[->, >=stealth, deepblue, thick] (A) -- (D) node[below right] {$\vec{AD}$};
        \draw[->, >=stealth, deepblue, thick] (A) -- (A1) node[left] {$\vec{AA'}$};
        \draw[->, >=stealth, amberorange, line width=1.4pt] (A) -- (C1) node[above right] {$\vec{AC'}$};
        \fill[deepblue] (A) circle (1.2pt) node[left] {$A$};
    \end{tikzpicture}
\end{minipage}
...
\noindent
\begin{minipage}[c]{0.66\linewidth}
    \textbf{\textcolor{amberorange}{6. Nhân vectơ với một số (Điều kiện cùng phương)}}
    \begin{itemize}
        \item Độ dài: $|k\vec{a}| = |k| \cdot |\vec{a}|$.
        \item Hướng: Cùng hướng với $\vec{a}$ khi $k > 0$; ngược hướng khi $k < 0$.
        \item \textbf{Cùng phương:} $\vec{a} \parallel \vec{b} \iff \vec{a} = k\vec{b}$ (với $\vec{b} \neq \vec{0}$).
    \end{itemize}
\end{minipage}\hfill
\begin{minipage}[c]{0.32\linewidth}
    \centering
    \begin{tikzpicture}[scale=0.72, font=\scriptsize]
        \draw[->, >=stealth, deepblue, thick] (0, 0.9) -- (1.2, 0.9) node[midway, above] {$\vec{a}$};
        \draw[->, >=stealth, deepblue, thick] (0, 0.2) -- (2.4, 0.2) node[midway, above] {$2\vec{a}\ (k > 0)$};
        \draw[<-, >=stealth, accentred, thick] (0, -0.5) -- (1.2, -0.5) node[midway, below] {$-\vec{a}\ (k < 0)$};
        \node[amberorange, font=\bfseries\scriptsize, right] at (1.4, -0.15) {$|k\vec{a}| = |k||\vec{a}|$};
    \end{tikzpicture}
\end{minipage}
...
\begin{minipage}[c]{0.33\linewidth}
    ...
    \begin{tikzpicture}[scale=0.85, font=\footnotesize]
        \coordinate (O) at (0,0);
        \draw[->, >=stealth, deepblue, thick] (O) -- (2.6, 0) node[below] {$\vec{b}$};
        \draw[->, >=stealth, deepblue, thick] (O) -- (1.7, 1.9) node[above] {$\vec{a}$};
        \draw[amberorange, line width=1.1pt] (0.65, 0) arc (0:48.2:0.65);
        \node[amberorange, font=\footnotesize] at (1.0, 0.35) {$\varphi$};
        \node[font=\scriptsize, deepblue] at (1.9, 1.1) {$0^\circ \le \varphi \le 180^\circ$};
    \end{tikzpicture}
\end{minipage}
