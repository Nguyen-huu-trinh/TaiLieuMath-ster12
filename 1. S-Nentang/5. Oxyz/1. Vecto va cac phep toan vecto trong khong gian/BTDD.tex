...
% --- CÂU 1 ---
\questionLinesManual{0}{1}{Cho tứ diện \(ABCD\). Hỏi có bao nhiêu vectơ khác vectơ \(\vec{0}\) mà mỗi vectơ có điểm đầu, điểm cuối là hai đỉnh của tứ diện \(ABCD\)?}{%
    \begin{tasks}(4)
        \task 12
        \task 4
        \task 10
...
% --- CÂU 2 ---
\questionLinesManual{0}{2}{Cho hình lập phương \(ABCD.A'B'C'D'\). Mệnh đề nào sau đây \textbf{sai}?}{%
    \begin{tasks}(2)
...
% --- CÂU 3 ---
\questionLinesManual{0}{3}{Cho hình tứ diện \(ABCD\) có trọng tâm \(G\). Mệnh đề nào sau đây \textbf{sai}?}{%
    \begin{tasks}(2)
...
% --- CÂU 4 ---
\questionLinesManual{0}{4}{Cho tứ diện \(ABCD\), gọi \(I, J\) lần lượt là trung điểm của \(AB\) và \(CD\); Đẳng thức nào \textbf{sai}?}{%
    \begin{tasks}(2)
...
% --- CÂU 5 ---
\questionLinesManual{0}{5}{Cho hình hộp chữ nhật \(ABCD.A'B'C'D'\). Khi đó, vectơ bằng vectơ \(\vec{AB}\) là vectơ nào dưới đây?}{%
    \begin{tasks}(4)
        \task \(\vec{D'C'}\)
        \task \(\vec{BA}\)
        \task \(\vec{CD}\)
...
% --- CÂU 6 ---
\questionLinesManual{0}{6}{Cho hình chóp \(S.ABCD\) có đáy \(ABCD\) là hình bình hành. Đặt \(\vec{SA} = \vec{a}\); \(\vec{SB} = \vec{b}\); \(\vec{SC} = \vec{c}\); \(\vec{SD} = \vec{d}\). Khẳng định nào sau đây đúng?}{%
    \begin{tasks}(4)
...
% --- CÂU 7 ---
\questionLinesManual{0}{7}{Cho tứ diện \(ABCD\). Gọi \(P, Q\) là trung điểm của \(AB\) và \(CD\). Chọn khẳng định đúng?}{%
    \begin{tasks}(2)
...
% --- CÂU 8 ---
\questionLinesManual{0}{8}{Cho hình lăng trụ \(ABC.A'B'C'\). Đặt \(\vec{AB} = \vec{a}, \vec{AA'} = \vec{b}, \vec{AC} = \vec{c}\). Khẳng định nào sau đây đúng?
\begin{center}
...
% --- CÂU 9 ---
\questionLinesManual{0}{9}{Cho hình lập phương \(ABCD.A'B'C'D'\). Tính \(\cos\left( \vec{BD}, \vec{A'C'} \right)\)}{%
    \begin{tasks}(4)
...
% --- CÂU 10 ---
\questionLinesManual{0}{10}{Cho tứ diện \(ABCD\) và điểm \(G\) thỏa \(\vec{GA} + \vec{GB} + \vec{GC} + \vec{GD} = \vec{0}\) (\(G\) là trọng tâm của tứ diện). Gọi \(O\) là giao điểm của \(GA\) và mặt phẳng \((BCD)\). Trong các khẳng định sau, khẳng định nào đúng?}{%
    \begin{tasks}(4)
        \task \(\vec{GA} = -2\vec{OG}\)
        \task \(\vec{GA} = 4\vec{OG}\)
        \task \(\vec{GA} = 3\vec{OG}\)
