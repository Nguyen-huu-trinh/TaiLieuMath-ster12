...
% --- CÂU 1 ---
\questionLinesManual{15}{1}{Thống kê nhiệt độ trung bình hàng ngày (đơn vị: °C) trong tháng 1/2025 tại địa điểm X được cho trong bảng biểu diễn số liệu ghép nhóm như sau:
...
% --- CÂU 2 ---
\questionLinesManual{20}{2}{Khảo sát thời gian luyện tập thể thao trong ngày của một số sinh viên trong KTX của trường đại học X, thu được mẫu số liệu ghép nhóm sau:
...
% --- CÂU 3 ---
\questionLinesManual{15}{3}{Kết quả thu thập điểm số môn Toán của 40 học sinh lớp 12B khi kiểm tra 15 phút được biểu thị qua biểu đồ sau:
...
% --- CÂU 4 ---
\questionLinesManual{20}{4}{Một bác tài xế thống kê lại độ dài quãng đường (đơn vị: km) mà bác đã lái xe mỗi ngày trong một tháng ở bảng sau:
...
% --- CÂU 5 ---
\questionLinesManual{15}{5}{Cô H tìm hiểu thời gian hoàn thành một bài toán Vận dụng cao (đơn vị: phút) của một nhóm học sinh khối 12, thu được biểu đồ dưới đây:
...
% --- CÂU 6 ---
\questionLinesManual{20}{6}{Trong một đợt khám sức khỏe của 36 học sinh nam khối 12 của trường THPT X, cô y tá thống kê và thu được kết quả về chiều cao (đơn vị: cm) trong bảng dưới đây:
...
% --- CÂU 9 ---
\questionLinesManual{12}{9}{Khoảng tứ phân vị của mẫu số liệu ghép nhóm về chỉ số IQ của 50 thí sinh gần nhất với giá trị nào dưới đây?}{%
    \begin{tasks}(4)
        \task 19,12
        \task 19,11
        \task 19,13
...
% --- CÂU 10 ---
\questionLinesManual{8}{10}{Người ta thống kê được thời lượng thi đấu của các trận đấu cầu lông tại giải đấu X được cho ở bảng sau:
...
% --- CÂU 11 ---
\questionLinesManual{3}{11}{Kết quả điều tra tổng thể thu nhập trong năm 2024 của một số hộ gia đình ở thành phố X được ghi lại ở bảng sau:
...
% --- CÂU 12 ---
\questionLinesManual{3}{12}{Cân nặng của một số quả mít trong một khu vườn được thống kê ở bảng sau:
...
% --- CÂU 13 ---
\questionLinesManual{3}{13}{Số người đến thư viện đọc sách trong tháng 5 ở thư viện X được thống kê trong bảng dưới đây:
...
% --- CÂU 14 ---
\questionLinesManual{5}{14}{Trong tuần lễ bảo vệ môi trường, các học sinh khối 12 tiến hành thu nhặt vỏ chai nhựa để tái chế. Nhà trường thống kê kết quả thu nhặt vỏ chai của học sinh khối 12 trong biểu đồ sau:
...
% --- CÂU 17 ---
\questionLinesManual{10}{17}{Tính độ lệch chuẩn của mẫu số liệu ghép nhóm trên (kết quả làm tròn đến hàng phần trăm).}{%
    \begin{tasks}(4)
        \task 2,44
        \task 2,43
        \task 2,46
...
% --- CÂU 18 ---
\questionLinesManual{5}{18}{Một giáo viên thể dục muốn tìm hiểu về tình hình cân nặng của học sinh lớp 12B để đưa ra lời khuyên phù hợp về chế độ dinh dưỡng và tập luyện. Để làm điều này, giáo viên đó đã thu thập cân nặng của 40 học sinh trong lớp và chia thành các nhóm giá trị như sau:
...
\textbf{Dùng dữ kiện sau để trả lời các câu 19, 20 phía dưới}  Hai thùng hàng $A, B$ đều chứa 50 quả táo. Kết quả kiểm tra cân nặng (đơn vị: $gam$) của 50 quả táo ở mỗi thùng $A$ và $B$ được cho ở biểu đồ dưới đây:
\begin{center}
    \begin{tikzpicture}[scale=0.8, >=stealth]
    % Định nghĩa màu sắc
...
% --- CÂU 20 ---
\questionLinesManual{4}{20}{Độ lệch chuẩn của mẫu số liệu ghép nhóm về cân nặng 50 quả táo ở thùng A lớn hơn thùng B bao nhiêu? (Kết quả làm tròn đến hàng phần mười).}{%
    \begin{tasks}(4)
        \task 0,4
        \task 0,2
        \task 0,3
...
% --- CÂU 21 ---
\questionTrueFalse{20}{21}{Để chuẩn bị cho tiết học "Mạng xã hội: lợi và hại" (Hoạt động thực hành trải nghiệm môn Toán lớp 10), giáo viên đã khảo sát thời gian sử dụng mạng xã hội trong một ngày của học sinh trong lớp 10A mình dạy và thu được mẫu số liệu sau:
...
% --- CÂU 22 ---
\questionTrueFalse{20}{22}{Tuổi thọ (đơn vị: năm) của một số bình ắc quy ô tô của công ty X được cho như bảng dưới đây:
...
% --- CÂU 23 ---
\questionTrueFalse{15}{23}{Biểu đồ sau thống kê lại tổng số giờ nắng trong tháng 6 của các năm từ 2002 đến 2021 tại hai trạm quan trắc đặt ở Quy Nhơn và Nha Trang:
...
% --- CÂU 24 ---
\questionTrueFalse{15}{24}{Người ta ghi lại tiền lãi (đơn vị: triệu đồng) của một số nhà đầu tư (với số tiền đầu tư như nhau), khi đầu tư vào hai lĩnh vực \( M, N \) được cho dưới biểu đồ sau:
...
% --- CÂU 26 ---
\questionTrueFalse{20}{26}{Cuối năm học, cô giáo dạy Toán muốn đánh giá kết quả học tập của 55 học sinh lớp 12A thông qua điểm tổng kết môn Toán. Để có cái nhìn tổng quát và đưa ra phương hướng giảng dạy phù hợp, cô tiến hành thống kê và phân tích điểm số của cả lớp. Kết quả thu được ở bảng dưới đây:
...
% --- CÂU 27 ---
\questionTrueFalse{20}{27}{Để đánh giá chất lượng của một loại pin điện thoại mới, người ta ghi lại thời gian nghe nhạc (đơn vị: giờ) liên tục của điện thoại được sạc đầy pin cho đến khi hết pin và thu được kết quả như sau:
...
% --- CÂU 29 ---
\questionTrueFalse{15}{29}{Mức lương khởi điểm (tính bằng triệu đồng) của một số công nhân ở hai khu vực I và II được thống kê ở biểu đồ dưới đây:
...
% --- CÂU 30 ---
\questionTrueFalse{15}{30}{Một nhóm học sinh trong câu lạc bộ Sinh học đang nghiên cứu về ảnh hưởng của môi trường đến kích thước tế bào thực vật. Họ tiến hành thu thập mẫu từ hai khu vực khác nhau:
...
% --- CÂU 16 ---
\questionShortAnswer{20}{31}{Tại trạm khí tượng thủy văn, anh thanh niên đo đạc và thống kê lượng mưa tại một thành phố M trong một thời điểm liên tiếp 30 ngày được cho trong bảng sau:
...
% --- CÂU 17 ---
\questionShortAnswer{20}{32}{Mỗi ngày ông Trung đều đi bộ để rèn luyện sức khỏe. Quãng đường đi bộ mỗi ngày (đơn vị: km) của ông Trung trong 30 ngày được thống kê ở bảng sau:
...
% --- CÂU 18 ---
\questionShortAnswer{18}{33}{Bạn Dương rất thích nhảy Dance Battle. Thời gian (đơn vị: phút) tập nhảy mỗi ngày trong thời gian gần đây của bạn Dương được thống kê lại ở biểu đồ sau:
...
% --- CÂU 19 ---
\questionShortAnswer{20}{34}{Trong một đợt kiểm tra sức khỏe định kì ở vườn sở thú A, người quản lý thú ghi lại tuổi thọ (đơn vị: năm) của 32 con hổ và thu được kết quả ở bảng dưới đây:
...
% --- CÂU 20 ---
\questionShortAnswer{20}{35}{Một trang trại trồng khoai tây cần phân tích sản lượng thu hoạch để đánh giá hiệu suất canh tác. Dữ liệu thu thập từ các cánh đồng khác nhau trong một mùa vụ như sau:
...
% --- CÂU 36 ---
\questionShortAnswer{20}{36}{Số tiền ghi trên hóa đơn của 100 khách hàng lấy ngẫu nhiên trong một ngày của một siêu thị cho ở bảng dưới đây:
...
% --- CÂU 37 ---
\questionShortAnswer{20}{37}{Huấn luyện viên của một tay vợt chuyên nghiệp đã tiến hành ghi lại tốc độ giao bóng (tính bằng km/h) trong 200 lần nhằm đánh giá sự ổn định và hiệu suất thi đấu của vận động viên. Kết quả được thống kê trong bảng sau:
...
% --- CÂU 38 ---
\questionShortAnswer{20}{38}{Khảo sát về độ ẩm không khí trung bình các tháng năm 2024 tại thành phố X (đơn vị: \%), người ta thu được mẫu số liệu ghép nhóm như sau:
...
% --- CÂU 40 ---
\questionShortAnswer{18}{40}{Kết quả khảo sát năng suất (đơn vị: tấn/ha) của một số thửa ruộng ở hai khu vực X và Y được minh họa bởi biểu đồ sau:
