...
% --- CÂU 1 ---
\questionLinesManual{15}{1}{Công ty X muốn khảo sát mức chi phí thuê nhà hàng tháng của các nhân viên độc thân để có chính sách hỗ trợ phù hợp. Một nhóm nghiên cứu đã thu thập dữ liệu từ 100 nhân viên độc thân về số tiền họ phải chi trả cho việc thuê nhà hàng tháng (đơn vị: triệu đồng) ở bảng dưới đây:
...
% --- CÂU 2 ---
\questionLinesManual{25}{2}{Một giống cây xoan đào được trồng tại địa điểm X. Người ta thống kê đường kính thân của một số cây xoan đào 7 năm tuổi (đơn vị: cm) ở biểu đồ sau:
...
% --- CÂU 4 ---
\questionLinesManual{12}{4}{Nếu so sánh theo độ lệch chuẩn thì độ rủi ro của lĩnh vực kinh doanh M cao hơn lĩnh vực kinh doanh N bao nhiêu? (kết quả làm tròn đến chữ số thập phân thứ hai)}{%
    \begin{tasks}(4)
        \task 2,34
        \task 2,35
        \task 2,36
...
% --- CÂU 12 ---
\questionLinesManual{25}{5}{Một trung tâm mua sắm đã thống kê lại hóa đơn (tính bằng triệu đồng) của các khách hàng trong một ngày ở bảng sau:
...
% --- CÂU 9 ---
\questionTrueFalse{25}{6}{Kết quả thống kê về điểm trung bình năm học của học sinh hai lớp 12A và 12B được biểu diễn trong bảng dưới đây:
...
% --- CÂU 8 ---
\questionTrueFalse{25}{7}{Chỉ số ô nhiễm không khí (AQI) tại thủ đô Hà Nội trong tháng 6/2024 được thống kê vào 10h30 sáng các ngày trong tháng được thể hiện trong bảng sau:
...
% --- CÂU 11 ---
\questionShortAnswer{3}{8}{Thầy Minh thống kê điểm thi khảo sát chất lượng môn Toán của học sinh lớp 12D thu được mẫu số liệu ghép nhóm sau:
...
% --- CÂU 13 ---
\questionShortAnswer{20}{9}{Một hãng xe ô tô thống kê lại số lần gặp sự cố về động cơ của 100 chiếc xe cùng loại sau 3 năm sử dụng đầu tiên ở bảng sau:
...
% --- CÂU 13 ---
\questionShortAnswer{25}{10}{Để đánh giá mức độ cân bằng giữa học tập và công việc làm thêm của sinh viên, ban quản lý của trường đại học X đã thực hiện một cuộc khảo sát về số giờ làm thêm mỗi tuần của sinh viên trong trường. Dữ liệu được tổng hợp trong bảng sau:
