...
% --- CÂU 44 ---
\questionLinesManual{0}{10}{Một cuộc thi khoa học có 36 bộ câu hỏi, trong đó có 20 bộ câu hỏi về chủ đề tự nhiên và 16 bộ câu hỏi về chủ đề xã hội. Bạn An lấy ngẫu nhiên 1 bộ câu hỏi (lấy không hoàn lại), sau đó bạn Bình lấy ngẫu nhiên 1 bộ câu hỏi. Xác suất bạn Bình lấy được bộ câu hỏi về chủ đề xã hội bằng}{%
    \begin{tasks}(4)
        \task \(\dfrac{15}{35}\)
        \task \(\dfrac{16}{35}\)
        \task \(\dfrac{4}{9}\)
