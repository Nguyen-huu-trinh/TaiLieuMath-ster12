...
% --- CÂU 2 ---
\questionTrueFalse{20}{2}{Chất điểm chuyển động theo quy luật vận tốc \(v(t)\) (m/s) có dạng đường Parabol \(v(t) = t^2 + bt + c\) khi \(0 \leq t \leq 4\) và \(v(t)\) có dạng đường thẳng khi \(4 \leq t \leq 8\). Đồ thị \(v(t)\) được cho như hình bên.
\begin{center}
...
% --- CÂU 3 ---
\questionTrueFalse{25}{3}{Một chất điểm \(A\) chuyển động trên trục số \(Ox\), với vận tốc \(v(t) = 3t^2 - 24t + 46\) (m/s) trong đó thời điểm \(t = 0\) tính từ lúc chất điểm bắt đầu chuyển động và khi đó chất điểm ở tại gốc tọa độ.
\begin{center}
