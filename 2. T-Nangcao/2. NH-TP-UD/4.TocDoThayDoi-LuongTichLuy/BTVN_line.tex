...
% --- CÂU 8 ---
\questionShortAnswer{25}{8}{Một bể cá hình trụ thủy tinh có bán kính đáy bằng 6 dm, chiều cao bằng 5 dm; bên trong bể cả người ta đặt một vật trang trí là khối nón đặc (đỉnh hình nón sẽ được bố trí với bơm nước cho bể cá), đáy hình nón có bán kính bằng 3 dm và có tâm trùng với đáy hình trụ, chiều cao hình nón bằng với chiều cao hình trụ. Người ta bơm nước vào bể với tốc độ 0,5 lít/phút; đến phút thứ 40 thì tốc độ dâng lên của nước là bao nhiêu cm/phút (làm tròn đến hàng phần trăm)?
\begin{figure}[H]
    \centering
    \includegraphics[width=0.4\textwidth]{../images/HoCa.png}
\end{figure}
}
