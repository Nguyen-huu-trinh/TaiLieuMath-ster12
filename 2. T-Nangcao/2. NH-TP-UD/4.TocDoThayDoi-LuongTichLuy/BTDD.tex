...
% --- CÂU 1 ---
\questionTrueFalse{0}{1}{Bạn Khánh đang tham gia một thử nghiệm nhằm đo thời gian ghi nhớ các khái niệm khác nhau trong môn Nguyên lý kế toán. Biết rằng hàm số \(M(t)\) biểu thị số lượng khái niệm mà bạn Khánh nhớ được trong \(t\) phút, khi đó tốc độ ghi nhớ khái niệm của bạn Khánh được biểu thị bởi hàm số \(M'(t) = 0,2t - 0,005t^2\) (khái niệm/phút). Giả sử rằng bạn Khánh rất yêu môn học này, nên trước khi tham gia thử nghiệm, bạn không thuộc được khái niệm nào.}{
