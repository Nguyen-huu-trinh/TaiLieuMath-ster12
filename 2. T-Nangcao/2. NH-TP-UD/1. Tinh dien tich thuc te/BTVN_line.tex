...
\questionShortAnswer{23}{3}{Trang trí một sân hình chữ nhật kích thước 30m × 16m, trong đó hai Parabol \( (P_1) \) đối xứng với \( (P_2) \) qua đường thẳng đi qua hai trung điểm của chiều dài sân (hình vẽ), khoảng cách giữa hai đỉnh Parabol bằng 6m.  
