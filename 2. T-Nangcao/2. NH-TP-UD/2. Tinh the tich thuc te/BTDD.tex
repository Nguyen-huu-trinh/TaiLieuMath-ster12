...
\questionShortAnswer{0}{3}{Một chậu cây có chiều cao 50cm và đường kính miệng chậu là 50cm. Mặt cắt ngang của chậu cây là một đường parabol (tham khảo hình vẽ).
\begin{figure}[htbp]
    \centering
...
\questionShortAnswer{0}{4}{Săm lớp xe ô tô khi bơm căng đặt nằm trên mặt phẳng nằm ngang có hình chiếu bằng như hình vẽ với bán kính đường tròn nhỏ \( R_1 = 25cm \), bán kính đường tròn lớn \( R_2 = 35cm \) và mặt cắt khi cắt bởi mặt phẳng đi qua trục, vuông góc với mặt phẳng nằm ngang là hai đường tròn. Bỏ qua độ dày của vỏ săm. Tính thể tích không khí được chứa bên trong săm, kết quả làm tròn đến hàng đơn vị của decimet khối.
