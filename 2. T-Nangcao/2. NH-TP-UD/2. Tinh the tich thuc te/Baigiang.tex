...
\questionShortAnswer{14}{6}{Một kiến trúc sư chịu trách nhiệm thiết kế một tòa nhà cao 30 mét. Mặt cắt ngang tại mọi độ cao, vuông góc với trục thẳng đứng, luôn là một hình vuông (xem hình vẽ).

\begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{../images/ToaNha.png}
\end{figure}
