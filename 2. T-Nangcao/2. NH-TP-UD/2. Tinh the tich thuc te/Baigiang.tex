...
\questionShortAnswer{18}{5}{Một bình chứa nước dạng như hình có chiều cao là \(\dfrac{3\pi}{2}\) dm. Nếu lượng nước trong bình có chiều cao là \(x\) (dm) thì mặt nước là hình tròn có bán kính \(\sqrt{2 - \sin x}\) (dm) với \(0 \leq x \leq \dfrac{3\pi}{2}\). Tính dung tích của bình (kết quả làm tròn đến hàng phần trăm của đơn vị đề-xi-mét khối).
