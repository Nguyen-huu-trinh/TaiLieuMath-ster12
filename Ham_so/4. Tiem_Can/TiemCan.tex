...
\begin{tikzpicture}
    ...
    {$-\infty$, $0$, $3$, $+\infty$}
    \tkzTabLine{, -, d, -, 0, +, }
    \tkzTabVar{-/ $1$ / , -D+/ $-\infty$ / $+\infty$ , -/ $3$ / , +/ $+\infty$ /}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    {$-\infty$, $0$, $1$, $+\infty$}
    \tkzTabLine{, -, d, -, 0, +, }
    \tkzTabVar{-/ $0$ / , -D+/ $-\infty$ / $+\infty$ , -/ $-2$ / , +/ $+\infty$ /}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    {$-\infty$, $-1$, $0$, $1$, $+\infty$}
    \tkzTabLine{, +, 0, -, d, +, 0, -, }
    \tkzTabVar{-/ $-\infty$ / , +/ $2$ / , -D+/ $-\infty$ / $+\infty$ , +/ $-1$ / , -/ $-\infty$ /}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    {$-\infty$, $-2$, $0$, $+\infty$}
    \tkzTabLine{, -, 0, +, d, -, }
    \tkzTabVar{-/ $-\infty$ / , +/ $-2$ / , -D+/ $-\infty$ / $+\infty$ , -/ $1$ /}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    {$-\infty$, $-1$, $1$, $+\infty$}
    \tkzTabLine{, -, 0, +, d, -, }
    \tkzTabVar{-/ $-\sqrt{2}$ / , +/ $-1$ / , -D+/ $-\infty$ / $+\infty$ , -/ $-\infty$ /}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    {$-\infty$, $0$, $3$, $+\infty$}
    \tkzTabLine{, -, d, -, 0, +, }
    \tkzTabVar{-/ $0$ / , -D+/ $-\infty$ / $+\infty$ , -/ $3$ / , +/ $+\infty$ /}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[>=latex, scale=1]
    ...
    % 2. Vẽ đồ thị hàm số - tránh điểm gián đoạn x = -0.5
    \draw[thick, samples=100, domain=-2.5:-1.2] 
        plot (\x, {1 + 1/(\x + 0.5)});
    \draw[thick, samples=100, domain=-0.8:-0.51] 
        plot (\x, {1 + 1/(\x + 0.5)});
    \draw[thick, samples=100, domain=-0.49:3.5] 
        plot (\x, {1 + 1/(\x + 0.5)});
    
    % 3. Đường tiệm cận
    \draw[dashed] (-0.5,-2.5) -- (-0.5,2.5) node[above] {\small $x=-\frac{1}{2}$};
    \draw[dashed] (-2.5,1) -- (3.5,1) node[right] {\small $y=1$};
...
\begin{tikzpicture}[>=latex, scale=1]
    ...
    % 2. Vẽ đồ thị hàm số
    \draw[thick, samples=100, domain=-3.5:-1.3] 
        plot (\x, {0.5 + 2/(\x + 1)});
    \draw[thick, samples=100, domain=-0.7:3.5] 
        plot (\x, {0.5 + 2/(\x + 1)});
    
    % 3. Đường tiệm cận
    \draw[dashed] (-1,-2.5) -- (-1,2.5) node[above] {\small $x=-1$};
    \draw[dashed] (-3.5,0.5) -- (3.5,0.5) node[right] {\small $y=\frac{1}{2}$};
...
\begin{tikzpicture}[>=latex, scale=1]
    ...
    % 3. Đường tiệm cận
    \draw[dashed] (-1,-2.5) -- (-1,2.5) node[above] {\small $x=-1$};
    \draw[dashed] (-3.5,-1) -- (3.5,-1) node[right] {\small $y=-1$};
...
\begin{tikzpicture}[>=latex, scale=1]
    ...
    \draw[->] (0,-5.5) -- (0,5.5) node[right] {\small $y$};
    \node[below left] at (0,0) {\small $O$};
    
    % 2. Vẽ đồ thị hàm số
    \draw[thick, samples=100, domain=-3:-0.3] 
        plot (\x, {-2 + 2/(\x + 0.5)});
    \draw[thick, samples=100, domain=0.3:6.5] 
        plot (\x, {-2 + 2/(\x + 0.5)});
    
    % 3. Đường tiệm cận
    \draw[dashed] (0,-5.5) -- (0,5.5) node[above] {\small $x=0$};
    \draw[dashed] (-3.5,-2) -- (7.5,-2) node[right] {\small $y=-2$};
    \draw[dashed] (-3.5,0) -- (7.5,0) node[right] {\small $y=0$};
...
\begin{tikzpicture}[>=latex, scale=1]
    ...
    \draw[thick, samples=100, domain=-3.5:-1.3] 
        plot (\x, {2*\x - 2 + 4/(\x + 1)});
    \draw[thick, samples=100, domain=-0.7:4.5] 
        plot (\x, {2*\x - 2 + 4/(\x + 1)});
    
    % 3. Đường tiệm cận xiên
    \draw[dashed, thick] (-3.5,-9) -- (4.5,7) node[right] {\small $y = 2x - 2$};
    
    % 4. Đường tiệm cận đứng
    \draw[dashed] (-1,-3.5) -- (-1,4.5) node[above] {\small $x = -1$};
...
\begin{tikzpicture}[>=latex, scale=1]
    ...
    % 3. Đường tiệm cận
    \draw[dashed] (-1,-3.5) -- (-1,3.5) node[above] {\small $x = -1$};
    \draw[dashed] (-3.5,1) -- (3.5,1) node[right] {\small $y = 1$};
...
\begin{tikzpicture}[>=latex, scale=1]
    ...
    % 3. Đường tiệm cận xiên
    \draw[dashed, thick] (-4.5,-9) -- (4.5,9) node[right] {\small $y = 2x$};
    
    % 4. Đường tiệm cận đứng
    \draw[dashed] (0,-4.5) -- (0,4.5) node[above] {\small $x = 0$};
...
\begin{tikzpicture}[>=latex, scale=1]
    % 1. Hệ trục tọa độ
    \draw[->] (-1.5,0) -- (5.5,0) node[below] {\small $x$};
    ...
    % 3. Đường tiệm cận
    \draw[dashed] (2,-1.5) -- (2,4.5) node[above] {\small $x = 2$};
    \draw[dashed] (-1.5,1) -- (5.5,1) node[right] {\small $y = 1$};
...
\begin{tikzpicture}[>=latex, scale=1]
    ...
    % 3. Đường tiệm cận xiên
    \draw[dashed, thick] (-4.5,5.5) -- (4.5,-3.5) node[right] {\small $y = -x + 1$};
    
    % 4. Đường tiệm cận đứng
    \draw[dashed] (-1,-4.5) -- (-1,4.5) node[above] {\small $x = -1$};
...
\begin{tikzpicture}[>=latex, scale=1]
    ...
    % 3. Đường tiệm cận
    \draw[dashed] (-1,-3.5) -- (-1,3.5) node[above] {\small $x = -1$};
    \draw[dashed] (-3.5,2) -- (3.5,2) node[right] {\small $y = 2$};
...
\begin{tikzpicture}[>=latex, scale=1]
    ...
    % 2. Vẽ đồ thị hàm số
    \draw[thick, samples=100, domain=0.3:5.5] 
        plot (\x, {2 + 1/(\x - 2)});
    
    % 3. Đường tiệm cận
    \draw[dashed] (2,-1.5) -- (2,4.5) node[above] {\small $x = 2$};
    \draw[dashed] (-1.5,2) -- (5.5,2) node[right] {\small $y = 2$};
...
\begin{tikzpicture}[>=latex, scale=1]
    ...
    % 3. Đường tiệm cận
    \draw[dashed] (0,-2.5) -- (0,3.5) node[above] {\small $x = 0$};
    \draw[dashed] (-3.5,1) -- (3.5,1) node[right] {\small $y = 1$};
...
\begin{tikzpicture}[>=latex, scale=1]
    ...
    % 3. Đường tiệm cận xiên
    \draw[dashed, thick] (-4.5,4.5) -- (4.5,-4.5) node[right] {\small $y = -x$};
...
\begin{tikzpicture}[>=latex, scale=1]
    ...
    % 3. Đường tiệm cận
    \draw[dashed] (-1,-3.5) -- (-1,3.5) node[above] {\small $x = -1$};
    \draw[dashed] (-3.5,-1) -- (4.5,-1) node[right] {\small $y = -1$};
...
\begin{tikzpicture}[>=latex, scale=1]
    ...
    \draw[thick, samples=100, domain=-3.5:0.7] 
        plot (\x, {-2 + 1/(\x - 1)});
    \draw[thick, samples=100, domain=1.3:3.5] 
        plot (\x, {-2 + 1/(\x - 1)});
...
\(\lim_{x \to 1^-} f(x) = 2; \lim_{x \to 1^+} f(x) = -\infty; \lim_{x \to +\infty} f(x) = 0\). Khẳng định nào sau đây đúng?}{
    \begin{tasks}(1)
...
\(\lim_{x \to (-2)^-} f(x) = 2\), \(\lim_{x \to 1^+} f(x) = -\infty\).  
...
% --- CÂU 113 ---
\questionLinesManual{0}{113}{Cho hàm số \( y = f(x) \) có \( \lim_{x \to +\infty} f(x) = 1 \) và \( \lim_{x \to -\infty} f(x) = -1 \). Khẳng định nào sau đây là khẳng định đúng?}{
    \begin{tasks}(1)
...
\begin{tikzpicture}
    ...
    {$-\infty$, $1$, $2$, $+\infty$}
    \tkzTabLine{, -, 0, +, d, -, }
    \tkzTabVar{-/ $-\infty$ / , +/ $3$ / , -D+/ $-\infty$ / $+\infty$ , -/ $-2$ /}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}[>=latex, scale=1]
    ...
    % 2. Vẽ đồ thị hàm số
    \draw[thick, samples=100, domain=-2.5:0.7] 
        plot (\x, {(2*\x - 3)/(5*\x*\x - 15*\x + 10)});
    \draw[thick, samples=100, domain=1.3:1.7] 
        plot (\x, {(2*\x - 3)/(5*\x*\x - 15*\x + 10)});
    \draw[thick, samples=100, domain=2.3:4.5] 
        plot (\x, {(2*\x - 3)/(5*\x*\x - 15*\x + 10)});
    
    % 3. Đường tiệm cận
    \draw[dashed] (1,-2.5) -- (1,2.5) node[above] {\small $x=1$};
    \draw[dashed] (2,-2.5) -- (2,2.5) node[above] {\small $x=2$};
    \draw[dashed] (-2.5,0) -- (4.5,0) node[right] {\small $y=0$};
...
\begin{tikzpicture}
    ...
    {$-\infty$, $-1$, $0$, $1$, $+\infty$}
    \tkzTabLine{, -, 0, +, d, +, 0, -, }
    \tkzTabVar{-/ $0$ / , +/ $2$ / , -D+/ $-\infty$ / $+\infty$ , +/ $3$ / , -/ $-1$ /}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    {$-\infty$, $-2$, $0$, $1$, $+\infty$}
    \tkzTabLine{, -, 0, +, d, -, 0, +, }
    \tkzTabVar{-/ $-\infty$ / , +/ $5$ / , -D+/ $-\infty$ / $+\infty$ , -/ $0$ / , +/ $1$ /}
\end{tikzpicture}
\end{center}
...
\questionTrueFalse{0}{122}{Cho hàm số \( f(x) = \dfrac{x^2 - x - 7}{x - 3} \). Xét tính đúng sai của các mệnh đề sau}{
    ...
    \textbf{b)} & \( \lim_{x \to 3^+} \dfrac{x^2 - x - 7}{x - 3} = +\infty \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{c)} & \( \lim_{x \to -\infty} \dfrac{x^2 - x - 7}{x - 3} = 1 \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
...
\begin{tikzpicture}
    ...
    {$-\infty$, $-1$, $1$, $3$, $+\infty$}
    \tkzTabLine{, -, 0, +, 0, -, d, -, }
    \tkzTabVar{-/ $+\infty$ / , +/ $-1$ / , -/ $3$ / , -D+/ $-\infty$ / $+\infty$ , -/ $-\infty$ /}
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    {$-\infty$, $-2$, $0$, $2$, $+\infty$}
    \tkzTabLine{, +, d, +, d, +, 0, -, }
    \tkzTabVar{-/ $2$ / , +D-/ $+\infty$ / $-\infty$, +D-/ $+\infty$ / $-\infty$, +/ $3$ / , -/ $-3$ /}
\end{tikzpicture}
\end{center}
