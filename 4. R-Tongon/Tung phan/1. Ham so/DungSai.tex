...
\questionTrueFalse{0}{1}{Cho hàm số \( y = f(x) = \frac{-x^2 + 10x - 12}{x} \) có đồ thị \( (C) \).
...
\questionTrueFalse{0}{47}{Trong hệ trục \( Oxy \) đường biên của một hòn đảo được mô hình hoá bởi hàm số  
