...
\questionLinesManual{0}{1}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên. Hàm số đã cho đồng biến trên khoảng nào dưới đây?
\begin{center}
...
\questionLinesManual{0}{2}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên. Hàm số đã cho nghịch biến trên khoảng nào dưới đây?
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Vẽ hệ trục tọa độ Ox, Oy
    \draw[->] (-2.5,0) -- (2.5,0) node[above] {\small $x$};
...
\questionLinesManual{0}{3}{Cho hàm số \( y = f(x) \) đồ thị hàm số như hình vẽ. Hàm số đồng biến trên khoảng nào?
\begin{center}
...
\questionLinesManual{0}{4}{Cho hàm số \( y = f(x) \) đồ thị hàm số như hình vẽ. Hàm số đồng biến trên khoảng nào?
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % 1. Vẽ lưới
...
\questionLinesManual{0}{5}{Cho hàm số \( y = x^3 - 3x^2 \). Hàm số nghịch biến trên khoảng nào?
...
\questionLinesManual{0}{6}{Hỏi hàm số \( y = 2x^4 + 1 \) đồng biến trên khoảng nào?
\begin{tasks}(4)
\task 
\task 
\task
...
\questionLinesManual{0}{7}{Cho hàm số \( y = \dfrac{x-2}{x+1} \). Hàm số đồng biến trên khoảng nào?
...
\questionLinesManual{0}{8}{Cho hàm số \( y = \dfrac{2x+3}{x-2} \). Hàm số nghịch biến trên khoảng nào?
...
\questionLinesManual{0}{9}{Cho hàm số \( y = \dfrac{x^2+2x+2}{x+1} \). Hàm số nghịch biến trên khoảng nào?
...
\questionLinesManual{0}{10}{Cho hàm số \( y = \dfrac{x^2-x+1}{x-1} \). Hàm số nghịch biến trên khoảng nào?
...
\questionLinesManual{0}{11}{Cho hàm số \( y = \sqrt{2x^2 + 1} \). xét tính đơn điệu của hàm số?}{%
\begin{tasks}(4)
\task 
\task 
\task
...
\questionLinesManual{0}{12}{Cho hàm \( y = \sqrt{x^2 - 6x + 5} \). xét tính đơn điệu của hàm số?}{%
\begin{tasks}(4)
\task 
\task 
\task
...
\questionLinesManual{0}{13}{Cho hàm số \( y = \log_3 (x^2 - 2x + 3) \). Hàm số đồng biến trên khoảng nào?}{%
\begin{tasks}(4)
\task \((-\infty; 1)\)
\task \((-1; +\infty)\)
\task \((-\infty; -1)\)
...
\questionLinesManual{0}{15}{Cho hàm số \( y = f(x) \) có bảng biến thiên như hình dưới đây. Xét tính đơn diệu của hàm số?
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $y'$ / 1, $y$ / 2.5}
...
\questionLinesManual{0}{16}{Cho hàm số \( y = f(x) \) có bảng xét dấu đạo hàm như sau:
\begin{center}
\begin{tikzpicture}
...
\questionLinesManual{0}{17}{Cho hàm số \( y = f(x) \) có bảng xét dấu của đạo hàm như hình vẽ.
...
\questionLinesManual{0}{18}{Cho hàm số \( y = 2x+1 \)
...
\questionLinesManual{0}{19}{Cho hàm số \( y = 2x^2-6x+1 \)
...
\questionLinesManual{0}{20}{Cho hàm số \( y = (x-1)(x-2)(x+3) \)
...
\questionLinesManual{0}{21}{Cho hàm số \( y = x^5(x-1)(x+1)^3(x-3) \)
...
\questionLinesManual{0}{22}{Cho hàm số \( y = x^2(x-2)(x-4)^4(x-3) \)
...
\questionLinesManual{0}{23}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \) và có đạo hàm  
\( f'(x) = (1 - x)^2 (x + 1)^3 (3 - x). \)  
...
\questionLinesManual{0}{24}{Cho hàm số \( y = f(x) \) có đạo hàm \( f'(x) = x(x - 2)^3 \), với mọi \( x \in \mathbb{R} \). Hàm số đã cho nghịch biến trên khoảng nào?}{%
\begin{tasks}(4)
\task \((1; 3)\)
\task \((-1; 0)\)
\task \((0; 1)\)
...
\questionLinesManual{0}{25}{Cho hàm số \( f(x) \) liên tục trên \( \mathbb{R} \) có đạo hàm  
...
\questionLinesManual{0}{26}{Cho hàm số \( y = f(x) \) xác định, có đạo hàm trên \( \mathbb{R} \) và \( f'(x) \) có đồ thị như hình vẽ bên dưới
\begin{center}
...
\questionLinesManual{0}{27}{Cho hàm số \( y = f(x) \) có đạo hàm trên \( \mathbb{R} \) và đồ thị của hàm số \( y = f'(x) \) như hình vẽ.
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Hệ trục tọa độ
    \draw[->] (-4.5,0) -- (4.5,0) node[below] {\small $x$};
...
\end{tikzpicture}
\end{center}
Hàm số \( g(x) = f(x) - 2 \) nghịch biến trên khoảng nào?}{%
\begin{tasks}(4)
\task \((-1; 1)\)
\task \((-\infty; -2)\)
\task \((2; +\infty)\)
...
\questionLinesManual{0}{28}{Cho hàm số \( y = f(x) \) xác định, có đạo hàm trên \( \mathbb{R} \) và \( f'(x) \) có đồ thị như hình vẽ bên dưới
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Hệ trục tọa độ
    \draw[->] (-4.5,0) -- (4.5,0) node[below] {\small $x$};
