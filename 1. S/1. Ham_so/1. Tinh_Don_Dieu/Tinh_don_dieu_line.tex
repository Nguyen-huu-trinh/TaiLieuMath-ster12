...
\questionLinesManual{5}{1}{ Cho hàm số \( f(x) \) có bảng biến thiên như sau:
...
% ====== CÂU 3 ======
\questionLinesManual{5}{3}{Cho hàm số \( y = f(x) \) có bảng xét dấu đạo hàm như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3]
{$x$ / 1, $y'$ / 1}
...
% ====== CÂU 4 ======
\questionLinesManual{5}{4}{Cho hàm số \( y = f(x) \) có bảng xét dấu của đạo hàm như hình vẽ.
...
% ====== CÂU 5 ======
\questionLinesManual{5}{5}{Cho hàm số \( y = f(x) \) có bảng biến thiên như hình dưới đây. Mệnh đề nào sau đây là đúng?
\begin{center}
\begin{tikzpicture}
...
% ====== CÂU 6 ======
% ====== CÂU 6 ======
\questionLinesManual{5}{6}{Cho hàm số \( f(x) \) có bảng biến thiên như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1, $f(x)$ / 2.5}
...
% ====== CÂU 7 ======
\questionLinesManual{5}{7}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \) có bảng xét dấu \( f'(x) \) cho như hình vẽ.
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1}
...
% ====== CÂU 8 ======
\questionLinesManual{5}{8}{Cho hàm số \( f(x) \) có bảng biến thiên như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1, $f(x)$ / 2.5}
...
% ====== CÂU 9 ======
\questionLinesManual{5}{9}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $y'$ / 1, $y$ / 2.5}
...
% ====== CÂU 10 ======
\questionLinesManual{5}{10}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \) có bảng xét dấu \( f'(x) \) cho như hình vẽ.
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1}
...
% ====== CÂU 11 ======
\questionLinesManual{5}{11}{Cho hàm số \( f(x) \) có bảng biến thiên như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1, $f(x)$ / 2.5}
...
% ====== CÂU 12 ======
\questionLinesManual{5}{12}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1, $f(x)$ / 2.5}
...
% ====== CÂU 13 ======
\questionLinesManual{5}{13}{Cho hàm số \( f(x) \) có bảng biến thiên như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1, $f(x)$ / 2.5}
...
\questionLinesManual{5}{14}{Cho hàm số \( f(x) \) có bảng biến thiên như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1, $f(x)$ / 2.5}
...
% ====== CÂU 16 ======
\questionLinesManual{5}{16}{Cho hàm số \( y = f(x) \) có đồ thị là đường cong hình bên. Hàm số đã cho đồng biến trên khoảng nào dưới đây?
\begin{center}
...
\questionLinesManual{5}{17}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên. Hàm số đã cho đồng biến trên khoảng nào dưới đây?
\begin{center}
...
\questionLinesManual{5}{18}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên. Hàm số đã cho nghịch biến trên khoảng nào dưới đây?
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Vẽ hệ trục tọa độ Ox, Oy
...
\questionLinesManual{5}{19}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên. Hàm số đã cho nghịch biến trên khoảng nào dưới đây?
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Vẽ hệ trục tọa độ Ox, Oy
    \draw[->] (-2.5,0) -- (2.5,0) node[above] {\small $x$};
...
\questionLinesManual{5}{20}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên.
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Vẽ hệ trục tọa độ Ox, Oy
...
\questionLinesManual{5}{21}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên. Hàm số đã cho đồng biến trên khoảng nào?
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Vẽ hệ trục tọa độ Ox, Oy
...
\questionLinesManual{5}{22}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên. Hàm số đã cho nghịch biến trên khoảng nào?
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Vẽ hệ trục tọa độ Ox, Oy
...
\questionLinesManual{5}{23}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên. Hàm số đã cho nghịch biến trên khoảng nào?
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Vẽ hệ trục tọa độ Ox, Oy
    \draw[->] (-2.5,0) -- (2.5,0) node[above] {\small $x$};
...
\questionLinesManual{5}{24}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên.
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Vẽ hệ trục tọa độ Ox, Oy
...
% ====== CÂU 25 ======
\questionLinesManual{5}{25}{Cho hàm số \( f(x) \) liên tục trên \( \mathbb{R} \) và có đồ thị như hình vẽ bên. Khẳng định nào sau đây là đúng?
\begin{center}
\begin{tikzpicture}[>=latex, scale=1]
    % Hệ trục tọa độ
    \draw[->] (-2.5,0) -- (2.5,0) node[below] {\small $x$};
...
% ====== CÂU 26 ======
\questionLinesManual{5}{26}{Cho hàm số \( y = f(x) \) đồ thị hàm số như hình vẽ. Hàm số đồng biến trên khoảng nào?
\begin{center}
...
\questionLinesManual{8}{27}{Cho hàm số \( y = x^3 - 3x^2 \). Mệnh đề nào dưới đây đúng?
...
\questionLinesManual{8}{28}{Hỏi hàm số \( y = 2x^4 + 1 \) đồng biến trên khoảng nào?
\begin{tasks}(4)
\task \( (-\infty; 0) \)
\task \( (-\infty; -\dfrac{1}{2}) \)
\task \( (0; +\infty) \)
...
\questionLinesManual{8}{29}{Cho hàm số \( y = f(x) \) có đạo hàm \( f'(x) = x^2 + 1 \), \( \forall x \in \mathbb{R} \). Mệnh đề nào dưới đây đúng?}{%
\begin{tasks}(2)
...
\questionLinesManual{8}{30}{Cho hàm số \( y = x^3 - 2x^2 + x + 1 \). Mệnh đề nào dưới đây đúng?}{%
\begin{tasks}(2)
\task Hàm số nghịch biến trên khoảng \( (1; +\infty) \)
...
\questionLinesManual{8}{31}{Cho hàm số \( y = x^4 - 2x^2 \). Mệnh đề nào dưới đây đúng?
\begin{tasks}(2)
\task Hàm số nghịch biến trên khoảng \((-\infty; -2)\)
...
\questionLinesManual{8}{32}{Cho hàm số \( y = x^3 + 3x + 2 \). Mệnh đề nào dưới đây là đúng?}{%
\begin{tasks}(1)
...
\questionLinesManual{10}{33}{Cho hàm số \( y = \sqrt{2x^2 + 1} \). Mệnh đề nào dưới đây đúng?}{%
\begin{tasks}(1)
...
\questionLinesManual{8}{34}{Cho hàm số \( y = \dfrac{x^3}{3} - x^2 + x + 2019 \). Mệnh đề nào dưới đây đúng?}{%
\begin{tasks}(1)
...
\questionLinesManual{8}{35}{Hàm số \( y = -x^3 + 3x^2 - 2 \) đồng biến trên khoảng
...
\questionLinesManual{8}{36}{Hàm số \( y = x^4 - 4x^3 \) đồng biến trên khoảng
...
\questionLinesManual{5}{37}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \) và có đạo hàm  
\( f'(x) = (1 - x)^2 (x + 1)^3 (3 - x). \)  
...
\questionLinesManual{10}{38}{Cho hàm số \( y = \log_3 (x^2 - 2x + 3) \). Hàm số đồng biến trên khoảng nào sau đây?}{%
\begin{tasks}(4)
\task \((-\infty; 1)\)
\task \((-1; +\infty)\)
\task \((-\infty; -1)\)
...
\questionLinesManual{5}{39}{Cho hàm số \( y = f(x) \) có đạo hàm \( f'(x) = x(x - 2)^3 \), với mọi \( x \in \mathbb{R} \). Hàm số đã cho nghịch biến trên khoảng nào dưới đây?}{%
\begin{tasks}(4)
\task \((1; 3)\)
\task \((-1; 0)\)
\task \((0; 1)\)
...
\questionLinesManual{10}{40}{Cho hàm \( y = \sqrt{x^2 - 6x + 5} \). Mệnh đề nào sau đây là đúng?}{%
\begin{tasks}(2)
...
\questionLinesManual{5}{41}{Hàm số \( y = f(x) \) có đạo hàm \( y' = x^2 \). Mệnh đề nào sau đây đúng?}{%
\begin{tasks}(1)
...
\questionLinesManual{5}{42}{Cho hàm số \( f(x) \) liên tục trên \( \mathbb{R} \) có đạo hàm  
...
\questionLinesManual{8}{43}{Hàm số nào dưới đây đồng biến trên khoảng \((-\infty;+\infty)\)?}{%
\begin{tasks}(4)
\task \(y = -x^3 - 2x + 1\)
\task \(y = \frac{x-2}{x+1}\)
\task \(y = 3x^3 + 3x - 2\)
...
\questionLinesManual{8}{44}{Trong các hàm số cho dưới đây, hàm số nào đồng biến trên \( \mathbb{R} \)?}{%
\begin{tasks}(4)
...
\questionLinesManual{8}{45}{Hàm số nào sau đây nghịch biến trên các khoảng xác định của nó?}{%
\begin{tasks}(4)
\task \(y = e^{-x}\)
\task \(y = \log_{\sqrt{3}}x\)
\task \(y = (\sqrt{2})^x\)
...
\questionLinesManual{8}{46}{Hàm số nào dưới đây nghịch biến trên \((-\infty;+\infty)\)?}{%
\begin{tasks}(4)
\task \(y = \ln x\)
...
\questionLinesManual{5}{47}{Cho hàm số \( y = f(x) \) xác định, có đạo hàm trên \( \mathbb{R} \) và \( f'(x) \) có đồ thị như hình vẽ bên dưới
\begin{center}
\begin{tikzpicture}[>=latex, scale=1]
    % Hệ trục tọa độ
...
\questionLinesManual{5}{48}{Cho hàm số \( y = f(x) \) có đạo hàm trên \( \mathbb{R} \) và đồ thị của hàm số \( y = f'(x) \) như hình vẽ.
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Hệ trục tọa độ
    \draw[->] (-4.5,0) -- (4.5,0) node[below] {\small $x$};
...
\questionLinesManual{5}{49}{Cho hàm số \( y = f(x) \) xác định, có đạo hàm trên \( \mathbb{R} \) và \( f'(x) \) có đồ thị như hình vẽ bên dưới
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Hệ trục tọa độ
    \draw[->] (-4.5,0) -- (4.5,0) node[below] {\small $x$};
...
\questionLinesManual{5}{50}{Cho hàm số \( y = f(x) \) có đạo hàm trên \( \mathbb{R} \) thỏa mãn \( f'(x) > 0, \forall x \in (-1; 0) \) và \( f'(x) < 0, \forall x \in (0; 1) \). Khẳng định nào sau đây là đúng?}{%
\begin{tasks}(1)
...
\questionLinesManual{5}{51}{Cho hàm số \( y = f(x) \) xác định với mọi \( x \neq 0 \) và có bảng xét dấu \( f'(x) \) như hình vẽ dưới đây.
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1}
...
% ====== CÂU 54 (Đúng/Sai) ======
\questionTrueFalse{12}{54}{Cho hàm số \( f(x) = x^2 e^x \).}{
...
% ====== CÂU 55 (Câu 4) ======
\questionTrueFalse{12}{55}{Cho hàm số \( f(x) \) có đạo hàm \( f'(x) = x(x-3)^3 \) với mọi \( x \in \mathbb{R} \). }{
...
% ====== CÂU 56 (Câu 5) ======
\questionTrueFalse{15}{56}{Cho hàm số \( y = f(x) \) có đạo hàm trên \( \mathbb{R} \) và đồ thị hàm số \( y = f'(x) \) như hình.
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Hệ trục tọa độ
...
% ====== CÂU 57 (Câu 6) ======
\questionTrueFalse{15}{57}{Cho hàm số bậc bốn \( y = f(x) \) có dạng đồ thị như hình vẽ.
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Hệ trục tọa độ
...
% ====== CÂU 58 (Câu 7) ======
\questionTrueFalse{7}{58}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \) và có bảng biến thiên như sau:
 \begin{center}
...
% ====== CÂU 59 (Câu 8) ======
\questionTrueFalse{7}{59}{Cho hàm số \( f(x) \) có bảng xét dấu đạo hàm như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3]
{$x$ / 1, $y'$ / 1}
...
% ====== CÂU 60 (Câu 9) ======
\questionTrueFalse{15}{60}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên.
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Hệ trục tọa độ
...
% ====== CÂU 63 (Câu 12) ======
\questionTrueFalse{15}{63}{Cho hàm số \( y = \sqrt{x^3 - 3x} \). Khi đó:}{
