...
\questionLinesManual{3}{1}{ Cho hàm số \( f(x) \) có bảng biến thiên như sau:
...
% ====== CÂU 2 ======
\questionLinesManual{3}{2}{Cho hàm số \( f(x) \) có bảng biến thiên như sau:
\begin{center}
\begin{tikzpicture}
...
% ====== CÂU 3 ======
\questionLinesManual{3}{3}{Cho hàm số \( y = f(x) \) có bảng xét dấu đạo hàm như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3]
{$x$ / 1, $y'$ / 1}
...
% ====== CÂU 4 ======
\questionLinesManual{3}{4}{Cho hàm số \( y = f(x) \) có bảng xét dấu của đạo hàm như hình vẽ.
...
% ====== CÂU 5 ======
\questionLinesManual{3}{5}{Cho hàm số \( y = f(x) \) có bảng biến thiên như hình dưới đây. Mệnh đề nào sau đây là đúng?
\begin{center}
\begin{tikzpicture}
...
% ====== CÂU 6 ======
% ====== CÂU 6 ======
\questionLinesManual{3}{6}{Cho hàm số \( f(x) \) có bảng biến thiên như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1, $f(x)$ / 2.5}
...
% ====== CÂU 7 ======
\questionLinesManual{3}{7}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \) có bảng xét dấu \( f'(x) \) cho như hình vẽ.
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1}
...
% ====== CÂU 8 ======
\questionLinesManual{3}{8}{Cho hàm số \( f(x) \) có bảng biến thiên như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1, $f(x)$ / 2.5}
...
% ====== CÂU 9 ======
\questionLinesManual{3}{9}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $y'$ / 1, $y$ / 2.5}
...
% ====== CÂU 10 ======
\questionLinesManual{3}{10}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \) có bảng xét dấu \( f'(x) \) cho như hình vẽ.
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1}
...
% ====== CÂU 11 ======
\questionLinesManual{3}{11}{Cho hàm số \( f(x) \) có bảng biến thiên như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1, $f(x)$ / 2.5}
...
% ====== CÂU 13 ======
\questionLinesManual{3}{13}{Cho hàm số \( f(x) \) có bảng biến thiên như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1, $f(x)$ / 2.5}
...
\questionLinesManual{3}{14}{Cho hàm số \( f(x) \) có bảng biến thiên như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1, $f(x)$ / 2.5}
...
% ====== CÂU 15 ======
\questionLinesManual{3}{15}{Cho hàm số \( f(x) \) có bảng biến thiên như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1, $f(x)$ / 2.5}
...
% ====== CÂU 16 ======
\questionLinesManual{3}{16}{Cho hàm số \( y = f(x) \) có đồ thị là đường cong hình bên. Hàm số đã cho đồng biến trên khoảng nào dưới đây?
\begin{center}
...
\questionLinesManual{3}{17}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên. Hàm số đã cho đồng biến trên khoảng nào dưới đây?
\begin{center}
...
\questionLinesManual{3}{18}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên. Hàm số đã cho nghịch biến trên khoảng nào dưới đây?
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Vẽ hệ trục tọa độ Ox, Oy
...
\questionLinesManual{3}{19}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên. Hàm số đã cho nghịch biến trên khoảng nào dưới đây?
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Vẽ hệ trục tọa độ Ox, Oy
    \draw[->] (-2.5,0) -- (2.5,0) node[above] {\small $x$};
...
\questionLinesManual{3}{20}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên.
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Vẽ hệ trục tọa độ Ox, Oy
...
\questionLinesManual{3}{21}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên. Hàm số đã cho đồng biến trên khoảng nào?
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Vẽ hệ trục tọa độ Ox, Oy
...
\questionLinesManual{3}{22}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên. Hàm số đã cho nghịch biến trên khoảng nào?
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Vẽ hệ trục tọa độ Ox, Oy
...
\questionLinesManual{3}{23}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên. Hàm số đã cho nghịch biến trên khoảng nào?
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Vẽ hệ trục tọa độ Ox, Oy
    \draw[->] (-2.5,0) -- (2.5,0) node[above] {\small $x$};
...
\questionLinesManual{3}{24}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên.
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Vẽ hệ trục tọa độ Ox, Oy
...
% ====== CÂU 25 ======
\questionLinesManual{3}{25}{Cho hàm số \( f(x) \) liên tục trên \( \mathbb{R} \) và có đồ thị như hình vẽ bên. Khẳng định nào sau đây là đúng?
\begin{center}
\begin{tikzpicture}[>=latex, scale=1]
    % Hệ trục tọa độ
    \draw[->] (-2.5,0) -- (2.5,0) node[below] {\small $x$};
...
% ====== CÂU 26 ======
\questionLinesManual{3}{26}{Cho hàm số \( y = f(x) \) đồ thị hàm số như hình vẽ. Hàm số đồng biến trên khoảng nào?
\begin{center}
...
\questionLinesManual{3}{27}{Cho hàm số \( y = x^3 - 3x^2 \). Mệnh đề nào dưới đây đúng?
...
\questionLinesManual{3}{28}{Hỏi hàm số \( y = 2x^4 + 1 \) đồng biến trên khoảng nào?
\begin{tasks}(4)
\task \( (-\infty; 0) \)
\task \( (-\infty; -\dfrac{1}{2}) \)
\task \( (0; +\infty) \)
...
\questionLinesManual{3}{29}{Cho hàm số \( y = f(x) \) có đạo hàm \( f'(x) = x^2 + 1 \), \( \forall x \in \mathbb{R} \). Mệnh đề nào dưới đây đúng?}{%
\begin{tasks}(2)
...
\questionLinesManual{3}{30}{Cho hàm số \( y = x^3 - 2x^2 + x + 1 \). Mệnh đề nào dưới đây đúng?}{%
\begin{tasks}(2)
\task Hàm số nghịch biến trên khoảng \( (1; +\infty) \)
...
\questionLinesManual{3}{31}{Cho hàm số \( y = x^4 - 2x^2 \). Mệnh đề nào dưới đây đúng?
\begin{tasks}(2)
\task Hàm số nghịch biến trên khoảng \((-\infty; -2)\)
...
\questionLinesManual{3}{32}{Cho hàm số \( y = x^3 + 3x + 2 \). Mệnh đề nào dưới đây là đúng?}{%
\begin{tasks}(1)
...
\questionLinesManual{3}{33}{Cho hàm số \( y = \sqrt{2x^2 + 1} \). Mệnh đề nào dưới đây đúng?}{%
\begin{tasks}(1)
...
\questionLinesManual{3}{34}{Cho hàm số \( y = \dfrac{x^3}{3} - x^2 + x + 2019 \). Mệnh đề nào dưới đây đúng?}{%
\begin{tasks}(1)
...
\questionLinesManual{3}{35}{Hàm số \( y = -x^3 + 3x^2 - 2 \) đồng biến trên khoảng
...
\questionLinesManual{3}{36}{Hàm số \( y = x^4 - 4x^3 \) đồng biến trên khoảng
...
\questionLinesManual{3}{37}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \) và có đạo hàm  
\( f'(x) = (1 - x)^2 (x + 1)^3 (3 - x). \)  
...
\questionLinesManual{3}{38}{Cho hàm số \( y = \log_3 (x^2 - 2x + 3) \). Hàm số đồng biến trên khoảng nào sau đây?}{%
\begin{tasks}(4)
\task \((-\infty; 1)\)
\task \((-1; +\infty)\)
\task \((-\infty; -1)\)
...
\questionLinesManual{3}{39}{Cho hàm số \( y = f(x) \) có đạo hàm \( f'(x) = x(x - 2)^3 \), với mọi \( x \in \mathbb{R} \). Hàm số đã cho nghịch biến trên khoảng nào dưới đây?}{%
\begin{tasks}(4)
\task \((1; 3)\)
\task \((-1; 0)\)
\task \((0; 1)\)
...
\questionLinesManual{3}{40}{Cho hàm \( y = \sqrt{x^2 - 6x + 5} \). Mệnh đề nào sau đây là đúng?}{%
\begin{tasks}(2)
...
\questionLinesManual{3}{41}{Hàm số \( y = f(x) \) có đạo hàm \( y' = x^2 \). Mệnh đề nào sau đây đúng?}{%
\begin{tasks}(1)
...
\questionLinesManual{3}{42}{Cho hàm số \( f(x) \) liên tục trên \( \mathbb{R} \) có đạo hàm  
...
\questionLinesManual{3}{43}{Hàm số nào dưới đây đồng biến trên khoảng \((-\infty;+\infty)\)?}{%
\begin{tasks}(4)
\task \(y = -x^3 - 2x + 1\)
\task \(y = \frac{x-2}{x+1}\)
\task \(y = 3x^3 + 3x - 2\)
...
\questionLinesManual{3}{44}{Trong các hàm số cho dưới đây, hàm số nào đồng biến trên \( \mathbb{R} \)?}{%
\begin{tasks}(4)
...
\questionLinesManual{3}{45}{Hàm số nào sau đây nghịch biến trên các khoảng xác định của nó?}{%
\begin{tasks}(4)
\task \(y = e^{-x}\)
\task \(y = \log_{\sqrt{3}}x\)
\task \(y = (\sqrt{2})^x\)
...
\questionLinesManual{3}{46}{Hàm số nào dưới đây nghịch biến trên \((-\infty;+\infty)\)?}{%
\begin{tasks}(4)
\task \(y = \ln x\)
...
\questionLinesManual{3}{47}{Cho hàm số \( y = f(x) \) xác định, có đạo hàm trên \( \mathbb{R} \) và \( f'(x) \) có đồ thị như hình vẽ bên dưới
\begin{center}
\begin{tikzpicture}[>=latex, scale=1]
    % Hệ trục tọa độ
...
\questionLinesManual{3}{48}{Cho hàm số \( y = f(x) \) có đạo hàm trên \( \mathbb{R} \) và đồ thị của hàm số \( y = f'(x) \) như hình vẽ.
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Hệ trục tọa độ
    \draw[->] (-4.5,0) -- (4.5,0) node[below] {\small $x$};
...
\questionLinesManual{3}{49}{Cho hàm số \( y = f(x) \) xác định, có đạo hàm trên \( \mathbb{R} \) và \( f'(x) \) có đồ thị như hình vẽ bên dưới
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Hệ trục tọa độ
    \draw[->] (-4.5,0) -- (4.5,0) node[below] {\small $x$};
...
\questionLinesManual{3}{50}{Cho hàm số \( y = f(x) \) có đạo hàm trên \( \mathbb{R} \) thỏa mãn \( f'(x) > 0, \forall x \in (-1; 0) \) và \( f'(x) < 0, \forall x \in (0; 1) \). Khẳng định nào sau đây là đúng?}{%
\begin{tasks}(1)
...
\questionLinesManual{3}{51}{Cho hàm số \( y = f(x) \) xác định với mọi \( x \neq 0 \) và có bảng xét dấu \( f'(x) \) như hình vẽ dưới đây.
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3.5]
{$x$ / 1, $f'(x)$ / 1}
...
% ====== CÂU 52 (Đúng/Sai) ======
\questionTrueFalse{10}{52}{Cho hàm số \( y = f(x) \) có bảng xét dấu đạo hàm như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3]
{$x$ / 1, $f'(x)$ / 1}
...
% ====== CÂU 53 (Đúng/Sai) ======
\questionTrueFalse{10}{53}{Cho hàm số \( y = \dfrac{x^3}{3} - 2x^2 + 3x - 1 \).}{
...
% ====== CÂU 54 (Đúng/Sai) ======
\questionTrueFalse{10}{54}{Cho hàm số \( f(x) = x^2 e^x \).}{
...
% ====== CÂU 55 (Câu 4) ======
\questionTrueFalse{10}{55}{Cho hàm số \( f(x) \) có đạo hàm \( f'(x) = x(x-3)^3 \) với mọi \( x \in \mathbb{R} \). }{
...
% ====== CÂU 56 (Câu 5) ======
\questionTrueFalse{10}{56}{Cho hàm số \( y = f(x) \) có đạo hàm trên \( \mathbb{R} \) và đồ thị hàm số \( y = f'(x) \) như hình.
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Hệ trục tọa độ
...
% ====== CÂU 57 (Câu 6) ======
\questionTrueFalse{10}{57}{Cho hàm số bậc bốn \( y = f(x) \) có dạng đồ thị như hình vẽ.
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Hệ trục tọa độ
...
% ====== CÂU 58 (Câu 7) ======
\questionTrueFalse{10}{58}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \) và có bảng biến thiên như sau:
 \begin{center}
...
% ====== CÂU 59 (Câu 8) ======
\questionTrueFalse{10}{59}{Cho hàm số \( f(x) \) có bảng xét dấu đạo hàm như sau:
\begin{center}
\begin{tikzpicture}
\tkzTabInit[color, lgt=1.5, espcl=3]
{$x$ / 1, $y'$ / 1}
...
% ====== CÂU 60 (Câu 9) ======
\questionTrueFalse{10}{60}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ bên.
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % Hệ trục tọa độ
...
% ====== CÂU 61 (Câu 10) ======
\questionTrueFalse{10}{61}{Cho hàm số \( y = f(x) \) đồng biến trên khoảng \( (a; b) \). Khi đó:}{
...
% ====== CÂU 62 (Câu 11) ======
\questionTrueFalse{10}{62}{Giả sử hàm số \( (C): y = f(x) \) nghịch biến trên khoảng \( K \) và hàm số \( (C'): y = g(x) \) đồng biến trên khoảng \( K \). Khi đó:}{
...
% ====== CÂU 63 (Câu 12) ======
\questionTrueFalse{10}{63}{Cho hàm số \( y = \sqrt{x^3 - 3x} \). Khi đó:}{
