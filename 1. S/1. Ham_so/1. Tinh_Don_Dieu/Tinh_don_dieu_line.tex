...
\questionLinesManual{5}{27}{Cho hàm số \( y = x^3 - 3x^2 \). Mệnh đề nào dưới đây đúng?
...
\questionLinesManual{5}{28}{Hỏi hàm số \( y = 2x^4 + 1 \) đồng biến trên khoảng nào?
\begin{tasks}(4)
\task \( (-\infty; 0) \)
\task \( (-\infty; -\dfrac{1}{2}) \)
\task \( (0; +\infty) \)
...
\questionLinesManual{5}{29}{Cho hàm số \( y = f(x) \) có đạo hàm \( f'(x) = x^2 + 1 \), \( \forall x \in \mathbb{R} \). Mệnh đề nào dưới đây đúng?}{%
\begin{tasks}(2)
...
\questionLinesManual{5}{30}{Cho hàm số \( y = x^3 - 2x^2 + x + 1 \). Mệnh đề nào dưới đây đúng?}{%
\begin{tasks}(2)
\task Hàm số nghịch biến trên khoảng \( (1; +\infty) \)
...
\questionLinesManual{5}{31}{Cho hàm số \( y = x^4 - 2x^2 \). Mệnh đề nào dưới đây đúng?
\begin{tasks}(2)
\task Hàm số nghịch biến trên khoảng \((-\infty; -2)\)
...
\questionLinesManual{5}{32}{Cho hàm số \( y = x^3 + 3x + 2 \). Mệnh đề nào dưới đây là đúng?}{%
\begin{tasks}(1)
...
\questionLinesManual{5}{33}{Cho hàm số \( y = \sqrt{2x^2 + 1} \). Mệnh đề nào dưới đây đúng?}{%
\begin{tasks}(1)
...
\questionLinesManual{5}{34}{Cho hàm số \( y = \dfrac{x^3}{3} - x^2 + x + 2019 \). Mệnh đề nào dưới đây đúng?}{%
\begin{tasks}(1)
...
\questionLinesManual{5}{35}{Hàm số \( y = -x^3 + 3x^2 - 2 \) đồng biến trên khoảng
...
\questionLinesManual{5}{36}{Hàm số \( y = x^4 - 4x^3 \) đồng biến trên khoảng
...
\questionLinesManual{5}{38}{Cho hàm số \( y = \log_3 (x^2 - 2x + 3) \). Hàm số đồng biến trên khoảng nào sau đây?}{%
\begin{tasks}(4)
\task \((-\infty; 1)\)
\task \((-1; +\infty)\)
\task \((-\infty; -1)\)
...
\questionLinesManual{5}{40}{Cho hàm \( y = \sqrt{x^2 - 6x + 5} \). Mệnh đề nào sau đây là đúng?}{%
\begin{tasks}(2)
...
\questionLinesManual{5}{43}{Hàm số nào dưới đây đồng biến trên khoảng \((-\infty;+\infty)\)?}{%
\begin{tasks}(4)
\task \(y = -x^3 - 2x + 1\)
\task \(y = \frac{x-2}{x+1}\)
\task \(y = 3x^3 + 3x - 2\)
...
\questionLinesManual{5}{44}{Trong các hàm số cho dưới đây, hàm số nào đồng biến trên \( \mathbb{R} \)?}{%
\begin{tasks}(4)
...
\questionLinesManual{5}{45}{Hàm số nào sau đây nghịch biến trên các khoảng xác định của nó?}{%
\begin{tasks}(4)
\task \(y = e^{-x}\)
\task \(y = \log_{\sqrt{3}}x\)
\task \(y = (\sqrt{2})^x\)
...
\questionLinesManual{5}{46}{Hàm số nào dưới đây nghịch biến trên \((-\infty;+\infty)\)?}{%
\begin{tasks}(4)
\task \(y = \ln x\)
