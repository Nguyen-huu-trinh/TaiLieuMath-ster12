...
\questionLinesManual{3}{3}{ Cho hàm số \( f(x) \) có đồ thị như hình vẽ
...
\questionLinesManual{3}{4}{ Cho hàm số \( y = f(x) \) liên tục và có đồ thị trên đoạn \([-2; 4]\) như hình vẽ bên. Tổng giá trị lớn nhất và nhỏ nhất của hàm số \( y = f(x) \) trên đoạn \([-2; 4]\) bằng
...
\questionLinesManual{3}{5}{Cho hàm số \( y = f(x) \) liên tục trên đoạn \([-2; 6]\) và có đồ thị như hình vẽ sau. Tổng giá trị lớn nhất và giá trị nhỏ nhất của hàm số \( y = f(x) \) trên đoạn \([-2; 6]\) bằng
...
\questionLinesManual{3}{6}{ Cho hàm số \( y = f(x) \) liên tục trên \([-1; 3]\) và có đồ thị như hình bên.
...
\questionLinesManual{3}{7}{ Cho hàm số \( y = f(x) \) liên tục trên đoạn \([1; 5]\) và có đồ thị trên như hình vẽ sau.
...
\questionLinesManual{3}{8}{ Cho hàm số \( f(x) \) liên tục trên \([-1; 5]\) và có đồ thị trên đoạn \([-1; 5]\) như hình vẽ bên dưới. Tổng giá trị lớn nhất và giá trị nhỏ nhất của hàm số \( f(x) \) trên đoạn \([-1; 5]\) bằng
...
\questionLinesManual{3}{9}{ Cho hàm số \( f(x) \) liên tục trên đoạn \([-2; 2]\) có đồ thị như hình vẽ. Gọi \( M \) và \( m \) lần lượt là giá trị lớn nhất và nhỏ nhất của hàm số trên đoạn \([-2; 2]\). Khi đó, tổng \( M + m \) bằng
...
\questionLinesManual{3}{10}{Cho hàm số \( y = f(x) \) có đồ thị trên đoạn \([-3; 5]\) như hình vẽ. Gọi \( M, m \) lần lượt là giá trị lớn nhất và giá trị nhỏ nhất của hàm số đã cho trên đoạn \([-3; 5]\). Tính \( 2M - m \).
...
\questionLinesManual{3}{11}{ Cho hàm số \( y = f(x) \), có đồ thị trên đoạn \([-2; 2]\) như hình vẽ.
...
\questionLinesManual{3}{12}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ. Giá trị lớn nhất của hàm số \( y = f(x) \) trên đoạn \([-2; 0]\) bằng:
...
\questionLinesManual{3}{13}{ Cho hàm số \( y = f(x) \) liên tục trên đoạn \([-1; 3]\) và có đồ thị như hình vẽ bên. Gọi \( M \) và \( m \) lần lượt là giá trị lớn nhất và nhỏ nhất của hàm số đã cho trên đoạn \([-1; 3]\). Giá trị của \( M - m \) bằng
...
\questionLinesManual{3}{14}{Cho hàm số \( y = f(x) \) xác định và liên tục trên \( \mathbb{R} \) có đồ thị như hình vẽ bên. Tìm giá trị nhỏ nhất \( m \) và giá trị lớn nhất \( M \) của hàm số \( y = f(x) \) trên đoạn \([-2; 2]\).
...
\questionLinesManual{3}{15}{ Cho hàm số \( f(x) \) liên tục trên \([-1; 5]\) và có đồ thị trên đoạn \([-1; 5]\) như hình vẽ bên dưới. Tổng giá trị lớn nhất và giá trị nhỏ nhất của hàm số \( f(x) \) trên đoạn \([-1; 5]\) bằng
...
\questionLinesManual{3}{16}{ Cho hàm số \( y = f(x) \) xác định, liên tục trên \([-1, \dfrac{5}{2}]\) và có đồ thị là đường cong như hình vẽ.
...
\questionLinesManual{3}{17}{ Cho hàm số \( y = f(x) \) liên tục trên đoạn \([-1; 3]\) và có đồ thị như hình vẽ bên. Gọi \( M, m \) lần lượt là giá trị lớn nhất và giá trị nhỏ nhất của hàm số đã cho trên đoạn \([-1; 3]\). Giá trị của \( M + m \) là
...
\questionLinesManual{3}{18}{Cho hàm số \( f(x) \) liên tục trên đoạn \([0;3]\) và có đồ thị như hình vẽ bên. Gọi \( M \) và \( m \) lần lượt là giá trị lớn nhất và nhỏ nhất của hàm số đã cho trên \([0;3]\). Giá trị của \( M + m \) bằng?
...
\questionLinesManual{3}{19}{ Cho hàm số \( y = f(x) \) liên tục trên đoạn \([-2;6]\) và có đồ thị như hình vẽ bên dưới.
...
\questionLinesManual{3}{20}{Cho hàm số \( y = f(x) \) liên tục và có đồ thị trên đoạn \([-2; 4]\) như hình vẽ bên. Tổng giá trị lớn nhất và nhỏ nhất của hàm số \( y = f(x) \) trên đoạn \([-2; 4]\) bằng
...
\questionLinesManual{3}{21}{Cho hàm số \( y = f(x) \) liên tục trên đoạn \([-4; 4]\) có bảng biến thiên như hình vẽ
...
\questionLinesManual{3}{22}{Cho hàm số \( y = f(x) \) liên tục và có bảng biến thiên trên đoạn \([-1; 3]\) như hình vẽ bên. Khẳng định nào đúng?
...
\questionLinesManual{3}{23}{ Cho hàm số \( y = f(x) \) liên tục và có bảng biến thiên trên đoạn \([-1; 3]\) như hình vẽ bên. Khẳng định nào sau đây là đúng?
...
\questionLinesManual{3}{24}{Cho hàm số \( y = f(x) \) có bảng biến thiên trên đoạn \([0; 3]\) như sau.
...
\questionLinesManual{3}{26}{ Cho hàm số \( y = f(x) \) có bảng biến thiên như hình bên. Giá trị lớn nhất của hàm số đã cho trên đoạn \([-2; 4]\) bằng
...
\questionLinesManual{3}{27}{ Cho hàm số \( y = f(x) \) liên tục và có bảng biến thiên trên đoạn \([-1; 3]\) như hình vẽ bên.
...
\questionLinesManual{3}{28}{ Cho hàm số \( y = f(x) \) có bảng xét dấu đạo hàm như sau
...
\questionLinesManual{3}{29}{ Cho hàm số \( y = f(x) \) xác định trên \( \mathbb{R} \) và có bảng xét dấu \( f'(x) \) như sau:
...
\questionLinesManual{3}{30}{ Cho hàm số \( y = f(x) \) liên tục trên đoạn \([-4; 3]\), có bảng biến thiên như hình vẽ. Khẳng định nào sau đây là đúng?
...
\questionLinesManual{3}{31}{Cho hàm số \( y = f(x) \) có bảng biến thiên trên đoạn \([0; 3]\) như sau:
...
\questionLinesManual{3}{32}{ Cho hàm số \( y = f(x) \) xác định, liên tục trên \( \mathbb{R} \) và có bảng biến thiên:
...
\questionLinesManual{3}{33}{Cho hàm số \( y = f(x) \) liên tục trên \([-3; 2]\) và có bảng biến thiên như sau. Gọi \( M, m \) lần lượt là giá trị lớn nhất và giá trị nhỏ nhất của hàm số \( y = f(x) \) trên đoạn \([-1; 2]\). Tính \( M + m \).
...
\questionLinesManual{3}{34}{ Xét hàm số \( y = f(x) \) với \( x \in [-1; 5] \) có bảng biến thiên như sau:
...
\questionLinesManual{3}{35}{ Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \), có bảng biến thiên như hình sau:
...
\questionLinesManual{3}{36}{ Cho hàm số \( y = f(x) \) liên tục và có bảng biến thiên trên đoạn \([-1; 3]\) như hình vẽ bên. Khẳng định nào sau đây đúng?
...
\questionLinesManual{8}{37}{ Gọi \( M, m \) lần lượt là giá trị lớn nhất và giá trị nhỏ nhất của hàm số \( f(x) = x^4 - 2x^2 - 1 \) trên đoạn \([-1; 2]\). Giá trị của biểu thức \( M + 3m \) bằng}{
    \begin{tasks}(4)
        \task $1$
        \task $5$
        \task $6$
...
\questionLinesManual{8}{38}{ Giá trị lớn nhất của hàm số \( f(x) = x^3 - 3x^2 - 9x + 10 \) trên đoạn \([-2; 2]\) bằng:}{
    \begin{tasks}(4)
        \task $-12$
        \task $10$
        \task $15$
...
\questionLinesManual{8}{39}{ Giá trị nhỏ nhất của hàm số \( y = x^3 + 3x - 6 \) trên đoạn \([1; 3]\) là:}{
    \begin{tasks}(4)
        \task $-39$
        \task $-2$
        \task $-10$
...
\questionLinesManual{8}{40}{Giá trị lớn nhất của hàm số \( y = x^3 - 3x + 1 \) trên đoạn \([-2; 0]\)}{
    \begin{tasks}(4)
        \task $1$
        \task $3$
        \task $-1$
...
\questionLinesManual{8}{41}{ Giá trị nhỏ nhất của hàm số \( f(x) = x^3 - 3x + 2 \) trên đoạn \([-3; 3]\) bằng}{
    \begin{tasks}(4)
        \task $0$
        \task $-16$
        \task $4$
...
\questionLinesManual{8}{43}{ Giá trị lớn nhất của hàm số \( f(x) = x^3 + 3x - 6 \) trên đoạn \([1; 3]\) là}{
    \begin{tasks}(4)
        \task $30$
        \task $39$
        \task $36$
...
\questionLinesManual{8}{44}{ Giá trị nhỏ nhất của hàm số \( f(x) = -x^3 - x + 2 \) trên đoạn \([-2; 0]\) bằng?}{
    \begin{tasks}(4)
        \task $2$
        \task $-2$
        \task $0$
...
\questionLinesManual{8}{47}{Giá trị lớn nhất của hàm số \( f(x) = x^3 - 3x^2 - 9x + 10 \) trên đoạn \([-2; 2]\) là}{
    \begin{tasks}(4)
        \task $17$
        \task $10$
        \task $15$
...
\questionLinesManual{8}{48}{ Giá trị nhỏ nhất của hàm số \( y = x^4 - 4x^2 + 3 \) trên đoạn \([0; 4]\) là}{
    \begin{tasks}(4)
        \task $0$
        \task $\sqrt{2}$
        \task $3$
...
\questionLinesManual{8}{49}{ Giá trị lớn nhất của hàm số \( y = x^3 - 3x + 4 \) trên đoạn \([-2; 0]\) bằng}{
    \begin{tasks}(4)
        \task $2$
        \task $4$
        \task $12$
...
\questionLinesManual{8}{50}{ Tìm giá trị lớn nhất \( M \) của hàm số \( y = x^3 + 3x^2 - 9x - 6 \) trên đoạn \([-1; 2]\).}{
    \begin{tasks}(4)
        \task \( M = 21 \)
        \task \( M = 7 \)
        \task \( M = 5 \)
...
\questionLinesManual{8}{51}{ Giá trị lớn nhất \( M \) của hàm số \( y = x^3 + 3x^2 - 9x - 6 \) trên đoạn \([-1; 2]\) là?}{
    \begin{tasks}(4)
        \task \( M = 7 \)
        \task \( M = 5 \)
        \task \( M = -11 \)
...
\questionLinesManual{8}{52}{Giá trị lớn nhất của hàm số \( y = x^3 - 3x \) trên đoạn \([0; 3]\) bằng}{
    \begin{tasks}(4)
        \task $2$
        \task $18$
        \task $-2$
...
\questionLinesManual{8}{55}{Giá trị lớn nhất của hàm số \( y = \sqrt{4 - x^2} \) là}{
    \begin{tasks}(4)
        \task $2$
        \task $0$
        \task $4$
...
\questionLinesManual{8}{56}{Tìm giá trị nhỏ nhất của hàm số \( y = \sin^2 x - 4 \sin x - 5 \).}{
    \begin{tasks}(4)
        \task $-20$
        \task $-8$
        \task $-9$
...
\questionLinesManual{8}{57}{ Gọi \( m, M \) lần lượt là giá trị nhỏ nhất và giá trị lớn nhất của hàm số \( f(x) = \dfrac{1}{2}x - \sqrt{x + 1} \) trên đoạn \([0; 3]\). Tính tổng \( S = 2m + 3M \).}{
    \begin{tasks}(4)
        \task \( S = -\dfrac{7}{2} \)
        \task \( S = -\dfrac{3}{2} \)
        \task $-3$
...
\questionLinesManual{8}{58}{ Tìm giá trị lớn nhất của hàm số \( f(x) = \sin x + \cos 2x \) trên \([0; \pi]\) là}{
    \begin{tasks}(4)
        \task \(\dfrac{9}{8}\)
        \task \(\dfrac{5}{4}\)
        \task $2$
...
\questionLinesManual{8}{59}{Giá trị lớn nhất của hàm số \( y = 2 \cos x - \dfrac{4}{3} \cos^3 x \) trên \([0; \pi]\).}{
    \begin{tasks}(4)
...
\questionLinesManual{8}{60}{Gọi \( M, m \) lần lượt là giá trị lớn nhất và giá trị nhỏ nhất của hàm số \( y = \dfrac{3 \sin x + 2}{\sin x + 1} \) trên đoạn \(\left[ 0; \dfrac{\pi}{2} \right]\). Khi đó giá trị của \( M^2 + m^2 \) là}{
    \begin{tasks}(4)
        \task \(\dfrac{31}{2}\)
        \task \(\dfrac{11}{2}\)
        \task \(\dfrac{41}{4}\)
...
\questionLinesManual{8}{61}{ Tính giá trị nhỏ nhất của hàm số \( y = 3x + \dfrac{4}{x^2} \) trên khoảng \( (0; +\infty) \).}{
    \begin{tasks}(4)
...
\questionLinesManual{8}{64}{ Gọi \( m \) là giá trị nhỏ nhất của hàm số \( y = x + \dfrac{4}{x} \) trên khoảng \( (0; +\infty) \). Tìm \( m \)}{
    \begin{tasks}(4)
        \task \( m = 4 \)
        \task \( m = 2 \)
        \task \( m = 1 \)
...
\questionLinesManual{8}{65}{ Giá trị nhỏ nhất của hàm số \( f(x) = x + \dfrac{1}{x} \) trên nửa khoảng \( [2; +\infty) \) là:}{
    \begin{tasks}(4)
        \task $2$
        \task $\dfrac{5}{2}$
        \task $0$
...
\questionTrueFalse{5}{66}{Sử dụng đồ thị hàm số \( y = f(x) \) (hình bên)

\begin{flushleft}
\begin{tikzpicture}[>=latex, scale=0.6]
    % 1. Hệ trục tọa độ Ox, Oy màu đen
    \draw[->, black, thick] (-0.5, 0) -- (9.5, 0) node[below] {\tiny $x$};
    \draw[->, black, thick] (0, -0.5) -- (0, 5) node[right] {\tiny $y$};
    ...
    \foreach \i/\p in {1/P1, 2/P2, 3/P3, 4/P4, 5/P5, 6/P6, 7/P7, 8/P8} {
        ...
        \node[below] at (\p |- 0,0) {\tiny $x_\i$};
        \fill[black] (\p) circle (1.5pt);
    }

    % 4. Thêm nhãn tên hàm số
    \node[right] at (6.3, 4) {\tiny $y=f(x)$};
...
\questionTrueFalse{5}{67}{Cho hàm số \( y = g(x) \) liên tục trên đoạn \([-3; 3]\) và có đồ thị như hình vẽ. Xét tính đúng sai của các mệnh đề sau

\begin{flushleft}
\begin{tikzpicture}[>=latex, scale=0.6]
    % 1. Hệ trục tọa độ
    \draw[->] (-4,0) -- (4.5,0) node[below] {\tiny $x$};
    \draw[->] (0,-0.5) -- (0,8) node[right] {\tiny $y$};
    \node[below left] at (0,0) {\tiny $O$};
...
\questionTrueFalse{5}{68}{Cho hàm số \( y = f(x) \) liên tục trên đoạn \([-2; 4]\) và có đồ thị như hình vẽ. Xét tính đúng sai của các mệnh đề sau

\begin{flushleft}
\begin{tikzpicture}[>=latex, xscale=0.8, yscale=0.4]
    % 1. Hệ trục tọa độ Ox, Oy màu đen
    \draw[->, black, thick] (-2.8, 0) -- (5.0, 0) node[below] {\tiny $x$};
    \draw[->, black, thick] (0, -4.8) -- (0, 8.2) node[right] {\tiny $y$};
    \node[below left] at (0,0) {\tiny $O$};
...
\questionTrueFalse{5}{69}{Cho hàm số \( y = f(x) \) có bảng biến thiên như hình vẽ. Xét tính đúng sai của các mệnh đề sau
...
\begin{tikzpicture}[>=stealth]
            ...
            \node (y1) at (1.7, -4.5) {$-\infty$};
            \node (y2) at (6.7, -2.5) {$\dfrac{9}{20}$};
...
\questionTrueFalse{5}{70}{Cho hàm số \( y = f(x) \) có bảng biến thiên như hình vẽ.

\begin{flushleft}
\begin{tikzpicture}[>=stealth]
    \tkzTabInit[nocadre=false,lgt=0.6,espcl=1.3]
            {$x$ / 0.6, $y'$ / 0.6, $y$ / 1.5}
        {$-\infty$, $0$, $1$, $+\infty$}
...
\questionTrueFalse{5}{71}{Cho hàm số \( y = f(x) \) xác định, liên tục trên \( D = \mathbb{R} \setminus \{-1\} \) và có bảng biến thiên như hình vẽ.
...
% --- CÂU 72: HÀM SỐ BẬC 3 ---
\questionTrueFalse{6}{72}{Cho hàm số \( y = f(x) = x^3 - 3x^2 - 9x + 35 \). Xét tính đúng sai của các mệnh đề sau}{
...
\questionTrueFalse{8}{73}{Cho hàm số \( f(x) = x^4 - 2x^2 - 15 \). Xét tính đúng sai của các mệnh đề sau}{
...
\questionTrueFalse{5}{74}{Cho hàm số \( f(x) = \dfrac{x^2 + x + 2}{x + 2} \). Xét tính đúng sai của các mệnh đề sau}{
...
\questionTrueFalse{5}{75}{Cho hàm số \( y = f(x) \). Đồ thị hàm số \( y = f'(x) \) trên đoạn \([-2; 2]\) là đường cong trong hình vẽ.

\begin{flushleft}
\begin{tikzpicture}[>=latex, scale=1]
    % 1. Hệ trục tọa độ Ox, Oy màu đen
    \draw[->, black, thick] (-2.8, 0) -- (2.8, 0) node[below] {\tiny $x$};
    \draw[->, black, thick] (0, -1.8) -- (0, 3.5) node[right] {\tiny $y$};
    \node[below left] at (0,0) {\tiny $O$};
    
    % 2. Đồ thị hàm số màu tím (Purple)
    % Đường cong giảm mượt mà từ (-2, 2.8) qua trục Oy, cắt Ox tại (1,0) và dừng ở (2,-1)
    \draw[purple, ultra thick] (-2, 2.8) to[out=-55, in=155] (0, 0.4) 
...
\questionTrueFalse{5}{76}{Cho hàm số \( y = f(x) \). Đồ thị hàm số \( y = f'(x) \) trên đoạn \([-3; 3]\) là đường cong trong hình vẽ.

\begin{flushleft}
\begin{tikzpicture}[>=latex, xscale=0.8, yscale=0.4]
    % 1. Hệ trục tọa độ Ox, Oy màu đen
    \draw[->, black, thick] (-4.0, 0) -- (4.2, 0) node[above] {\tiny $x$};
    \draw[->, black, thick] (0, -5.0) -- (0, 3.8) node[right] {\tiny $y$};
    \node[below left] at (0,0) {\tiny $O$};
...
\questionTrueFalse{8}{77}{Cho hàm số \( f(x) = \dfrac{x}{x^2 + 1} \). Xét tính đúng sai của các mệnh đề sau}{
...
\questionTrueFalse{5}{78}{ Cho đồ thị hàm số \( y = f(x) \) có hình vẽ dưới đây và có tập xác định trên \( \mathbb{R} \).

\begin{flushleft}
\begin{tikzpicture}[>=latex, scale=1]
    % 1. Hệ trục tọa độ Ox, Oy màu đen
    \draw[->, black, thick] (-2, 0) -- (2.5, 0) node[below] {\tiny $x$};
    \draw[->, black, thick] (0, -1.5) -- (0, 2.5) node[left] {\tiny $y$};
...
% --- CÂU 79: ĐỒ THỊ f'(x) ---
\questionTrueFalse{8}{79}{ Cho hàm số \( y = f(x) \) có đạo hàm liên tục trên \( \mathbb{R} \). Hàm số \( y = f'(x) \) có đồ thị như hình dưới đây.

\begin{flushleft}
\begin{tikzpicture}[>=latex, scale=0.8]
    % 1. Hệ trục tọa độ Ox, Oy màu xám đậm
    \draw[->, black!70, thick] (-2.2, 0) -- (5.2, 0) node[below] {\tiny $x$};
    \draw[->, black!70, thick] (0, -2.5) -- (0, 3.2) node[left] {\tiny $y$};
    \node[below left] at (0,0) {\tiny $0$};
    
    % 2. Các nhãn tọa độ trên trục hoành Ox
    \node[below right] at (-1, 0) {\tiny $-1$};
    \node[above right] at (1, 0) {\tiny $1$};
    \node[below right] at (4, 0) {\tiny $4$};
...
\questionTrueFalse{8}{80}{Cho hàm số \( f(x) = 4 \sin x \cos x + 2x \).}{
...
\questionTrueFalse{8}{81}{ Cho hàm số \( f(x) = 2 \cos x + x \).}{
...
\questionTrueFalse{8}{82}{ Cho hàm số \( f(x) = \sin x - x \).}{
...
\questionTrueFalse{8}{83}{Cho hàm số \( f(x) = 2\sin x - \sqrt{3}x \).}{
...
% --- CÂU 84: HÀM SỐ BẬC 3 ---
\questionTrueFalse{8}{84}{Cho hàm số \( y = 2x^3 - 3x^2 + 2025 = f(x) \). Các mệnh đề sau đúng hay sai?}{
...
\questionTrueFalse{8}{85}{Cho hàm số \( y = \dfrac{x^2 - x + 1}{x - 1} = f(x) \). Các mệnh đề sau đúng hay sai?}{
...
\questionTrueFalse{8}{86}{Cho hàm số \( y = f(x) = \dfrac{2x - 1}{x - 3} \).}{
...
\questionTrueFalse{8}{87}{Cho hàm số \( y = x - \ln x \).}{
...
\questionTrueFalse{8}{88}{Cho hàm số \( y = \log_3(x^2 - 2x) \).}{
...
\questionTrueFalse{8}{89}{(Sở Vĩnh Phúc 2025) Cho hàm số \( f(x) = 2x - \log_5(x + 1) \).}{
