...
\begin{tikzpicture}
   ...
   \fill[pattern=north east lines](9,-4.5) rectangle (13,-2);
\end{tikzpicture}
\end{center}}{
    \begin{tasks}(4)
        \task $1$
...
\begin{tikzpicture}
    ...
    \fill[pattern=north east lines](1.5,-4.5) rectangle (4.5,-2);
\end{tikzpicture}
\end{center}
...
\begin{tikzpicture}
    ...
    \tkzTabLine{,,d, +, d, -, }
    \tkzTabVar{,D-/ /$-\infty$ / , +D+/ $+\infty$ / $1$ , -/ $0$ /}
    \fill[pattern=north east lines](1.5,-4.5) rectangle (5.5,-2);
\end{tikzpicture}
\end{center}
