...
% --- CÂU 1 ---
\questionLinesManual{3}{1}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \), (\(ac \neq 0, ad - bc \neq 0\)) có bảng biến thiên như dưới đây.
...
% --- CÂU 2 ---
\questionLinesManual{3}{2}{Cho hàm số \( y = f(x) \) có bảng biến thiên như hình vẽ dưới đây.
...
% --- CÂU 3 ---
\questionLinesManual{3}{3}{Cho hàm số \( f(x) \) xác định trên \( (-\infty; 0) \setminus \{-2\} \) và có bảng biến thiên bên dưới. Đồ thị hàm số đã cho có tổng số đường tiệm cận ngang và tiệm cận đứng là
...
% --- CÂU 4 ---
\questionLinesManual{3}{4}{Cho hàm số \( y = f(x) \) xác định trên \( \mathbb{R} \setminus \{1\} \), liên tục trên mỗi khoảng xác định và có bảng biến thiên như hình bên dưới. Hỏi đồ thị hàm số đã cho có tất cả bao nhiêu đường tiệm cận đứng và đường tiệm cận ngang?
...
\questionLinesManual{3}{5}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) (\(ad - bc \neq 0\); \(c \neq 0\)) có bảng biến thiên như sau
...
% --- CÂU 6 ---
\questionLinesManual{3}{6}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 7 ---
\questionLinesManual{3}{7}{Cho hàm số \( y = f(x) \) xác định trên \( \mathbb{R} \setminus \{1\} \), liên tục trên mỗi khoảng xác định và có bảng biến thiên như sau:
...
% --- CÂU 8 ---
\questionLinesManual{3}{8}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 9 ---
\questionLinesManual{3}{9}{Cho hàm số \( y = f(x) \) xác định trên \( \mathbb{R} \setminus \{1\} \), liên tục trên mỗi khoảng xác định và có bảng biến thiên như hình bên dưới. Hỏi đồ thị hàm số đã cho có tất cả bao nhiêu đường tiệm cận đứng và đường tiệm cận ngang?
...
% --- CÂU 10 ---
\questionLinesManual{3}{10}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau
...
% --- CÂU 11 ---
\questionLinesManual{3}{11}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 12 ---
\questionLinesManual{3}{12}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 13 ---
\questionLinesManual{3}{13}{Cho hàm số \( y = f(x) \) xác định trên \( \mathbb{R} \setminus \{-1\} \) có bảng biến thiên như hình bên
...
% --- CÂU 14 ---
\questionLinesManual{10}{14}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \) và có bảng biến thiên như sau
...
% --- CÂU 15 ---
\questionLinesManual{3}{15}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 16 ---
\questionLinesManual{3}{16}{Cho hàm số \( f(x) \) có bảng biến thiên như sau
...
% --- CÂU 17 ---
\questionLinesManual{3}{17}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 18 ---
\questionLinesManual{3}{18}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau
...
% --- CÂU 19 ---
\questionLinesManual{3}{19}{Cho hàm số có bảng biến thiên như hình sau
...
% --- CÂU 20 ---
\questionLinesManual{3}{20}{Cho hàm số \( y = f(x) \) có bảng biến thiên như hình vẽ dưới đây. Hỏi đồ thị của hàm số đã cho có bao nhiêu đường tiệm cận?
...
% --- CÂU 21 ---
\questionLinesManual{3}{21}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 22 ---
\questionLinesManual{3}{22}{Cho hàm số \( f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 23 ---
\questionLinesManual{3}{23}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 24 ---
\questionLinesManual{3}{24}{Cho hàm số \( f(x) \) có bảng biến thiên như sau
...
% --- CÂU 25 ---
\questionLinesManual{3}{25}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau
...
% --- CÂU 26 ---
\questionLinesManual{3}{26}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \setminus \{1\} \) có bảng biến thiên như hình vẽ. Tổng số đường tiệm cận đứng và đường tiệm cận ngang của đồ thị hàm số \( y = f(x) \)
...
% --- CÂU 27 ---
\questionLinesManual{3}{27}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 28 ---
\questionLinesManual{3}{28}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 29 ---
\questionLinesManual{3}{29}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 30 ---
\questionLinesManual{3}{30}{Cho hàm số \( f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 31 ---
\questionLinesManual{3}{31}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 32 ---
\questionLinesManual{3}{32}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau
...
% --- CÂU 33 ---
\questionLinesManual{3}{33}{Cho hàm số có bảng biến thiên như hình sau
...
% --- CÂU 34 ---
\questionLinesManual{3}{34}{Cho hàm số \( y = f(x) \) có bảng biến thiên như hình vẽ dưới đây. Hỏi đồ thị của hàm số đã cho có bao nhiêu đường tiệm cận?
...
% --- CÂU 35 ---
\questionLinesManual{3}{35}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 36 ---
\questionLinesManual{3}{36}{Cho hàm số \( f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 37 ---
\questionLinesManual{3}{37}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 38 ---
\questionLinesManual{3}{38}{Cho hàm số \( f(x) \) có bảng biến thiên như sau
...
% --- CÂU 39 ---
\questionLinesManual{3}{39}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau
...
% --- CÂU 40 ---
\questionLinesManual{3}{40}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \setminus \{1\} \) có bảng biến thiên như hình vẽ. Tổng số đường tiệm cận đứng và đường tiệm cận ngang của đồ thị hàm số \( y = f(x) \)
...
% --- CÂU 41 ---
\questionLinesManual{3}{41}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 42 ---
\questionLinesManual{3}{42}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
\questionLinesManual{3}{43}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau
...
% --- CÂU 44 ---
\questionLinesManual{3}{44}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ. Đường thẳng nào sau đây là tiệm cận ngang của đồ thị hàm số đã cho
...
% --- CÂU 47 ---
\questionLinesManual{3}{47}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ:
...
% --- CÂU 48 ---
\questionLinesManual{8}{48}{Cho hàm số \( y = \dfrac{ax^2 + bx + c}{mx + n} \) (với \( a \neq 0; m \neq 0 \)) có đồ thị như hình vẽ dưới đây.
...
% --- CÂU 51 ---
\questionLinesManual{3}{51}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) (\( c \neq 0; ad - bc \neq 0 \)) có đồ thị như hình vẽ.
...
% --- CÂU 52 ---
\questionLinesManual{8}{52}{Cho hàm số \( y = \dfrac{ax^2 + bx + c}{mx + n} \) có đồ thị như hình bên.
...
% --- CÂU 53 ---
\questionLinesManual{3}{53}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) (\( c \neq 0; ad - bc \neq 0 \)) có đồ thị như hình vẽ bên dưới.
...
% --- CÂU 54 ---
\questionLinesManual{3}{54}{Đồ thị dưới đây là của hàm số nào trong các hàm số cho ở các phương án \( A, B, C, D \)?
...
% --- CÂU 55 ---
\questionLinesManual{3}{55}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) (\( c \neq 0, ad - bc \neq 0 \)) có đồ thị như hình sau:
...
% --- CÂU 56 ---
\questionLinesManual{3}{56}{Cho hàm số \( y = f(x) \) có đồ thị như hình bên dưới. Khẳng định nào sau đây là đúng?
...
% --- CÂU 57 ---
\questionLinesManual{8}{57}{Cho hàm số \( f(x) = \dfrac{ax^2 + bx + c}{dx + e} \) (\( a, b, c, d, e \in \mathbb{R}, ad \neq 0 \)) có đồ thị như hình vẽ.
...
% --- CÂU 58 ---
\questionLinesManual{3}{58}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) (với \( c \neq 0; ad - bc \neq 0 \)) có đồ thị như hình vẽ dưới đây.
...
% --- CÂU 59 ---
\questionLinesManual{3}{59}{Cho hàm số \( y = f(x) \) có đồ thị như sau:
...
% --- CÂU 60 ---
\questionLinesManual{3}{60}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ dưới đây:
...
% --- CÂU 61 ---
\questionLinesManual{3}{61}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) (\( c \neq 0, ad - bc \neq 0 \)) có đồ thị như hình vẽ bên. Tiệm cận ngang của đồ thị hàm số là:
...
% --- CÂU 62 ---
\questionLinesManual{8}{62}{Cho hàm số \( y = f(x) \) có đồ thị hàm số như hình sau:
...
% --- CÂU 63 ---
\questionLinesManual{3}{63}{Cho đồ thị hàm số \( y = f(x) \) như hình bên. Khẳng định nào sau đây là đúng?
...
% --- CÂU 64 ---
\questionLinesManual{8}{64}{Đường tiệm cận ngang của đồ thị hàm số \( y = 1 + \dfrac{2x + 1}{x + 2} \) có phương trình là:}{
    \begin{tasks}(4)
        \task \( x = -2 \)
        \task \( y = 3 \)
        \task \( x = -1 \)
...
% --- CÂU 65 ---
\questionLinesManual{8}{65}{Cho đồ thị hàm số \( y = \dfrac{2x^2 + x - 5}{x + 3} \) có đường tiệm cận xiên là đường thẳng \( \Delta : y = ax + b \) với \( a, b \in \mathbb{R}, a \neq 0 \). Giá trị của tổng \( a + b \) bằng}{
    \begin{tasks}(4)
        \task $-3$
        \task $7$
        \task $3$
...
% --- CÂU 66 ---
\questionLinesManual{5}{66}{Tiệm cận ngang của đồ thị hàm số \( y = \dfrac{2x - 3}{x + 1} \) là đường thẳng có phương trình}{
    \begin{tasks}(4)
        \task \( y = -1 \)
        \task \( y = -1 \)
        \task \( y = 2 \)
...
% --- CÂU 67 ---
\questionLinesManual{5}{67}{Đường tiệm cận xiên của đồ thị hàm số \( y = 2x - 1 + \dfrac{1}{x} \) có phương trình là:}{
    \begin{tasks}(4)
        \task \( y = 1 - 2x \)
        \task \( y = 2x \)
        \task \( y = 2x - 1 \)
...
% --- CÂU 68 ---
\questionLinesManual{3}{68}{Đường tiệm cận ngang của đồ thị hàm số \( y = \dfrac{2x + 1}{x + 1} \) là}{
    \begin{tasks}(4)
        \task \( y = 2 \)
        \task \( x = -1 \)
        \task \( y = -1 \)
...
% --- CÂU 69 ---
\questionLinesManual{8}{69}{Tiệm cận xiên của đồ thị hàm số \( y = \dfrac{x^2 - 2x + 4}{x - 3} \) đi qua điểm nào sau đây?}{
    \begin{tasks}(4)
        \task \( M(2024; 2025) \)
        \task \( Q(2027; 2024) \)
        \task \( N(2025; 2022) \)
...
% --- CÂU 70 ---
\questionLinesManual{8}{70}{Đường tiệm cận xiên của đồ thị hàm số \( y = \dfrac{x^2 + 2x - 3}{x - 2} \) là}{
    \begin{tasks}(4)
        \task \( y = x \)
        \task \( x = 2 \)
        \task \( y = 2 \)
...
% --- CÂU 71 ---
\questionLinesManual{3}{71}{Đường tiệm cận đứng của đồ thị hàm số \( y = \dfrac{2x + 3}{x - 1} \) là}{
    \begin{tasks}(4)
        \task \( x = 1 \)
        \task \( x = 2 \)
        \task \( y = 1 \)
...
% --- CÂU 72 ---
\questionLinesManual{8}{72}{Đồ thị hàm số \( y = \dfrac{x^2 + 2x + 2}{x + 1} \) có tiệm cận xiên là đường thẳng}{
    \begin{tasks}(4)
        \task \( y = x \)
        \task \( y = 2x - 1 \)
        \task \( y = x - 1 \)
...
% --- CÂU 73 ---
\questionLinesManual{3}{73}{Tiệm cận đứng và tiệm cận ngang của đồ thị hàm số \( y = \dfrac{2x - 1}{x + 1} \) có phương trình lần lượt là:}{
    \begin{tasks}(4)
        \task \( x = -1, y = 2 \)
        \task \( x = \dfrac{1}{2}, y = -1 \)
        \task \( x = 1, y = -2 \)
...
% --- CÂU 74 ---
\questionLinesManual{3}{74}{Tiệm cận ngang của đồ thị hàm số \( y = \dfrac{x - 2}{x + 1} \) là}{
    \begin{tasks}(4)
        \task \( y = -2 \)
        \task \( y = 1 \)
        \task \( x = -1 \)
...
% --- CÂU 75 ---
\questionLinesManual{3}{75}{Tiệm cận ngang của đồ thị hàm số \( y = \dfrac{4x + 1}{x - 1} \) là}{
    \begin{tasks}(4)
        \task \( y = \dfrac{1}{4} \)
        \task \( y = 4 \)
        \task \( y = 1 \)
...
% --- CÂU 76 ---
\questionLinesManual{3}{76}{Tiệm cận ngang của đồ thị hàm số \( y = \dfrac{5x + 1}{x - 1} \) là}{
    \begin{tasks}(4)
        \task \( y = 1 \)
        \task \( y = \dfrac{1}{5} \)
        \task \( y = -1 \)
...
% --- CÂU 77 ---
\questionLinesManual{3}{77}{Tiệm cận ngang của đồ thị hàm số \( y = \dfrac{2x + 1}{x - 1} \) là:}{
    \begin{tasks}(4)
        \task \( y = \dfrac{1}{2} \)
        \task \( y = -1 \)
        \task \( y = 1 \)
...
% --- CÂU 78 ---
\questionLinesManual{3}{78}{Tiệm cận ngang của đồ thị hàm số \( y = \dfrac{3x + 1}{x - 1} \) là:}{
    \begin{tasks}(4)
        \task \( y = \dfrac{1}{3} \)
        \task \( y = 3 \)
        \task \( y = -1 \)
...
% --- CÂU 79 ---
\questionLinesManual{3}{79}{Tiệm cận đứng của đồ thị hàm số \( y = \dfrac{2x + 2}{x - 1} \) là}{
    \begin{tasks}(4)
        \task \( x = 2 \)
        \task \( x = -2 \)
        \task \( x = 1 \)
...
% --- CÂU 80 ---
\questionLinesManual{3}{80}{Tiệm cận đứng của đồ thị hàm số \( y = \dfrac{x - 1}{x - 3} \) là}{
    \begin{tasks}(4)
        \task \( x = -3 \)
        \task \( x = -1 \)
        \task \( x = 1 \)
...
% --- CÂU 81 ---
\questionLinesManual{3}{81}{Tiệm cận đứng của đồ thị hàm số \( y = \dfrac{2x - 2}{x + 1} \) là}{
    \begin{tasks}(4)
        \task \( x = -2 \)
        \task \( x = 1 \)
        \task \( x = -1 \)
...
% --- CÂU 82 ---
\questionLinesManual{3}{82}{Tiệm cận đứng của đồ thị hàm số \( y = \dfrac{x + 1}{x + 3} \) là}{
    \begin{tasks}(4)
        \task \( x = -1 \)
        \task \( x = 1 \)
        \task \( x = -3 \)
...
% --- CÂU 83 ---
\questionLinesManual{3}{83}{Đường tiệm cận đứng của đồ thị hàm số \( y = \dfrac{x - 1}{x + 2} \) là}{
    \begin{tasks}(4)
        \task \( x = 1 \)
        \task \( x = -1 \)
        \task \( x = -2 \)
...
% --- CÂU 84 ---
\questionLinesManual{8}{84}{Đường tiệm cận xiên của đồ thị hàm số \( y = \dfrac{x^2 - 2x}{x + 1} \) có phương trình là}{
    \begin{tasks}(4)
        \task \( y = x - 1 \)
        \task \( y = x - 3 \)
        \task \( y = x + 1 \)
...
% --- CÂU 85 ---
\questionLinesManual{8}{85}{Tiệm cận xiên của đồ thị hàm số \( y = \dfrac{x^2 - 2x + 4}{x - 3} \) đi qua điểm nào sau đây?}{
    \begin{tasks}(4)
        \task \( M(1; 2) \)
        \task \( Q(1; -3) \)
        \task \( N(3; 1) \)
...
% --- CÂU 86 ---
\questionLinesManual{3}{86}{Đường tiệm cận ngang của đồ thị hàm số \( y = \dfrac{2x + 1}{x + 1} \) là}{
    \begin{tasks}(4)
        \task \( y = 2 \)
        \task \( x = -1 \)
        \task \( x = 2 \)
...
% --- CÂU 87 ---
\questionLinesManual{3}{87}{Cho hàm số \( y = \dfrac{2x + 3}{x + 1} \). Tiệm cận đứng của đồ thị hàm số này là}{
    \begin{tasks}(4)
        \task \( y = \dfrac{1}{2} \)
        \task \( y = -1 \)
        \task \( x = \dfrac{1}{2} \)
...
% --- CÂU 88 ---
\questionLinesManual{8}{88}{Tìm tiệm cận xiên (d) của đồ thị hàm số \( y = \dfrac{-x^2 + 2x + 5}{x + 1} \).}{
    \begin{tasks}(4)
        \task \( (d) \, y = -x + 1 \)
        \task \( (d) \, y = -x - 1 \)
        \task \( (d) \, y = -x + 3 \)
...
% --- CÂU 89 ---
\questionLinesManual{3}{89}{Đường thẳng \( y = -2x + 1 \) là tiệm cận xiên của đồ thị hàm số nào dưới đây?}{
    \begin{tasks}(2)
...
% --- CÂU 90 ---
\questionLinesManual{8}{90}{Cho đồ thị hàm số \( y = \dfrac{x^2 + 3x - 5}{x + 3} \) có đường tiệm cận xiên là đường thẳng \( \Delta : y = ax + b \) và tiệm cận đứng là đường thẳng \( \Delta' : x = c \) với \( a, b, c \in \mathbb{R} \). Giá trị của tổng \( S = a + b + c \) bằng}{
    \begin{tasks}(4)
        \task \( S = -1 \)
        \task \( S = -2 \)
        \task \( S = 1 \)
...
% --- CÂU 91 ---
\questionLinesManual{8}{91}{Phương trình đường tiệm cận ngang của đồ thị hàm số \( y = \dfrac{x + 2}{-x + 1} \) là}{
    \begin{tasks}(4)
        \task \( x = 1 \)
        \task \( y = 1 \)
        \task \( x = -1 \)
...
% --- CÂU 92 ---
\questionLinesManual{8}{92}{Đường tiệm cận xiên của đồ thị hàm số \( y = \dfrac{x^2 + 4x - 7}{x - 2} \) là}{
    \begin{tasks}(4)
        \task \( y = x - 6 \)
        \task \( y = -x - 6 \)
        \task \( y = -x + 6 \)
...
% --- CÂU 93 ---
\questionLinesManual{3}{93}{Cho hàm số \( y = f(x) \) thỏa mãn:  
...
% --- CÂU 94 ---
\questionLinesManual{3}{94}{Tiệm cận ngang của đồ thị hàm số \( y = \dfrac{x - 2}{x + 1} \) là}{
    \begin{tasks}(4)
        \task \( x = 1 \)
        \task \( y = -2 \)
        \task \( x = -1 \)
...
% --- CÂU 95 ---
\questionLinesManual{3}{95}{Số đường tiệm cận của đồ thị hàm số \( y = \dfrac{3x + 4}{x - 1} \) bằng:}{
    \begin{tasks}(4)
        \task $2$
        \task $3$
        \task $1$
...
% --- CÂU 96 ---
\questionLinesManual{3}{96}{Tiệm cận xiên của đồ thị hàm số \( y = x - 1 - \dfrac{2}{x + 1} \) là đường thẳng có phương trình}{
    \begin{tasks}(4)
        \task \( y = x - 1 \)
        \task \( y = -x - 1 \)
        \task \( y = x + 1 \)
...
% --- CÂU 97 ---
\questionLinesManual{8}{97}{Đường tiệm cận xiên của đồ thị hàm số \( y = \dfrac{2x^2 - x + 2}{x + 1} \) có phương trình là}{
    \begin{tasks}(4)
        \task \( y = 2x - 3 \)
        \task \( y = 2x + 3 \)
        \task \( y = x + 1 \)
...
% --- CÂU 98 ---
\questionLinesManual{3}{98}{Đồ thị hàm số \( y = 2x + 1 - \dfrac{3}{x + 1} \) có đường tiệm cận xiên là:}{
    \begin{tasks}(4)
        \task \( y = 2x - 3 \)
        \task \( y = 2x + 1 \)
        \task \( y = 2x - 1 \)
...
% --- CÂU 100 ---
\questionLinesManual{8}{100}{Cho hàm số \( y = f(x) \) xác định trên khoảng \((-2; 1)\) và có  
...
% --- CÂU 101 ---
\questionLinesManual{8}{101}{Đường tiệm cận xiên của đồ thị hàm số \( y = \dfrac{x^2 - 9x - 6}{x} \) có phương trình là}{
    \begin{tasks}(4)
        \task \( y = 2x - 18 \)
        \task \( y = x - 9 \)
        \task \( y = x + 9 \)
...
% --- CÂU 102 ---
\questionLinesManual{3}{102}{Đồ thị hàm số \( y = -x + 2 + \dfrac{1}{x} \) có đường tiệm cận xiên là}{
    \begin{tasks}(4)
        \task \( y = -x + 2 \)
        \task \( y = \dfrac{1}{x} \)
        \task \( y = x - 2 \)
...
% --- CÂU 103 ---
\questionLinesManual{8}{103}{Đồ thị hàm số \( y = f(x) = \dfrac{x^2 + 2x - 3}{x + 1} \) có đường tiệm cận xiên là}{
    \begin{tasks}(4)
        \task \( y = x + 3 \)
        \task \( y = x + 1 \)
        \task \( y = x - 1 \)
...
% --- CÂU 104 ---
\questionLinesManual{3}{104}{Phương trình đường tiệm cận ngang của đồ thị hàm số \( y = \dfrac{-2x - 1}{x - 2} \) là}{
    \begin{tasks}(4)
        \task \( y = -2 \)
        \task \( y = 2 \)
        \task \( x = 2 \)
...
% --- CÂU 105 ---
\questionLinesManual{8}{105}{Đường thẳng \( 2y + 1 = 0 \) là tiệm cận ngang của đồ thị hàm số nào sau đây?}{
    \begin{tasks}(2)
...
% --- CÂU 106 ---
\questionLinesManual{3}{106}{Cho hàm số \( y = 2x - 1 - \dfrac{3}{x + 2} \). Đường tiệm cận xiên của đồ thị hàm số đã cho là:}{
    \begin{tasks}(4)
        \task \( y = -2x + 1 \)
        \task \( y = 2x - 1 \)
        \task \( y = 2x + 1 \)
...
% --- CÂU 107 ---
\questionLinesManual{8}{107}{Đồ thị hàm số \( y = \dfrac{-x^2 + 4x - 3}{x + 2} \) có đường tiệm cận xiên là:}{
    \begin{tasks}(4)
        \task Đường thẳng \( y = -1 \)
...
% --- CÂU 108 ---
\questionLinesManual{8}{108}{Đồ thị của hàm số \( y = \dfrac{x - 2}{x^2 - 4} \) có tất cả bao nhiêu đường tiệm cận đứng và tiệm cận ngang?}{
    \begin{tasks}(4)
        \task $0$
        \task $1$
        \task $2$
...
% --- CÂU 109 ---
\questionLinesManual{8}{109}{Số đường tiệm cận của đồ thị hàm số \( y = \dfrac{5x^2 + 8x + 2}{2x^2 - 2} \) là}{
    \begin{tasks}(4)
        \task $2$
        \task $1$
        \task $0$
...
% --- CÂU 110 ---
\questionLinesManual{8}{110}{Đường tiệm cận đứng và tiệm cận ngang của đồ thị hàm số \( y = \dfrac{2x + 3}{x - 4} \) tạo với hai trục tọa độ một hình chữ nhật có diện tích bằng}{
    \begin{tasks}(4)
        \task $8$
        \task $4$
        \task $2$
...
% --- CÂU 111 ---
\questionLinesManual{3}{111}{Tiệm cận ngang của đồ thị hàm số \( f(x) = \dfrac{1 - 4x}{2x - 1} \) là đường thẳng có phương trình là}{
    \begin{tasks}(4)
        \task \( y = 2 \)
        \task \( y = 4 \)
        \task \( y = \dfrac{1}{2} \)
...
% --- CÂU 112 ---
\questionLinesManual{8}{112}{Tổng số các đường tiệm cận đứng và tiệm cận ngang của đồ thị hàm số \( y = \dfrac{\sqrt{9 - x^2} - 2}{x^2 - 5} \) là}{
    \begin{tasks}(4)
        \task $4$
        \task $3$
        \task $2$
...
% --- CÂU 113 ---
\questionLinesManual{8}{113}{Cho hàm số \( y = f(x) \) có \( \lim\limits_{x \to +\infty} f(x) = 1 \) và \( \lim\limits_{x \to -\infty} f(x) = -1 \). Khẳng định nào sau đây là khẳng định đúng?}{
    \begin{tasks}(1)
...
\questionTrueFalse{10}{114}{Cho hàm số \( y = f(x) \) có bảng biến thiên như hình vẽ.

\begin{flushleft}
\begin{tikzpicture}
    \tkzTabInit[lgt=0.8, espcl=1.5]
    {$x$ /0.6, $y'$ /0.6, $y$ /1.5}
    {$-\infty$, $0$, $1$, $+\infty$}
    \tkzTabLine{, -, d, -, 0, +, }
    \tkzTabVar{+/$0$,-D+/ $-\infty$ / $2$ / , -/ $-2$ /, +/$+\infty$}
...
\questionTrueFalse{10}{115}{Cho hàm số \( f(x) = \dfrac{2x - 3}{5x^2 - 15x + 10} \) có đồ thị như hình vẽ.
...
\questionTrueFalse{10}{116}{Cho hàm số \( y = f(x) \) có bảng biến thiên như hình vẽ.
...
\questionTrueFalse{10}{117}{Cho hàm số \( y = f(x) \) có bảng biến thiên như hình vẽ.
...
\questionTrueFalse{10}{118}{Cho hàm số \( y = f(x) \) có tập xác định là \( D = (-1; +\infty) \setminus \{4\} \) và có bảng biến thiên như hình vẽ.
...
\questionTrueFalse{10}{119}{Cho hàm số \( y = \dfrac{3x - 2}{2x - 3} \). Xét tính đúng sai của các mệnh đề sau}{
...
% --- CÂU 7 (120) ---
\questionTrueFalse{10}{120}{Cho hàm số \( y = \dfrac{3 - 2x}{x + 2} \). Xét tính đúng sai của các mệnh đề sau}{
...
% --- CÂU 8 (121) ---
\questionTrueFalse{10}{121}{Cho hàm số \( y = \dfrac{x^2 - 5x + 6}{x^2 - 9} \). Xét tính đúng sai của các mệnh đề sau}{
    \textbf{a)} & Đồ thị hàm số đã cho có hai đường tiệm cận đứng.
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
...
% --- CÂU 9 (122) ---
\questionTrueFalse{10}{122}{Cho hàm số \( f(x) = \dfrac{x^2 - x - 7}{x - 3} \). Xét tính đúng sai của các mệnh đề sau}{
...
% --- CÂU 10 (123) ---
\questionTrueFalse{10}{123}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 11 (124) ---
\questionTrueFalse{10}{124}{Cho hàm số \( y = f(x) = \dfrac{x^2 + x - 1}{x - 1} \). Xét tính đúng sai của các mệnh đề sau}{
...
% --- CÂU 12 (125) ---
\questionTrueFalse{10}{125}{Cho hàm số \( y = \dfrac{\sqrt{2x + 4} - 2}{x^2 - x} \). Xét tính đúng sai của các mệnh đề sau}{
...
% --- CÂU 13 (126) ---
\questionTrueFalse{10}{126}{Cho hàm số \( y = \dfrac{x^2 + 2x + 3}{\sqrt{x^4 - 3x^2 + 2}} \). Các mệnh đề sau đúng hay sai?}{
...
% --- CÂU 14 (127) ---
\questionTrueFalse{10}{127}{Cho hàm số \( y = \dfrac{5\sqrt{x^2 + 6} + x - 12}{4x^3 - 3x - 1} \) có đồ thị \( (C) \). Các mệnh đề sau đúng hay sai?}{
...
% --- CÂU 15 (128) ---
\questionTrueFalse{10}{128}{Cho hàm số \( y = \dfrac{x^2 - 2x + 2}{x + 2} \). Các mệnh đề sau đúng hay sai?}{
...
% --- CÂU 16 (129) ---
\questionTrueFalse{10}{129}{(THPT Lương Tài 2 - Bắc Ninh 2025) Cho hàm số \( y = \dfrac{x^2 - x + 7}{x + 1} \).}{
...
% --- CÂU 17 (130) ---
\questionTrueFalse{10}{130}{(THPT Văn Giang - Hưng Yên 2025) Cho hàm số \( y = \dfrac{x^2 + 2x - 1}{x - 1} \) có đồ thị \( (C) \).}{
...
% --- CÂU 18 (131) ---
\questionTrueFalse{10}{131}{(THPT Thạch Thành 1 - Thanh Hóa 2025) Cho hàm số \( y = f(x) \) liên tục trên các khoảng xác định và có bảng biến thiên như hình vẽ sau:
...
% --- CÂU 19 (132) ---
\questionTrueFalse{10}{132}{(THPT Kinh Môn - Hải Dương 2025) Cho hàm số \( y = \dfrac{x^2 + 3x + 3}{x + 2} \).}{
...
% --- CÂU 20 (133) ---
\questionTrueFalse{10}{133}{Cho hàm số \( y = f(x) \) có bảng biến thiên như hình dưới.
...
% --- CÂU 21 (134) ---
\questionTrueFalse{10}{134}{Cho hàm số \( y = f(x) = \dfrac{2x^2 - 3x}{x - 5} \). Khi đó:}{
...
% --- CÂU 22 (135) ---
\questionTrueFalse{10}{135}{Cho hàm số \( y = f(x) = \dfrac{2\sqrt{x^2 + 3}}{3x + 1} \). Khi đó:}{
...
% --- CÂU 23 (136) ---
\questionTrueFalse{10}{136}{Cho hàm số \( y = \dfrac{x^2 - 2x + 3}{x - 1} \) có đồ thị là \( (C) \).}{
...
% --- CÂU 24 (137) ---
\questionTrueFalse{10}{137}{Cho hàm số \( y = \dfrac{x^2 - 2x + 2}{x + 2} \) có đồ thị là \( (C) \). Xét tính đúng sai của các khẳng định sau:}{
...
% --- CÂU 25 (138) ---
\questionTrueFalse{10}{138}{Cho hàm số \( y = f(x) = \dfrac{\sqrt{2x + 4} - 4x - 2}{x^2 + 2x} \).}{
