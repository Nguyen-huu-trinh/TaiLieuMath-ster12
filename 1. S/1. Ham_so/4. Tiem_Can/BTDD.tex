...
\questionLinesManual{0}{1}{Cho hàm số \( y = f(x) \) có bảng biến thiên như hình vẽ dưới đây.
...
\questionLinesManual{0}{2}{Cho hàm số \( y = f(x) \) có bảng biến thiên như sau
...
\questionLinesManual{0}{3}{Cho hàm số \( y = f(x) \) có bảng biến thiên như hình vẽ dưới đây. Hỏi đồ thị của hàm số đã cho có bao nhiêu đường tiệm cận?
...
\questionLinesManual{0}{5}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) (\( c \neq 0; ad - bc \neq 0 \)) có đồ thị như hình vẽ.
...
\questionLinesManual{0}{6}{Cho hàm số \( f(x) = \dfrac{ax^2 + bx + c}{dx + e} \) (\( a, b, c, d, e \in \mathbb{R}, ad \neq 0 \)) có đồ thị như hình vẽ.
...
\questionLinesManual{0}{7}{Cho hàm số \( y = f(x) \) có đồ thị hàm số như hình sau:
...
\questionLinesManual{0}{8}{Tiệm cận ngang của đồ thị hàm số \( y = \dfrac{4x + 1}{x - 1} \) là}{
    \begin{tasks}(4)
        \task \( y = \dfrac{1}{4} \)
        \task \( y = 4 \)
        \task \( y = 1 \)
...
\questionLinesManual{0}{9}{Đường tiệm cận xiên của đồ thị hàm số \( y = \dfrac{x^2 - 2x}{x + 1} \) có phương trình là}{
    \begin{tasks}(4)
        \task \( y = x - 1 \)
        \task \( y = x - 3 \)
        \task \( y = x + 1 \)
...
\questionLinesManual{0}{10}{Đường thẳng \( y = -2x + 1 \) là tiệm cận xiên của đồ thị hàm số nào dưới đây?}{
    \begin{tasks}(2)
