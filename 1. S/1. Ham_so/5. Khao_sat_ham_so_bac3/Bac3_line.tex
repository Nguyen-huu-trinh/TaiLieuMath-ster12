...
% --- CÂU 2 ---
\questionLinesManual{6}{2}{Đồ thị hàm số nào dưới đây có dạng như đường cong hình bên
...
% --- CÂU 3 ---
\questionLinesManual{6}{3}{Đường cong hình bên là đồ thị của một trong bốn hàm số dưới đây. Hàm số đó là hàm số nào?
...
% --- CÂU 4 ---
\questionLinesManual{6}{4}{Đồ thị của hàm số nào dưới đây có dạng như đường cong trong hình bên?
...
% --- CÂU 5 ---
\questionLinesManual{6}{5}{Đồ thị của hàm số dưới đây có dạng như đường cong bên?
...
% --- CÂU 6 ---
\questionLinesManual{6}{6}{Đồ thị của hàm số nào dưới đây có dạng như đường cong trong hình bên?
...
% --- CÂU 7 ---
\questionLinesManual{3}{7}{Đường cong ở hình bên dưới là đồ thị của một trong bốn hàm số dưới đây. Hàm số đó là hàm số nào?
...
% --- CÂU 8 ---
\questionLinesManual{3}{8}{Đường cong trong hình bên là đồ thị của một hàm số trong bốn hàm số được liệt kê ở bốn phương án dưới đây. Hỏi hàm số đó là hàm số nào?
...
% --- CÂU 9 ---
\questionLinesManual{3}{9}{Đường cong bên là đồ thị hàm số nào sau đây?
...
% --- CÂU 10 ---
\questionLinesManual{3}{10}{Đồ thị của hàm số nào dưới đây có dạng như đường cong trong hình vẽ bên.
...
% --- CÂU 11 ---
\questionLinesManual{3}{11}{Đường cong trong hình vẽ bên là đồ thị của hàm số nào dưới đây?
...
% --- CÂU 12 ---
\questionLinesManual{3}{12}{Đường cong trong hình vẽ bên là đồ thị của hàm số nào dưới đây?
...
% --- CÂU 13 ---
\questionLinesManual{3}{13}{Hình vẽ sau đây là đồ thị của một trong bốn hàm số cho ở các đáp án. Hỏi đó là hàm số nào?
...
% --- CÂU 14 ---
\questionLinesManual{3}{14}{Đường cong trong hình vẽ bên là đồ thị của hàm số nào sau đây?
...
% --- CÂU 15 ---
\questionLinesManual{3}{15}{Đồ thị của hàm số nào dưới đây có dạng đường cong như hình bên?
...
% --- CÂU 16 ---
\questionLinesManual{7}{16}{Đồ thị sau đây là của hàm số nào?
...
% --- CÂU 17 ---
\questionLinesManual{6}{17}{Đường cong ở hình sau là đồ thị của một trong bốn hàm số dưới đây. Hàm số đó là hàm số nào?
...
% --- CÂU 18 ---
\questionLinesManual{7}{18}{Đồ thị hàm số nào sau đây có hình dạng như hình vẽ?
...
% --- CÂU 19 ---
\questionLinesManual{6}{19}{Đường cong ở hình sau là đồ thị của một trong bốn hàm số dưới đây. Hàm số đó là hàm số nào?
...
% --- CÂU 20 ---
\questionLinesManual{6}{20}{Hàm số nào dưới đây có đồ thị là đường cong trong hình vẽ bên?
...
% --- CÂU 21 ---
\questionLinesManual{6}{21}{Đường cong hình bên dưới là đồ thị hàm số nào sau đây?
...
% --- CÂU 22 ---
\questionLinesManual{6}{22}{Cho hàm số bậc ba \( y = f(x) \) có đồ thị như hình vẽ. Công thức của hàm số bậc ba đã cho là:
...
% --- CÂU 23 ---
\questionLinesManual{6}{23}{Đường cong ở hình sau là đồ thị của hàm số nào?
...
% --- CÂU 24 ---
\questionLinesManual{6}{24}{Đồ thị hàm số nào sau đây có dạng như hình vẽ?
...
% --- CÂU 25 ---
\questionLinesManual{6}{25}{Đường cong hình bên là đồ thị của một trong bốn hàm số dưới đây. Hàm số đó là hàm số nào?
...
% --- CÂU 26 ---
\questionLinesManual{6}{26}{Hình vẽ sau đây là đồ thị của một trong bốn hàm số cho ở các đáp án. Hỏi đó là hàm số nào?
...
% --- CÂU 27 ---
\questionLinesManual{6}{27}{Hình vẽ sau đây là đồ thị hàm số nào?
...
% --- CÂU 28 ---
\questionLinesManual{6}{28}{Cho hàm số bậc ba \( y = f(x) \) có bảng biến thiên như sau:
...
% --- CÂU 29 ---
\questionLinesManual{6}{29}{Hình vẽ sau là bảng biến thiên của hàm số nào dưới đây?
...
% --- CÂU 30 ---
\questionLinesManual{6}{30}{Cho hàm số bậc ba \( y = f(x) \) có đồ thị là đường cong trong hình dưới đây:
...
% --- CÂU 31 ---
\questionLinesManual{6}{31}{Cho hàm số \( y = f(x) = ax^3 + bx^2 + cx + d \) (\( a \neq 0 \)) có đồ thị như hình vẽ.
...
% --- CÂU 32 ---
\questionLinesManual{6}{32}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \) và có đồ thị như hình vẽ.
...
% --- CÂU 33 ---
\questionLinesManual{6}{33}{Cho hàm số \( y = f(x) \) có đồ thị là đường cong trong hình dưới đây.
...
% --- CÂU 34 ---
\questionLinesManual{6}{34}{Cho hàm số \( y = ax^3 + 3x - d \) (\( a, d \in \mathbb{R} \)) có đồ thị là đường cong trong hình vẽ.
...
% --- CÂU 35 ---
\questionLinesManual{6}{35}{Cho hàm số \( y = ax^3 + bx^2 + cx + d \) có đồ thị như hình vẽ. Khẳng định nào dưới đây đúng?
...
% --- CÂU 37 ---
\questionLinesManual{6}{36}{Cho hàm số \( y = ax^3 + 3x + d \) (\( a, d \in \mathbb{R} \)) có đồ thị như hình bên. Mệnh đề nào dưới đây đúng?
...
% --- CÂU 36 ---
\questionLinesManual{6}{37}{Cho hàm số \( f(x) = ax^3 + bx^2 + cx + d \) (\( a, b, c, d \in \mathbb{R} \)) có bảng biến thiên như sau:
...
% --- CÂU 38 ---
\questionLinesManual{6}{38}{Cho hàm số \( y = ax^3 + bx^2 + cx + d \) (\( a, b, c, d \in \mathbb{R} \)) có đồ thị là đường cong trong hình bên. Có bao nhiêu số dương trong các số \( a, b, c, d \)?
...
% --- CÂU 39 ---
\questionLinesManual{6}{39}{Cho hàm số \( y = ax^3 + bx^2 + cx + d \) (\( a, b, c, d \in \mathbb{R} \)) có đồ thị là đường cong trong hình bên. Có bao nhiêu số dương trong các hệ số \( a, b, c, d \)?
...
% --- CÂU 40 ---
\questionLinesManual{6}{40}{Cho hàm số \( y = ax^3 + bx^2 + cx + d \) (\( a, b, c, d \in \mathbb{R} \)) có đồ thị là đường cong trong hình bên. Có bao nhiêu số dương trong các số \( a, b, c, d \)?
...
% --- CÂU 41 ---
\questionLinesManual{6}{41}{Cho hàm số \( y = ax^3 + bx^2 + cx + d \) (\( a, b, c, d \in \mathbb{R} \)) có đồ thị là đường cong trong hình bên. Có bao nhiêu số dương trong các số \( a, b, c, d \)?
...
% --- CÂU 42 ---
\questionLinesManual{6}{42}{Cho hàm số \( f(x) = ax^3 + bx^2 + cx + d \) (\( a, b, c, d \in \mathbb{R} \)) có bảng biến thiên như sau
...
% --- CÂU 43 ---
\questionLinesManual{6}{43}{Cho hàm số \( f(x) = ax^3 + bx^2 + cx + d \) (\( a, b, c, d \in \mathbb{R} \)) có bảng biến thiên như sau:
...
% --- CÂU 44 ---
\questionLinesManual{6}{44}{Cho hàm số \( f(x) = ax^3 + bx^2 + cx + d \) (\( a, b, c, d \in \mathbb{R} \)) có bảng biến thiên như sau:
...
% --- CÂU 45 ---
\questionLinesManual{6}{45}{Cho hàm số \( f(x) = ax^3 + bx^2 + cx + d \) (\( a, b, c, d \in \mathbb{R} \)) có bảng biến thiên như sau:
...
% --- CÂU 46 ---
\questionLinesManual{6}{46}{Cho hàm số \( y = ax^3 + bx^2 + cx + d \) có đồ thị như hình vẽ bên. Mệnh đề nào dưới đây đúng?
...
% --- CÂU 48 ---
\questionLinesManual{6}{48}{Hàm số \( y = ax^3 + bx^2 + cx + d \) có đồ thị như hình vẽ bên dưới:
...
% --- CÂU 49 ---
\questionLinesManual{6}{49}{Cho hàm số \( y = ax^3 + bx^2 + cx + d \) có đồ thị như hình bên. Trong các mệnh đề sau mệnh đề nào đúng?
...
% --- CÂU 50 ---
\questionLinesManual{6}{50}{Cho hàm số \( y = ax^3 + bx^2 + cx + d \) có đồ thị như hình dưới. Khẳng định nào sau đây đúng?
...
% --- CÂU 51 ---
\questionLinesManual{6}{51}{Hàm số \( y = ax^3 + bx^2 + cx + d \) có đồ thị như hình vẽ bên dưới:
...
% --- CÂU 52 ---
\questionLinesManual{6}{52}{Tìm đồ thị hàm số \( y = f(x) \) được cho bởi một trong các phương án dưới đây, biết \( f(x) = (a - x)(b - x)^2 \) với \( a < b \).
...
% --- CÂU 53 ---
\questionLinesManual{6}{53}{Cho đường cong \( (C) : y = ax^3 + bx^2 + cx + d \) có đồ thị như hình bên.
...
% --- CÂU 54 ---
\questionLinesManual{6}{54}{Cho hàm số \( y = f(x) = ax^3 + bx^2 + cx + d \) có đồ thị như hình vẽ ở bên. Mệnh đề nào sau đây đúng?
...
% --- CÂU 55 ---
\questionLinesManual{6}{55}{Cho hàm số \( y = ax^3 + bx^2 + cx + d \) có đồ thị như hình vẽ. Tính \( S = a + b \)?
...
% --- CÂU 56 ---
\questionLinesManual{6}{56}{Cho hàm số \( y = ax^3 + bx^2 + cx + d \) có đồ thị như hình vẽ bên. Mệnh đề nào dưới đây đúng?
...
% --- CÂU 57 ---
\questionLinesManual{6}{57}{Cho hàm số \( y = ax^3 + bx^2 + cx + d \) có đồ thị như hình vẽ. Trong các số \( a, b, c \) và \( d \) có bao nhiêu số dương?
...
% --- CÂU 58 ---
\questionLinesManual{6}{58}{Phương trình tiếp tuyến của đồ thị hàm số \( y = x^3 - 3x \) tại điểm có hoành độ bằng 2 là}{
    \begin{tasks}(4)
        \task \( y = -9x + 16 \)
        \task \( y = 9x - 16 \)
        \task \( y = 9x - 20 \)
...
% --- CÂU 59 ---
\questionLinesManual{6}{59}{Số giao điểm của đồ thị hàm số \( y = x^3 - 3x^2 + 2x \) với trục \( Ox \) là}{
    \begin{tasks}(4)
        \task $2$
        \task $0$
        \task $3$
...
% --- CÂU 60 ---
\questionLinesManual{6}{60}{Tọa độ điểm cực tiểu của đồ thị hàm số \( y = \dfrac{1}{3}x^3 - 2x^2 + 3x - 1 \) là}{
    \begin{tasks}(4)
...
% --- CÂU 61 ---
\questionLinesManual{6}{61}{Số giao điểm của đồ thị hàm số \( y = x^3 + 3x^2 \) và đồ thị hàm số \( y = 3x^2 + 3x \) là}{
    \begin{tasks}(4)
        \task $3$
        \task $1$
        \task $2$
...
% --- CÂU 62 ---
\questionLinesManual{6}{62}{Cho hàm số \( f(x) = x^3 + ax^2 + bx + c \) đạt cực tiểu tại điểm \( x = 1 \) và \( f(1) = -3 \). Đồ thị hàm số cắt trục tung tại điểm có tung độ bằng 2. Tính \( T = 3a + b - c \).}{
    \begin{tasks}(4)
        \task \( T = 1 \)
        \task \( T = 9 \)
        \task \( T = -4 \)
...
% --- CÂU 63 ---
\questionLinesManual{6}{63}{Tiếp tuyến của đồ thị hàm số \( y = x^3 - 1 \) tại điểm \( M(1; 0) \) song song với đường thẳng nào trong các đường thẳng sau?}{
    \begin{tasks}(4)
        \task \( y = x + 3 \)
        \task \( y = x - 3 \)
        \task \( y = 3x - 3 \)
...
% --- CÂU 64 ---
\questionLinesManual{6}{64}{Cho hàm số \( y = x^3 - 3x \) có đồ thị \( (C) \). Có bao nhiêu điểm thuộc đồ thị \( (C) \) sao cho tiếp tuyến của đồ thị \( (C) \) tại các điểm đó song song với đường thẳng \( y = 9x + 16 \)?}{
    \begin{tasks}(4)
        \task $2$
        \task $1$
        \task $0$
...
% --- CÂU 65 ---
\questionLinesManual{6}{65}{Cho hàm số \( y = 2x^2 + 3x - 1 \) có đồ thị \( C \). Tiếp tuyến của \( C \) vuông góc với đường thẳng \( y = x \) có phương trình là}{
    \begin{tasks}(4)
        \task \( y = -x \)
        \task \( y = x - 3 \)
        \task \( y = -x - 3 \)
...
% --- CÂU 66 ---
\questionLinesManual{6}{66}{Cho hàm số \( y = -x^3 + 3x^2 - 3 \) có đồ thị \( (C) \). Số tiếp tuyến của \( (C) \) vuông góc với đường thẳng \( y = \dfrac{1}{9}x + 2025 \) là}{
    \begin{tasks}(4)
        \task $2$
        \task $1$
        \task $0$
...
% --- CÂU 67 ---
\questionLinesManual{6}{67}{Tìm điểm \( M \) có hoành độ âm trên đồ thị \( (C) \): \( y = \dfrac{1}{3}x^3 - x + \dfrac{2}{3} \) sao cho tiếp tuyến tại \( M \) vuông góc với đường thẳng \( y = -\dfrac{1}{3}x + \dfrac{2}{3} \).}{
    \begin{tasks}(4)
...
% --- CÂU 68 ---
\questionLinesManual{6}{68}{Cho hàm số \( y = x^3 + 3x \) có đồ thị là \( (C) \) và điểm \( M \) thuộc \( (C) \) có tung độ bằng 4. Phương trình tiếp tuyến của đồ thị \( (C) \) tại điểm \( M \) có dạng \( y = ax + b \) với \( a, b \in \mathbb{R} \). Tính \( P = a + 2b \).}{
    \begin{tasks}(4)
        \task \( P = 10 \)
        \task \( P = 4 \)
        \task \( P = 2 \)
...
% --- CÂU 69 ---
\questionLinesManual{6}{69}{Cho hàm số \( y = x^3 - 2x^2 + 1 \). Phương trình tiếp tuyến của đồ thị song song với đường thẳng \( d: y = -x + 2 \) là:}{
    \begin{tasks}(2)
...
% --- CÂU 70 ---
\questionLinesManual{3}{70}{Cho hàm số \( y = x^3 - 2x^2 + 1 \). Phương trình tiếp tuyến của đồ thị vuông góc với đường thẳng \( d: y = -\dfrac{1}{4}x - 4 \) là:}{
    \begin{tasks}(2)
...
% --- CÂU 71 ---
\questionTrueFalse{8}{71}{Cho hàm số bậc ba \( y = f(x) \) có đồ thị như hình vẽ.
...
\begin{tikzpicture}[>=latex, scale=0.5]
    ...
    \node [below right] at (0,-1)  {\tiny $-1$};
    \node [below right] at (0,3)  {\tiny $3$};
\end{tikzpicture}
\end{flushleft}
...
% --- CÂU 72 ---
\questionTrueFalse{8}{72}{Cho hàm số \( f(x) = -2x^4 + 4x^2 + 1 \) có đồ thị \( (C) \).}{
...
% --- CÂU 73 ---
\questionTrueFalse{8}{73}{Cho hàm số \( y = f(x) = x^3 - 3x + 2 \).}{
...
\begin{tikzpicture}[>=latex, scale=0.3]
    % Hệ trục tọa độ
    \draw[->] (-2,0) -- (4,0) node[below] {\tiny $x$};
    \draw[->] (0,-3) -- (0,4) node[right] {\tiny $y$};
...
% --- CÂU 74 ---
\questionTrueFalse{8}{74}{Cho hàm số \( y = -\dfrac{2x^3}{3} + x^2 + 4x - 2 \) đồ thị của hàm số là \( (C) \) và đường thẳng \( d: y = 4x - 1 \).}{
...
% --- CÂU 75 ---
\questionTrueFalse{8}{75}{Cho hàm số \( y = f(x) = x^3 - 3x + 2 \) có đồ thị \( (C) \) và đường thẳng \( (d) \): \( y = 9x + 18 \). Biết đường thẳng \( (d) \) là tiếp tuyến của đồ thị \( (C) \) tại điểm \( M(x_0; y_0) \).}{
...
% --- CÂU 76 ---
\questionTrueFalse{8}{76}{Cho hàm số \( f(x) = x^3 - 4x^2 - 3x + 2 \).}{
...
% --- CÂU 77 ---
\questionTrueFalse{8}{77}{Cho hàm số \( y = f(x) \) có đồ thị như hình bên.

\begin{flushleft}
\begin{tikzpicture}[>=latex, scale=0.5]
    % Hệ trục tọa độ
    \draw[->] (-3.5,0) -- (3.5,0) node[below] {\tiny $x$};
    \draw[->] (0,-3.5) -- (0,2) node[right] {\tiny $y$};
    \node[below left] at (0,0) {\tiny $O$};
...
% --- CÂU 78 ---
\questionTrueFalse{8}{78}{Cho hàm số \( f(x) = x^3 - 3x + 91 \).}{
...
% --- CÂU 79 ---
\questionTrueFalse{8}{79}{Cho hàm số \( f(x) = x^3 - 12x - 8 \).}{
...
% --- CÂU 80 ---
\questionTrueFalse{8}{80}{Cho hàm số bậc ba \( y = f(x) \) có đồ thị như hình vẽ.

\begin{flushleft}
\begin{tikzpicture}[>=latex, scale=0.5]
    % Hệ trục tọa độ
    \draw[->] (-1.5,0) -- (4.5,0) node[below] {\tiny $x$};
    \draw[->] (0,-1.5) -- (0,4) node[right] {\tiny $y$};
    \node[below left] at (0,0) {\tiny $O$};
...
% --- CÂU 81 ---
\questionTrueFalse{8}{81}{Cho hàm số \( y = \dfrac{1}{8}(x^3 - 3x^2 - 9x - 5) \) có đồ thị là \( (C) \).}{
...
% --- CÂU 82 ---
\questionTrueFalse{8}{82}{Cho hàm số \( f(x) = ax^3 + bx^2 + cx + d \) có đồ thị như hình sau đây.

\begin{flushleft}
\begin{tikzpicture}[>=latex, scale=0.5]
    % Hệ trục tọa độ
    \draw[->] (-3.5,0) -- (3.5,0) node[below] {\tiny $x$};
    \draw[->] (0,-2) -- (0,4) node[right] {\tiny $y$};
    \node[below left] at (0,0) {\tiny $O$};
...
% --- CÂU 83 ---
\questionTrueFalse{8}{83}{Cho hàm số \( y = f(x) = ax^3 + bx^2 + cx + d \) có đồ thị như hình dưới đây:

\begin{flushleft}
\begin{tikzpicture}[>=latex, scale=0.5]
    % Hệ trục tọa độ
    \draw[->] (-3.5,0) -- (2.5,0) node[below] {\tiny $x$};
    \draw[->] (0,-2) -- (0,4.5) node[right] {\tiny $y$};
    \node[below left] at (0,0) {\tiny $O$};
...
% --- CÂU 84 ---
\questionTrueFalse{8}{84}{Cho hàm số bậc ba \( y = f(x) \) có đồ thị là đường cong như hình vẽ.

\begin{flushleft}
\begin{tikzpicture}[>=latex, scale=0.5]
    % Hệ trục tọa độ
    \draw[->] (-2.5,0) -- (3.5,0) node[below] {\tiny $x$};
    \draw[->] (0,-4.5) -- (0,1.5) node[right] {\tiny $y$};
    \node[below left] at (0,0) {\tiny $O$};
    
    % Đánh dấu các mốc
    \foreach \x in {-1,1,2} {
         \draw (\x,0.05) -- (\x,-0.05)  node[above] {\tiny $\x$};
    }
    \foreach \y in {-4} {
          \draw (0.05,\y) -- (-0.05,\y)   node[left] {\tiny$\y$};
    }
