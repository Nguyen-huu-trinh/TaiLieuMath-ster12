...
\questionLinesManual{0}{1}{Đồ thị của hàm số dưới đây có dạng như đường cong bên?
...
\questionLinesManual{0}{2}{Đồ thị hàm số nào sau đây có dạng như hình vẽ?
...
\questionLinesManual{0}{3}{Hình vẽ sau là bảng biến thiên của hàm số nào dưới đây?
...
\questionLinesManual{0}{4}{Cho hàm số \( y = f(x) = ax^3 + bx^2 + cx + d \) (\( a \neq 0 \)) có đồ thị như hình vẽ.
...
\questionLinesManual{0}{5}{Cho hàm số \( y = ax^3 + bx^2 + cx + d \) có đồ thị như hình vẽ. Khẳng định nào dưới đây đúng?
...
\questionLinesManual{0}{6}{Cho đường cong \( (C) : y = ax^3 + bx^2 + cx + d \) có đồ thị như hình bên.
...
\questionLinesManual{0}{7}{Hàm số \( y = ax^3 + bx^2 + cx + d \) có đồ thị như hình vẽ bên dưới:
...
\questionLinesManual{0}{8}{Cho hàm số \( f(x) = ax^3 + bx^2 + cx + d \) (\( a, b, c, d \in \mathbb{R} \)) có bảng biến thiên như sau:
...
\questionLinesManual{0}{9}{Tìm điểm \( M \) có hoành độ âm trên đồ thị \( (C) \): \( y = \dfrac{1}{3}x^3 - x + \dfrac{2}{3} \) sao cho tiếp tuyến tại \( M \) vuông góc với đường thẳng \( y = -\dfrac{1}{3}x + \dfrac{2}{3} \).}{
    \begin{tasks}(4)
...
\questionLinesManual{0}{10}{Số giao điểm của đồ thị hàm số \( y = x^3 - 5x^2 \) và đồ thị hàm số \( y = -x^2 + 3x \) là}{
    \begin{tasks}(4)
        \task $3$
        \task $1$
        \task $2$
