...
\questionLinesManual{10}{42}{Đồ thị hàm số \( y = x^3 - 6x^2 + 9x - 1 \) có toạ độ điểm cực đại là}

\questionLinesManual{10}{44}{Số điểm cực tiểu của hàm số \( f(x) = x^4 - x^2 + 2 \) là}

\questionLinesManual{10}{46}{Hàm số \( y = \dfrac{2x + 3}{x + 1} \) có bao nhiêu điểm cực trị?}

\questionLinesManual{10}{47}{Cho hàm số \( y = \dfrac{x^2 + 3}{x + 1} \). Mệnh đề nào dưới đây đúng?}

\questionLinesManual{4}{1}{Cho hàm số bậc ba \( y = f(x) \) có bảng biến thiên như sau:
\begin{center}
...
\questionLinesManual{4}{4}{Cho hàm số \( y = f(x) = \dfrac{mx^2 + nx + p}{qx + r} \) có bảng biến thiên như hình vẽ bên dưới.
\begin{center}
\begin{tikzpicture}[>=stealth]
...
% ====== CÂU 61 ======
\questionLinesManual{5}{61}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \) và có đạo hàm  
\( f'(x) = (x+1)^3(x-1)(x-2). \) 
Số điểm cực trị của hàm số đã cho là}

% ====== CÂU 62 ======
\questionLinesManual{5}{62}{Hàm số \( f(x) \) có đạo hàm  
