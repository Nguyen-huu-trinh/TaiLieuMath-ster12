...
\questionLinesManual{0}{29}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) có đồ thị như sau.
...
% --- CÂU 30 ---
\questionLinesManual{0}{30}{Cho hàm số \( y = \dfrac{(a-1)x + b}{(c-1)x + d} \), \( d < 0 \) có đồ thị như hình trên. Khẳng định nào dưới đây là đúng?
...
% --- CÂU 31 ---
\questionLinesManual{0}{31}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) có đồ thị như trong hình bên dưới. Biết rằng \( a \) là số thực dương, hỏi trong các số \( b, c, d \) có tất cả bao nhiêu số dương?
...
% --- CÂU 32 ---
\questionLinesManual{0}{32}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) có đồ thị như hình vẽ bên. Khẳng định nào sau đây là khẳng định đúng?
...
% --- CÂU 33 ---
\questionLinesManual{0}{33}{Hình vẽ bên là đồ thị hàm số \( y = \dfrac{ax + b}{cx + d} \). Mệnh đề nào dưới đây đúng?
...
% --- CÂU 34 ---
\questionLinesManual{0}{34}{Cho hàm số \( y = \dfrac{ax - b}{x - 1} \) có đồ thị như hình vẽ dưới đây:
...
% --- CÂU 29 ---
\questionLinesManual{0}{35}{Cho hàm số \( y = \dfrac{x^2 + bx + c}{mx + n} \) (\( m \neq 0 \))  có đồ thị là đường cong bên dưới
...
% --- CÂU 30 ---
\questionLinesManual{0}{36}{Cho hàm số \( y = \dfrac{ax^2 + bx + c}{x + d} \) (\( a \neq 0 \))  có đồ thị như hình vẽ sau:
...
% --- CÂU 32 ---
\questionLinesManual{0}{38}{Cho hàm số \( y = ax + b - \dfrac{r}{x} \) (\(ab  \neq 0\)) và có đồ thị là \( (C) \) có dạng như hình vẽ sau.
...
% --- CÂU 33 ---
\questionLinesManual{0}{39}{Cho hàm số \( y = \dfrac{ax^2 + bx + c}{mx + n} \) (\( a > 0, m \neq 0 \)) có đồ thị như hình vẽ bên.
...
% --- CÂU 34 ---
\questionLinesManual{0}{40}{Tập xác định của hàm số \( f(x) = \dfrac{x^2 - 4x - 3}{x + 3} \) là}{
    \begin{tasks}(4)
...
% --- CÂU 35 ---
\questionLinesManual{0}{41}{Giá trị nhỏ nhất của hàm số \( y = x - 3 + \dfrac{9}{x + 2} \) trên đoạn \([-1; 3]\) bằng}{
    \begin{tasks}(4)
        \task $0$
        \task $5$
        \task $1$
...
% --- CÂU 36 ---
\questionLinesManual{0}{42}{Đường thẳng qua 2 điểm cực trị của đồ thị hàm số \( y = \dfrac{x^2 - x + 2}{x + 2} \) có phương trình là}{
    \begin{tasks}(4)
        \task \( y = 2x - 1 \)
        \task \( y = 2x + 1 \)
        \task \( y = x - 2 \)
...
% --- CÂU 37 ---
\questionLinesManual{0}{43}{Cho hàm số \( y = \dfrac{x^2 + 3x + 3}{x + 1} \) có đồ thị \((C)\). Tiếp tuyến của đồ thị \((C)\) tại giao điểm của đồ thị với trục tung cắt đường tiệm cận xiên của đồ thị tại điểm có tọa độ là}{
    \begin{tasks}(4)
        \task $(1; 2)$
        \task $(1; 3)$
        \task $(-1; 1)$
...
% --- CÂU 38 ---
\questionLinesManual{0}{44}{Phương trình tiếp tuyến của đồ thị hàm số \( y = \dfrac{x - 2}{x + 1} \) tại điểm có tung độ \(y_0 = -2\) là}{
    \begin{tasks}(4)
        \task \( y = 3x - 2 \)
        \task \( y = -3x + 2 \)
        \task \( y = 3x + 2 \)
...
% --- CÂU 39 ---
\questionLinesManual{0}{45}{Cho hàm số \( y = \dfrac{x - 1}{x + 1} \) có đồ thị \((C)\). Có bao nhiêu điểm thuộc đồ thị \((C)\) sao cho tiếp tuyến của đồ thị \((C)\) tại các điểm đó song song với đường thẳng \(y = 2x + 7\)?}{
    \begin{tasks}(4)
        \task $2$
        \task $1$
        \task $0$
...
% --- CÂU 40 ---
\questionLinesManual{0}{46}{Cho hàm số \( y = \dfrac{2x - 1}{x + 1} \) (C). Tiếp tuyến của (C) vuông góc với đường thẳng \( x + 3y + 2 = 0 \) tại điểm có hoành độ là}{
    \begin{tasks}(4)
        \task \( x = 0 \)
        \task \( x = -2 \)
        \task 
...
% --- CÂU 1: HÀM BẬC 3 ---
\questionLinesManual{0}{47}{Cho hàm số \( y = x^3 - 3x^2 + 2 \). Tìm tọa độ tâm đối xứng của đồ thị hàm số.}{
    \begin{tasks}(4)
        \task \( I(1; 0) \)
        \task \( I(1; 2) \)
        \task \( I(1; -2) \)
...
% --- CÂU 2: HÀM BẬC 3 ---
\questionLinesManual{0}{48}{Cho hàm số \( y = -2x^3 + 6x^2 - 4x + 1 \). Tâm đối xứng của đồ thị hàm số có tung độ bằng:}{
    \begin{tasks}(4)
        \task \( 1 \)
        \task \( -1 \)
        \task \( 3 \)
...
% --- CÂU 3: HÀM B1/B1 ---
\questionLinesManual{0}{49}{Cho hàm số \( y = \dfrac{2x + 1}{x - 1} \). Tâm đối xứng của đồ thị hàm số là:}{
    \begin{tasks}(4)
        \task \( I(1; 2) \)
        \task \( I(1; -2) \)
        \task \( I(-1; 2) \)
...
% --- CÂU 4: HÀM B1/B1 ---
\questionLinesManual{0}{50}{Cho hàm số \( y = \dfrac{-x + 3}{x + 2} \). Tổng hoành độ và tung độ của tâm đối xứng là:}{
    \begin{tasks}(4)
        \task \( 1 \)
        \task \( -1 \)
        \task \( 3 \)
...
% --- CÂU 5: HÀM B2/B1 ---
\questionLinesManual{0}{51}{Cho hàm số \( y = \dfrac{x^2 + 2x + 2}{x + 1} \). Tâm đối xứng của đồ thị hàm số là:}{
    \begin{tasks}(4)
        \task \( I(-1; 0) \)
        \task \( I(-1; 1) \)
        \task \( I(-1; 2) \)
...
% --- CÂU 6: HÀM B2/B1 ---
\questionLinesManual{0}{52}{Cho hàm số \( y = \dfrac{x^2 - 4x + 5}{x - 2} \). Tọa độ tâm đối xứng của đồ thị hàm số là:}{
    \begin{tasks}(4)
        \task \( I(2; 0) \)
        \task \( I(2; 2) \)
        \task \( I(2; -2) \)
...
% --- CÂU 42 ---
\questionTrueFalse{0}{53}{Cho hàm số \( y = f(x) = \dfrac{ax - 1}{bx + c} \) với \( a, b, c \in \mathbb{R} \) có bảng biến thiên như hình vẽ dưới đây
...
% --- CÂU 44 ---
\questionTrueFalse{0}{54}{Cho hàm số \( y = f(x) = \dfrac{ax^2 + bx + c}{mx + n} \) (với \( a, m \neq 0 \)) có đồ thị là đường cong như Hình.
...
% --- CÂU 48 ---
\questionTrueFalse{0}{56}{Cho hàm số \( y = f(x) = \dfrac{ax^2 + bx + c}{x + d} \) có đồ thị là đường cong như hình vẽ dưới đây, biết đường tiệm xiên của đồ thị hàm số đi qua hai điểm \( (0;1) \) và \( (1;0) \).
...
% --- CÂU 49 ---
\questionTrueFalse{0}{57}{Cho hàm số \( y = \dfrac{x+1}{x-1} \) có đồ thị là đường cong \( (C) \). Giả sử \( A, B \) là hai điểm thuộc hai nhánh và \( AB \) đi qua tâm đối xứng của \( (C) \).}{
...
% --- CÂU 50 ---
\questionTrueFalse{0}{58}{Cho hàm số \( y = f(x) = ax + b + \dfrac{c}{x+d} \) có đồ thị như hình vẽ sau:
...
% --- CÂU 53 ---
\questionTrueFalse{0}{59}{Cho hàm số \( y = \dfrac{x^2 + 3x - 8}{x - 2} \) và đường tròn \( (C): (x + 3)^2 + (y - 1)^2 = 4 \). Gọi I là tâm đường tròn (C).}{
...
% --- CÂU 54 ---
\questionTrueFalse{0}{60}{Cho hàm số \( y = \dfrac{mx^2 + nx + 1}{px + 2} \) có đồ thị như hình vẽ bên dưới.
...
% --- CÂU 56 ---
\questionTrueFalse{0}{61}{Cho hàm số \( y = f(x) = \dfrac{ax + b}{cx + 1} \) với \( a, b, c \in \mathbb{R} \) có đồ thị như hình vẽ dưới:
...
% --- CÂU 57 ---
\questionTrueFalse{0}{62}{Cho hàm số \( y = \dfrac{3x - 2}{x + 2} \) có đồ thị \( (C) \).}{
...
% --- CÂU 58 ---
\questionTrueFalse{0}{63}{Cho hàm số \( y = f(x) = \dfrac{x^2 + 2x - 1}{x - 1} \).}{
...
% --- CÂU 59 ---
\questionTrueFalse{0}{64}{Cho hàm số \( y = \dfrac{x^2 + x - 1}{x - 1} \) có đồ thị là \( (C) \). Xét tính đúng sai của các mệnh đề sau:}{
...
% --- CÂU 60 ---
\questionTrueFalse{0}{65}{Cho hàm số \( y = \dfrac{x^2 - 3x + 6}{x - 1} \).}{
...
% --- CÂU 61 ---
\questionTrueFalse{0}{66}{Cho hàm số \( y = \dfrac{-x^2 - 3x + 4}{x - 3} \) có đồ thị là \( (C) \).}{
...
% --- CÂU 62 ---
\questionTrueFalse{0}{67}{Cho hàm số \( y = f(x) = \dfrac{x^2 + x - 1}{x + 2} \).}{
...
% --- CÂU 63 ---
\questionTrueFalse{0}{68}{Cho hàm số \( f(x) = \dfrac{x^2 - x - 1}{x + 1} \) và điểm \( A(-1; -3) \).}{
...
% --- CÂU 65 ---
\questionTrueFalse{0}{69}{Cho hàm số \( y = \dfrac{2x + 1}{x - 1} \) có đồ thị \( (C) \).}{
...
% --- CÂU 66 ---
\questionTrueFalse{0}{70}{Cho hàm số \( y = \dfrac{x^2 - 2x - 3}{x - 1} \).}{
...
% --- CÂU 68 ---
\questionTrueFalse{0}{71}{Cho hàm số \( y = ax + b + \dfrac{c}{x + d} \) (\( a, b, c, d \in \mathbb{R} \)) có đồ thị như hình vẽ sau:
...
% --- CÂU 69 ---
\questionTrueFalse{0}{72}{Cho hàm số \( f(x) = -x + 4 - \dfrac{9}{x+2} \).}{
...
% --- CÂU 70 ---
\questionTrueFalse{0}{73}{Cho hàm số \( f(x) = \dfrac{x^2 + 2x - 1}{x - 1} \).}{
...
% --- CÂU 71 ---
\questionTrueFalse{0}{74}{Cho hàm số \( f(x) = \dfrac{x^2 - 3x + 3}{x - 1} \).}{
...
% --- CÂU 72 ---
\questionTrueFalse{0}{75}{Cho hàm số \( f(x) = \dfrac{x - 2}{x + 1} \).
...
% --- CÂU 73 ---
\questionTrueFalse{0}{76}{Cho hàm số \( y = \dfrac{x^2 + 2x - 1}{x - 1} \) có đồ thị (C).}{
...
% --- CÂU 74 ---
\questionTrueFalse{0}{77}{Cho hàm số \( y = x - 1 + \dfrac{9}{x + 2} \).}{
    \textbf{a)} & Tập xác định của hàm số là \( \mathbb{R} \setminus \{-2\} \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
...
% --- CÂU 75 ---
\questionTrueFalse{0}{78}{Cho hàm số \( f(x) = \dfrac{ax^2 + x + b}{x + c} \) (\( a > 0 \)), có đồ thị \( C \) như hình vẽ bên dưới. Biết đường tiệm cận xiên của đồ thị \( C \) tạo với hai trục toạ độ một tam giác cân.
...
% --- CÂU 76 ---
\questionTrueFalse{0}{79}{Cho hàm số \( y = f(x) = \dfrac{a_1 x^2 + b_1 x + c_1}{a_2 x + b_2} \) có đồ thị như hình dưới đây:
...
% --- CÂU 81 ---
\questionTrueFalse{0}{80}{Cho hàm số \( y = f(x) = x + 2 + \dfrac{1}{x - 1} \).}{
...
% --- CÂU 82 ---
\questionTrueFalse{0}{81}{Cho hàm số \( f(x) = \dfrac{2x^2 + 3x - 5}{x + 3} \).}{
...
% --- CÂU 84 ---
\questionTrueFalse{0}{82}{Cho hàm số \( y = \dfrac{x^2 + 3x + 3}{x + 2} \) có đồ thị \( (C) \) và 2 điểm \( A, B \) là hai điểm cực trị của \( (C) \).}{
...
% --- CÂU 85 ---
\questionTrueFalse{0}{83}{Cho hàm số \( y = \dfrac{x^2 - 2x + 2}{x - 1} \).}{
...
% --- CÂU 86 ---
\questionTrueFalse{0}{84}{Cho hàm số \( y = \dfrac{x^2 + 4}{x} \).}{
...
% --- CÂU 87 ---
\questionTrueFalse{0}{85}{Cho hàm số \( y = \dfrac{x^2 - 3x + 6}{x - 1} \).
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.6]
...
% --- CÂU 89 ---
\questionTrueFalse{0}{86}{Cho hàm số \( y = \dfrac{x^2 - 2x + 2}{x - 1} \).
...
% --- CÂU 90 ---
\questionTrueFalse{0}{87}{Cho hàm số \( y = \dfrac{x^2 - x + 1}{x + 1} \) có đồ thị là \( C \). Khi đó}{
...
% --- CÂU 93 ---
\questionTrueFalse{0}{88}{Cho hàm số \( y = \dfrac{x^2 - x + 1}{x - 1} \).}{
