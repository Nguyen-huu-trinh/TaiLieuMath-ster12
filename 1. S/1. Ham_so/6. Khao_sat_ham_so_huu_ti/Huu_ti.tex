...
% --- CÂU 1 ---
\questionLinesManual{0}{1}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) (\(a, b, c \in \mathbb{R}\)) có bảng biến thiên như sau:
...
% --- CÂU 2 ---
\questionLinesManual{0}{2}{Cho hàm số \( f(x) = \dfrac{ax - 6}{bx + c} \) (\(a, b, c \in \mathbb{R}\)) có bảng biến thiên như sau:
...
% --- CÂU 3 ---
\questionLinesManual{0}{3}{Cho hàm số \( f(x) = \dfrac{mx^2 + nx + p}{qx + r} \) có bảng biến thiên như hình vẽ bên dưới
...
% --- CÂU 4 ---
\questionLinesManual{0}{4}{Cho hàm số \( y = f(x) \) xác định trên \( \mathbb{R} \setminus \{1\} \), liên tục trên mỗi khoảng xác định và có bảng biến thiên hình vẽ sau
...
% --- CÂU 5 ---
\questionLinesManual{0}{5}{Cho hàm số \( f(x) = \dfrac{ax^2 + bx + c}{ex + f} \) có bảng biến thiên như hình sau:
...
% --- CÂU 6 ---
\questionLinesManual{0}{6}{Đường cong trong hình vẽ bên là của đồ thị hàm số nào trong các hàm số được cho bởi các phương án A, B, C, D dưới đây?
...
% --- CÂU 7 ---
\questionLinesManual{0}{7}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) có đồ thị là đường cong như hình vẽ bên. Tọa độ tâm đối xứng của đồ thị hàm số đã cho là
...
% --- CÂU 8 ---
\questionLinesManual{0}{8}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) có đồ thị là đường cong như hình vẽ bên. Tọa độ giao điểm của đồ thị hàm số với trục hoành là
...
% --- CÂU 9 ---
\questionLinesManual{0}{9}{Hàm số nào dưới đây có đồ thị như hình vẽ sau?
...
% --- CÂU 10 ---
\questionLinesManual{0}{10}{Đường cong ở hình dưới đây là đồ thị của hàm số
...
% --- CÂU 11 ---
\questionLinesManual{0}{11}{Cho hàm số \( y = \dfrac{ax + b}{x + c} \) có đồ thị như hình sau đây
...
% --- CÂU 12 ---
\questionLinesManual{0}{12}{Cho hàm số \( y = \dfrac{ax^2 + bx + 1}{cx + 2} \) (với \( a, b, c \in \mathbb{R}, a \neq 0 \)) có đồ thị là đường cong trong hình vẽ bên. Giá trị biểu thức \( T = 2a + 3b - c \) là
...
% --- CÂU 13 ---
\questionLinesManual{0}{13}{Cho hàm số \( y = ax + 2 + \dfrac{b}{x + c} \) có đồ thị như hình dưới đây. Giá trị của \( P = a + b + c \) bằng
...
% --- CÂU 14 ---
\questionLinesManual{0}{14}{Đường cong trong hình vẽ sau là đồ thị của hàm số nào dưới đây?
...
% --- CÂU 15 ---
\questionLinesManual{0}{15}{Đường cong trong hình vẽ là đồ thị của hàm số nào dưới đây?
...
% --- CÂU 16 ---
\questionLinesManual{0}{16}{Đường cong ở dưới đây là đồ thị của hàm số nào?
...
% --- CÂU 17 ---
\questionLinesManual{0}{17}{Đồ thị của hàm số \( y = \dfrac{x+1}{-x+1} \) là đường cong nào trong các hình vẽ sau?
...
% --- CÂU 18 ---
\questionLinesManual{0}{18}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) (\(a, b, c \in \mathbb{R}\)) có đồ thị là đường cong như hình vẽ bên:
...
% --- CÂU 19 ---
\questionLinesManual{0}{19}{Cho hàm số \( y = f(x) \) có đồ thị như hình dưới đây. Biểu thức \( f(x) \) là biểu thức nào sau đây?
...
% --- CÂU 20 ---
\questionLinesManual{0}{20}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) (với \( c \neq 0, ad - bc \neq 0 \)) có đồ thị như hình vẽ bên. Khẳng định nào sau đây đúng?
...
% --- CÂU 21 ---
\questionLinesManual{0}{21}{Đường cong như hình vẽ dưới đây là đồ thị của hàm số nào?
...
% --- CÂU 22 ---
\questionLinesManual{0}{22}{Đồ thị trong hình vẽ dưới đây là của hàm số nào?
...
% --- CÂU 23 ---
\questionLinesManual{0}{23}{Đường cong nào dưới đây là đồ thị của hàm số \( y = \dfrac{x+1}{x-1} \)?
...
% --- CÂU 24 ---
\questionLinesManual{0}{24}{Cho hàm số \( y = \dfrac{ax^2 + bx + c}{mx + n} \) có đồ thị hàm số như hình vẽ:
...
% --- CÂU 25 ---
\questionLinesManual{0}{25}{Cho hàm số có đồ thị như hình vẽ bên dưới. Phương trình đường tiệm cận đứng và tiệm cận ngang của đồ thị hàm số là
...
% --- CÂU 26 ---
\questionLinesManual{0}{26}{Cho hàm số \( y = \dfrac{ax + b}{cx + d} \) (\(a, b, c \in \mathbb{R}\)) có đồ thị là đường cong như hình vẽ bên. Toạ độ tâm đối xứng của đồ thị hàm số đã cho là:
...
% --- CÂU 27 ---
\questionLinesManual{0}{27}{Cho hàm số \( y = f(x) = \dfrac{ax^2 + bx + c}{dx + e} \) có đồ thị như hình vẽ dưới đây:
...
% --- CÂU 28 ---
\questionLinesManual{0}{28}{Hàm số nào sau đây có đồ thị như hình vẽ?
...
% --- CÂU 29 ---
\questionLinesManual{0}{29}{Cho hàm số \( y = f(x) \) có đồ thị là đường cong bên dưới
...
Trong các khẳng định sau, khẳng định nào đúng?}{
    \begin{tasks}(2)
        ...
        \task Hàm số đạt cực đại tại \( x = 0 \).
        \task Hàm số đạt cực đại tại \( x = 2 \).
        \task Hàm số đạt cực tiểu tại \( x = 6 \).
    \end{tasks}
}

% --- CÂU 30 ---
\questionLinesManual{0}{30}{Cho hàm số \( y = f(x) \) có đồ thị như hình vẽ sau:
...
% --- CÂU 31 ---
\questionLinesManual{0}{31}{Cho hàm số \( y = \dfrac{ax^2 + bx + c}{a'x + b'} \) có đồ thị như hình vẽ bên. Hàm số đã cho nghịch biến trên khoảng nào trong các khoảng sau đây?
...
% --- CÂU 32 ---
\questionLinesManual{0}{32}{Cho hàm số \( y = ax + b - \dfrac{r}{x} \) (\(ab  \neq 0\)) và có đồ thị là \( (C) \) có dạng như hình vẽ sau.
...
% --- CÂU 33 ---
\questionLinesManual{0}{33}{Cho hàm số \( y = \dfrac{ax^2 + bx + c}{mx + n} \) (\( a > 0, m \neq 0 \)) có đồ thị như hình vẽ bên.
...
% --- CÂU 34 ---
\questionLinesManual{0}{34}{Tập xác định của hàm số \( f(x) = \dfrac{x^2 - 4x - 3}{x + 3} \) là}{
    \begin{tasks}(4)
...
% --- CÂU 35 ---
\questionLinesManual{0}{35}{Giá trị nhỏ nhất của hàm số \( y = x - 3 + \dfrac{9}{x + 2} \) trên đoạn \([-1; 3]\) bằng}{
    \begin{tasks}(4)
        \task $0$
        \task $5$
        \task $1$
...
% --- CÂU 36 ---
\questionLinesManual{0}{36}{Đường thẳng qua 2 điểm cực trị của đồ thị hàm số \( y = \dfrac{x^2 - x + 2}{x + 2} \) có phương trình là}{
    \begin{tasks}(4)
        \task \( y = 2x - 1 \)
        \task \( y = 2x + 1 \)
        \task \( y = x - 2 \)
...
% --- CÂU 37 ---
\questionLinesManual{0}{37}{Cho hàm số \( y = \dfrac{x^2 + 3x + 3}{x + 1} \) có đồ thị \((C)\). Tiếp tuyến của đồ thị \((C)\) tại giao điểm của đồ thị với trục tung cắt đường tiệm cận xiên của đồ thị tại điểm có tọa độ là}{
    \begin{tasks}(4)
        \task $(1; 2)$
        \task $(1; 3)$
        \task $(-1; 1)$
...
% --- CÂU 38 ---
\questionLinesManual{0}{38}{Phương trình tiếp tuyến của đồ thị hàm số \( y = \dfrac{x - 2}{x + 1} \) tại điểm có tung độ \(y_0 = -2\) là}{
    \begin{tasks}(4)
        \task \( y = 3x - 2 \)
        \task \( y = -3x + 2 \)
        \task \( y = 3x + 2 \)
...
% --- CÂU 39 ---
\questionLinesManual{0}{39}{Cho hàm số \( y = \dfrac{x - 1}{x + 1} \) có đồ thị \((C)\). Có bao nhiêu điểm thuộc đồ thị \((C)\) sao cho tiếp tuyến của đồ thị \((C)\) tại các điểm đó song song với đường thẳng \(y = 2x + 7\)?}{
    \begin{tasks}(4)
        \task $2$
        \task $1$
        \task $0$
...
% --- CÂU 40 ---
\questionLinesManual{0}{40}{Cho hàm số \( y = \dfrac{2x - 1}{x + 1} \) (C). Tiếp tuyến của (C) vuông góc với đường thẳng \( x + 3y + 2 = 0 \) tại điểm có hoành độ là}{
    \begin{tasks}(4)
        \task \( x = 0 \)
        \task \( x = -2 \)
        \task 
...
% --- CÂU 41 ---
\questionTrueFalse{0}{41}{Cho hàm số \( y = \dfrac{2x+1}{x-1} \) có đồ thị \( (C) \).}{
    \textbf{a)} & Đồ thị \( (C) \) có tiệm cận đứng \( x=1 \) và tiệm cận ngang \( y=1 \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{b)} & Hàm số đã cho nghịch biến trên các khoảng xác định của nó.
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{c)} & Có đúng 3 điểm thuộc đồ thị \( (C) \) mà tọa độ của chúng là những số nguyên.
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{d)} & Gọi \( M \) là điểm nằm trên đồ thị \( (C) \) và \( H, K \) tương ứng là hình chiếu vuông góc của \( M \) trên các trục \( Ox \) và \( Oy \). Có 2 điểm \( M \) có hoành độ dương thỏa mãn tứ giác \( MHOK \) có diện tích bằng 2.
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\
}

% --- CÂU 42 ---
\questionTrueFalse{0}{42}{Cho hàm số \( y = f(x) = \dfrac{ax - 1}{bx + c} \) với \( a, b, c \in \mathbb{R} \) có bảng biến thiên như hình vẽ dưới đây
...
% --- CÂU 43 ---
\questionTrueFalse{0}{43}{Cho hàm số \( y = f(x) = \dfrac{ax^2 + bx + 1}{cx + d} \) đạt cực đại tại \( x = 0 \) và có đồ thị như hình vẽ sau:
...
% --- CÂU 44 ---
\questionTrueFalse{0}{44}{Cho hàm số \( y = f(x) = \dfrac{ax^2 + bx + c}{mx + n} \) (với \( a, m \neq 0 \)) có đồ thị là đường cong như Hình.
...
% --- CÂU 45 ---
\questionTrueFalse{0}{45}{Cho hàm số \( f(x) = 
\begin{cases} 
...
% --- CÂU 47 ---
\questionTrueFalse{0}{47}{Cho hàm số \( y = f(x) = \dfrac{ax^2 + bx + c}{x + d} \) có đồ thị là đường cong trong hình vẽ dưới đây, biết đường tiệm cận xiên của đồ thị hàm số đi qua hai điểm \((0;1)\) và \((1;0)\).

\begin{center}
\begin{tikzpicture}[>=latex, scale=0.3]
    % 1. Hệ trục tọa độ
    \draw[->] (-10,0) -- (10,0) node[below] {\small $x$};
    \draw[->] (0,-7) -- (0,15) node[right] {\small $y$};
...
\end{center}
    ...
    \textbf{a)} & Hàm số đồng biến trên khoảng \((-4; 0)\).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{b)} & Ta có \( a + b + c + d = -2 \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{c)} & Khoảng cách từ \( M(1; -8) \) đến đường thẳng đi qua các điểm cực trị của đồ thị hàm số là \( \sqrt{5} \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{d)} & Tập xác định của hàm số là \( \mathbb{R} \setminus \{2\} \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\
}

% --- CÂU 48 ---
\questionTrueFalse{0}{48}{Cho hàm số \( y = f(x) = \dfrac{ax^2 + bx + c}{x + d} \) có đồ thị là đường cong như hình vẽ dưới đây, biết đường tiệm xiên của đồ thị hàm số đi qua hai điểm \( (0;1) \) và \( (1;0) \).
...
% --- CÂU 49 ---
\questionTrueFalse{0}{49}{Cho hàm số \( y = \dfrac{x+1}{x-1} \) có đồ thị là đường cong \( (C) \). Giả sử \( A, B \) là hai điểm thuộc hai nhánh và \( AB \) đi qua tâm đối xứng của \( (C) \).}{
...
% --- CÂU 50 ---
\questionTrueFalse{0}{50}{Cho hàm số \( y = f(x) = ax + b + \dfrac{c}{x+d} \) có đồ thị như hình vẽ sau:

\begin{center}
\begin{tikzpicture}[>=latex, scale=0.5]
    % 1. Hệ trục tọa độ
    \draw[->] (-6,0) -- (4.5,0) node[below] {\small $x$};
    \draw[->] (0,-8) -- (0,8) node[right] {\small $y$};
...
% --- CÂU 51 ---
\questionTrueFalse{0}{51}{Cho hàm số \( y = \dfrac{x^2 + bx + c}{x + n} \) có đồ thị và hai đường tiệm cận \( d_1, d_2 \) như hình vẽ dưới đây.

\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % 1. Hệ trục tọa độ
    \draw[->] (-4.5,0) -- (4.5,0) node[below] {\small $x$};
    \draw[->] (0,-5.5) -- (0,3.5) node[right] {\small $y$};
    \node[below right] at (0,0) {\small $O$};
...
% --- CÂU 52 ---
\questionTrueFalse{0}{52}{Cho hàm số \( y = \dfrac{ax^2 + bx + c}{mx + n} \) có đồ thị như hình vẽ sau
...
% --- CÂU 53 ---
\questionTrueFalse{0}{53}{Cho hàm số \( y = \dfrac{x^2 + 3x - 8}{x - 2} \) và đường tròn \( (C): (x + 3)^2 + (y - 1)^2 = 4 \). Gọi I là tâm đường tròn (C).}{
...
% --- CÂU 54 ---
\questionTrueFalse{0}{54}{Cho hàm số \( y = \dfrac{mx^2 + nx + 1}{px + 2} \) có đồ thị như hình vẽ bên dưới.
...
% --- CÂU 55 ---
\questionTrueFalse{0}{55}{Cho hàm số \( y = \dfrac{2x+1}{x-1} \) (C). Các mệnh đề sau đây đúng hay sai}{
...
% --- CÂU 56 ---
\questionTrueFalse{0}{56}{Cho hàm số \( y = f(x) = \dfrac{ax + b}{cx + 1} \) với \( a, b, c \in \mathbb{R} \) có đồ thị như hình vẽ dưới:
...
% --- CÂU 57 ---
\questionTrueFalse{0}{57}{Cho hàm số \( y = \dfrac{3x - 2}{x + 2} \) có đồ thị \( (C) \).}{
...
% --- CÂU 58 ---
\questionTrueFalse{0}{58}{Cho hàm số \( y = f(x) = \dfrac{x^2 + 2x - 1}{x - 1} \).}{
...
% --- CÂU 59 ---
\questionTrueFalse{0}{59}{Cho hàm số \( y = \dfrac{x^2 + x - 1}{x - 1} \) có đồ thị là \( (C) \). Xét tính đúng sai của các mệnh đề sau:}{
...
% --- CÂU 60 ---
\questionTrueFalse{0}{60}{Cho hàm số \( y = \dfrac{x^2 - 3x + 6}{x - 1} \).}{
    \textbf{a)} & Điểm cực tiểu của đồ thị hàm số là \( (a; b) \) với \( a^2 + b = 12 \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{b)} & Tiệm cận xiên của đồ thị hàm số là \( y = x - 2 \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{c)} & Gọi \( I \) là giao điểm hai đường tiệm cận của đồ thị hàm số. Tiếp tuyến của đồ thị hàm số tại điểm có hoành độ \( x = 2 \) cắt hai đường tiệm cận tại \( A, B \). Diện tích tam giác \( IAB \) bằng 12.
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{d)} & Có tất cả 9 giá trị nguyên của tham số \( m \) để phương trình \( \dfrac{x^2 - 3x + 6}{x - 1} = m \) có hai nghiệm phân biệt \( x_1, x_2 \) thỏa mãn \( x_1 < 2 < x_2 < 15 \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\
}

% --- CÂU 61 ---
\questionTrueFalse{0}{61}{Cho hàm số \( y = \dfrac{-x^2 - 3x + 4}{x - 3} \) có đồ thị là \( (C) \).}{
...
% --- CÂU 62 ---
\questionTrueFalse{0}{62}{Cho hàm số \( y = f(x) = \dfrac{x^2 + x - 1}{x + 2} \).}{
...
% --- CÂU 63 ---
\questionTrueFalse{0}{63}{Cho hàm số \( f(x) = \dfrac{x^2 - x - 1}{x + 1} \) và điểm \( A(-1; -3) \).}{
...
% --- CÂU 64 ---
\questionTrueFalse{0}{64}{Cho hàm số \( y = \dfrac{x^2 - 3x + 6}{x - 1} \).}{
    \textbf{a)} & Điểm cực tiểu của đồ thị hàm số là \( (a; b) \) với \( a^2 + b = 12 \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
...
% --- CÂU 65 ---
\questionTrueFalse{0}{65}{Cho hàm số \( y = \dfrac{2x + 1}{x - 1} \) có đồ thị \( (C) \).}{
...
% --- CÂU 66 ---
\questionTrueFalse{0}{66}{Cho hàm số \( y = \dfrac{x^2 - 2x - 3}{x - 1} \).}{
    ...
    \textbf{c)} & Gọi \( A, B, C \) là giao điểm của đồ thị hàm số với các trục \( Ox, Oy \). Diện tích tam giác \( ABC \) bằng 6.
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{d)} & Có đúng 2 giá trị nguyên của tham số \( m \) để hàm số \( f(x) = \dfrac{x^2 - 2x - 3}{x - 1} - m^2 x \) đồng biến trên từng khoảng xác định.
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\
}

% --- CÂU 67 ---
\questionTrueFalse{0}{67}{Cho hàm số \( y = f(x) = \dfrac{x^2 + x - m}{x - 2} \), có đồ thị \( (C_m) \) (với \( m \) là tham số thực). Khi đó:}{
    \textbf{a)} & Đồ thị \( (C_m) \) luôn có hai điểm cực trị.
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{b)} & Khi \( m = 5 \) thì hàm số \( f(x) \) đồng biến trên khoảng \( (3; +\infty) \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{c)} & Hàm số \( f(x) \) nghịch biến trên \( \mathbb{R} \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{d)} & Hàm số \( f(x) \) có hai điểm cực trị khi \( m > 6 \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\
}

% --- CÂU 68 ---
\questionTrueFalse{0}{68}{Cho hàm số \( y = ax + b + \dfrac{c}{x + d} \) (\( a, b, c, d \in \mathbb{R} \)) có đồ thị như hình vẽ sau:
...
% --- CÂU 69 ---
\questionTrueFalse{0}{69}{Cho hàm số \( f(x) = -x + 4 - \dfrac{9}{x+2} \).}{
...
% --- CÂU 70 ---
\questionTrueFalse{0}{70}{Cho hàm số \( f(x) = \dfrac{x^2 + 2x - 1}{x - 1} \).}{
...
% --- CÂU 71 ---
\questionTrueFalse{0}{71}{Cho hàm số \( f(x) = \dfrac{x^2 - 3x + 3}{x - 1} \).}{
...
% --- CÂU 72 ---
\questionTrueFalse{0}{72}{Cho hàm số \( f(x) = \dfrac{x - 2}{x + 1} \).
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % 1. Hệ trục tọa độ
    \draw[->] (-5.5,0) -- (3.5,0) node[below] {\small $x$};
    \draw[->] (0,-3.5) -- (0,5.5) node[right] {\small $y$};
    \node[below left] at (0,0) {\small $O$};
     % 2. Đánh dấu các mốc
...
% --- CÂU 73 ---
\questionTrueFalse{0}{73}{Cho hàm số \( y = \dfrac{x^2 + 2x - 1}{x - 1} \) có đồ thị (C).}{
...
% --- CÂU 74 ---
\questionTrueFalse{0}{74}{Cho hàm số \( y = x - 1 + \dfrac{9}{x + 2} \).}{
    \textbf{a)} & Tập xác định của hàm số là \( \mathbb{R} \setminus \{-2\} \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
...
% --- CÂU 75 ---
\questionTrueFalse{0}{75}{Cho hàm số \( f(x) = \dfrac{ax^2 + x + b}{x + c} \) (\( a > 0 \)), có đồ thị \( C \) như hình vẽ bên dưới. Biết đường tiệm cận xiên của đồ thị \( C \) tạo với hai trục toạ độ một tam giác cân.

\begin{center}
\begin{tikzpicture}[>=latex, scale=0.4]
    % 1. Hệ trục tọa độ
    \draw[->] (-10,0) -- (4.5,0) node[below] {\small $x$};
    \draw[->] (0,-11) -- (0,8) node[right] {\small $y$};
    \node[below left] at (0,0) {\small $O$};
...
% --- CÂU 76 ---
\questionTrueFalse{0}{76}{Cho hàm số \( y = f(x) = \dfrac{a_1 x^2 + b_1 x + c_1}{a_2 x + b_2} \) có đồ thị như hình dưới đây:
...
% --- CÂU 77 ---
\questionTrueFalse{0}{77}{Cho hàm số \( y = \dfrac{-x^2 + x + 1}{x + 1} \) có đồ thị \( (C) \).}{
...
% --- CÂU 78 ---
\questionTrueFalse{0}{78}{Cho hàm số \( y = f(x) = \dfrac{x^2 + 2x - 2}{x - 1} \) có đồ thị \( (C) \).}{
...
% --- CÂU 79 ---
\questionTrueFalse{0}{79}{Cho hàm số \( y = f(x) = \dfrac{-x^2 + x - 2}{x + 1} \) có đồ thị \( (C) \). Khi đó}{
...
% --- CÂU 80 ---
\questionTrueFalse{0}{80}{Cho hàm số \( y = \dfrac{3x + 2}{x + 2} \) có đồ thị là \( (C) \). Hai điểm \( A, B \) thuộc hai nhánh của đồ thị \( (C) \).}{
...
% --- CÂU 81 ---
\questionTrueFalse{0}{81}{Cho hàm số \( y = f(x) = x + 2 + \dfrac{1}{x - 1} \).}{
...
% --- CÂU 82 ---
\questionTrueFalse{0}{82}{Cho hàm số \( f(x) = \dfrac{2x^2 + 3x - 5}{x + 3} \).}{
...
% --- CÂU 83 ---
\questionTrueFalse{0}{83}{Cho hàm số \( y = ax + b + \dfrac{c}{x + d} \) \((a, b, c, d \in \mathbb{R})\) có đồ thị như hình vẽ sau:
...
% --- CÂU 84 ---
\questionTrueFalse{0}{84}{Cho hàm số \( y = \dfrac{x^2 + 3x + 3}{x + 2} \) có đồ thị \( (C) \) và 2 điểm \( A, B \) là hai điểm cực trị của \( (C) \).}{
...
% --- CÂU 85 ---
\questionTrueFalse{0}{85}{Cho hàm số \( y = \dfrac{x^2 - 2x + 2}{x - 1} \).}{
    ...
    \begin{tikzpicture}[>=latex, scale=0.5]
        % 1. Hệ trục tọa độ
        \draw[->] (-4.5,0) -- (5,0) node[below] {\small $x$};
        \draw[->] (0,-4.5) -- (0,4.5) node[right] {\small $y$};
        \node[below right] at (0,0) {\small $O$};
...
% --- CÂU 86 ---
\questionTrueFalse{0}{86}{Cho hàm số \( y = \dfrac{x^2 + 4}{x} \).}{
...
% --- CÂU 87 ---
\questionTrueFalse{0}{87}{Cho hàm số \( y = \dfrac{x^2 - 3x + 6}{x - 1} \).
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.6]
    \draw[->] (-4.5,0) -- (6.5,0) node[below] {\small $x$};
    \draw[->] (0,-7.5) -- (0,5.5) node[right] {\small $y$};
    \node[below left] at (0,0) {\tiny $O$};
...
\end{center}
    ...
    \textbf{d)} & Đồ thị \( (C) \) của hàm số \( y = f(x) \) là hình vẽ bên.
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\
}

% --- CÂU 88 ---
\questionTrueFalse{0}{88}{Cho hàm số \( y = \dfrac{x^2 + 3x + 3}{x + 2} \) có đồ thị là \( (C) \) và hai điểm \( A, B \) là hai điểm cực trị của \( (C) \). Xét tính đúng sai của các mệnh đề sau:}{
    \textbf{a)} & Đường thẳng \( AB \) có phương trình là \( y = 2x + 1 \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{b)} & Đạo hàm của hàm số là \( y' = \dfrac{x^2 + 4x + 3}{(x + 2)^2} \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{c)} & Hai điểm \( A, B \) đối xứng nhau qua đường thẳng \( \Delta \) có phương trình \( x + 2y + 4 = 0 \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{d)} & Hai điểm \( A \) và \( B \) nằm ở hai phía trục tung.
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\
}

% --- CÂU 89 ---
\questionTrueFalse{0}{89}{Cho hàm số \( y = \dfrac{x^2 - 2x + 2}{x - 1} \).
\begin{center}
\begin{tikzpicture}[>=latex, scale=0.8]
    % 1. Hệ trục tọa độ
...
% --- CÂU 90 ---
\questionTrueFalse{0}{90}{Cho hàm số \( y = \dfrac{x^2 - x + 1}{x + 1} \) có đồ thị là \( C \). Khi đó}{
...
% --- CÂU 91 ---
\questionTrueFalse{0}{91}{Cho hàm số \( y = f(x) = \dfrac{-x^2 + x - 2}{x + 1} \) có đồ thị \( (C) \), khi đó.}{
    \textbf{a)} & \( y' = f'(x) = \dfrac{-x^2 - 2x + 3}{(x + 1)^2}, \forall x \neq -1 \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{b)} & Tiệm cận xiên của đồ thị hàm số là đường thẳng có phương trình \( y = x - 2 \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{c)} & Khoảng cách giữa hai điểm cực trị của đồ thị \( (C) \) bằng 4.
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{d)} & Trên đồ thị \( (C) \) có đúng 4 điểm \( M \) có tung độ và hoành độ là các số nguyên sao cho tiếp tuyến của \( (C) \) tại \( M \) tạo với hai đường tiệm cận của \( (C) \) một tam giác có diện tích bằng 8.
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\
}

% --- CÂU 92 ---
\questionTrueFalse{0}{92}{Cho hàm số \( y = f(x) \) có đạo hàm trên \( \mathbb{R} \setminus \{1\} \) và đồ thị như hình vẽ bên dưới.
...
\end{center}
    ...
    \textbf{a)} & Hàm số nghịch biến trên khoảng \( (-\infty; -1) \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{b)} & Hàm số đạt cực tiểu tại điểm \( x_0 = 3 \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
    
    \textbf{c)} & Tiệm cận đứng của đồ thị hàm số có phương trình là \( x = 0 \).
    & \textcolor{amberorange}{$\bigcirc$} & \textcolor{amberorange}{$\bigcirc$} \\ \hline
}

% --- CÂU 93 ---
\questionTrueFalse{0}{93}{Cho hàm số \( y = \dfrac{x^2 - x + 1}{x - 1} \).}{
...
\begin{tikzpicture}[>=latex, scale=0.6]
    ...
    \node [below right] at (1,0) {\small $1$};
    \fill (1,0) circle (2pt);
    \node [above] at (-1,-2) {\small $d$};
    \node [right] at (1,-2) {\small $l$};
\end{tikzpicture}
\end{center}
