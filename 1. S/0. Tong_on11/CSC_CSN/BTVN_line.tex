...
% --- CÂU 1 ---
\questionLinesManual{5}{1}{Cho cấp số cộng \( (u_n) \) với \( u_1 = 2 \) và công sai \( d = 3 \). Giá trị của \( u_5 \) bằng}{
    \begin{tasks}(4)
        \task $14$
        \task $17$
        \task $15$
...
% --- CÂU 2 ---
\questionLinesManual{5}{2}{Cấp số cộng \( (u_n) \) có \( u_1 = 1 \) và \( u_2 = 3 \). Số hạng \( u_5 \) của cấp số cộng là:}{
    \begin{tasks}(4)
        \task $5$
        \task $7$
        \task $9$
...
% --- CÂU 4 ---
\questionLinesManual{5}{4}{Cho cấp số nhân \( (u_n) \) với \( u_1 = 6 \) và \( u_2 = -12 \). Công bội \( q \) của cấp số nhân đã cho là}{
    \begin{tasks}(4)
        \task \( q = -\dfrac{1}{2} \)
        \task \( q = -2 \)
        \task \( q = -18 \)
...
% --- CÂU 5 ---
\questionLinesManual{5}{5}{Cho cấp số cộng có số hạng đầu \( u_1 = 3 \), công sai \( d = -4 \). Số hạng thứ năm của cấp số cộng là.}{
    \begin{tasks}(4)
        \task $768$
        \task $-13$
        \task $-3072$
...
% --- CÂU 6 ---
\questionLinesManual{5}{6}{Cho cấp số cộng \( (u_n) \), biết \( u_1 = 1 \), \( d = 2 \). Giá trị của \( u_{15} \) bằng:}{
    \begin{tasks}(4)
        \task $31$
        \task $29$
        \task $35$
...
% --- CÂU 7 ---
\questionLinesManual{5}{7}{Cho cấp số cộng \( (u_n) \) có công sai \( d = 2 \) và tổng của 25 số hạng đầu là 625. Tính \( u_5 \).}{
    \begin{tasks}(4)
        \task \( u_5 = 16 \)
        \task \( u_5 = 9 \)
        \task \( u_5 = 12 \)
...
% --- CÂU 8 ---
\questionLinesManual{5}{8}{Cho cấp số cộng \( (u_n) \) biết \( u_1 = 2 \), công sai \( d = -5 \). Tổng 10 số hạng đầu của cấp số cộng đó là}{
    \begin{tasks}(4)
        \task $-410$
        \task $-205$
        \task $245$
...
% --- CÂU 9 ---
\questionLinesManual{5}{9}{Cho cấp số nhân \( (u_n) \) có số hạng đầu \( u_1 = 2 \) và \( u_6 = 486 \). Công bội \( q \) bằng}{
    \begin{tasks}(4)
        \task \( q = 5 \)
        \task \( q = \dfrac{3}{2} \)
        \task \( q = \dfrac{2}{3} \)
...
% --- CÂU 10 ---
\questionLinesManual{5}{10}{Cho cấp số cộng \( (u_n) \) có \( u_4 = -12 \), \( u_{14} = 18 \). Tính tổng 18 số hạng đầu tiên của cấp số cộng này.}{
    \begin{tasks}(4)
        \task \( S_{18} = -72 \)
        \task \( S_{18} = 96 \)
        \task \( S_{18} = -96 \)
...
% --- CÂU 11 ---
\questionLinesManual{5}{11}{Cho cấp số cộng \( (u_n) \) có \( u_1 = -2 \) và công sai \( d = 3 \). Tìm số hạng tổng quát \( u_n \) của cấp số cộng đó.}{
    \begin{tasks}(4)
        \task \( u_n = 3n + 5 \)
        \task \( u_n = 3n - 5 \)
        \task \( u_n = 3n - 1 \)
...
% --- CÂU 12 ---
\questionLinesManual{5}{12}{Dãy số nào sau đây không phải là cấp số nhân?}{
    \begin{tasks}(4)
        \task $1; 2; 3; 4; 5$
        \task $1; 2; 4; 8; 16$
        \task $1; -1; 1; -1; 1$
...
% --- CÂU 13 ---
\questionLinesManual{5}{13}{Cho cấp số nhân \( (u_n) \) có \( u_1 = 3 \) và \( q = 2 \). Khi đó, số hạng tổng quát của cấp số nhân là}{
    \begin{tasks}(4)
...
% --- CÂU 14 ---
\questionLinesManual{5}{14}{Cho \( (u_n) \) là cấp số nhân, công bội \( q > 0 \). Biết \( u_1 = 1, u_3 = 4 \). Tìm \( u_4 \).}{
    \begin{tasks}(4)
        \task \( \dfrac{11}{2} \)
        \task $2$
        \task $16$
...
% --- CÂU 15 ---
\questionLinesManual{5}{15}{Cho một cấp số cộng \( (u_n) \) có \( u_1 = 5 \) và \( S_{50} = 5150 \). Tìm \( S_{20} \)?}{
    \begin{tasks}(4)
        \task $860$
        \task $900$
        \task $1080$
...
% --- CÂU 16 ---
\questionLinesManual{5}{16}{Cho cấp số nhân \( (u_n) \), biết \( u_1 = 2; q = 3 \) có số hạng tổng quát là:}{
    \begin{tasks}(4)
...
% --- CÂU 17 ---
\questionLinesManual{5}{17}{Cho cấp số nhân \( (u_n) \) với \( u_1 = 3, u_4 = 24 \). Tìm số hạng thứ 5 của cấp số nhân.}{
    \begin{tasks}(4)
        \task \( S_5 = 93 \)
        \task \( S_5 = -93 \)
        \task \( u_5 = 48 \)
...
% --- CÂU 18 ---
\questionLinesManual{5}{18}{Cho cấp số nhân \( (u_n) \) có số hạng đầu \( u_1 = 5 \) và công bội \( q = -2 \). Số hạng thứ sáu của \( (u_n) \) là:}{
    \begin{tasks}(4)
        \task \( u_6 = -320 \)
        \task \( u_6 = 320 \)
        \task \( u_6 = 160 \)
...
% --- CÂU 19 ---
\questionLinesManual{5}{19}{Cho cấp số nhân \( (u_n) \) biết \( u_n = 2^n, \forall n \in \mathbb{N}^* \). Tìm số hạng đầu \( u_1 \) và công bội \( q \) của cấp số nhân trên:}{
    \begin{tasks}(4)
        \task \( u_1 = 2; \, q = -2 \)
        \task \( u_1 = -2; \, q = 2 \)
        \task \( u_1 = 1; \, q = 2 \)
...
% --- CÂU 20 ---
\questionLinesManual{5}{20}{Cho cấp số nhân \( (u_n) \) có số hạng đầu \( u_1 = 5 \) và công bội \( q = -2 \). Tính \( S_6 \).}{
    \begin{tasks}(4)
        \task \( S_6 = -\dfrac{155}{3} \)
        \task \( S_6 = -\dfrac{315}{3} \)
        \task \( S_6 = -315 \)
...
% --- CÂU 21 ---
\questionLinesManual{5}{21}{Một cấp số nhân có số hạng thứ hai bằng 4 và số hạng thứ sáu bằng 64, thì số hạng tổng quát của cấp số nhân đó có thể tính theo công thức nào dưới đây}{
    \begin{tasks}(4)
        \task \( u_n = 2^{n-1} \)
        \task \( u_n = 2^n \)
        \task \( u_n = 2^{n+1} \)
...
% --- CÂU 22 ---
\questionLinesManual{5}{22}{Cho cấp số nhân \( (u_n) \) có \( u_1 = 3 \) và \( q = -4 \). Số 768 là số hạng thứ bao nhiêu của cấp số nhân đã cho?}{
    \begin{tasks}(4)
        \task Số hạng thứ 5
        \task Số hạng thứ 6
        \task Số hạng thứ 7
...
% --- CÂU 23 ---
\questionLinesManual{5}{23}{Tìm \( x \) để các số 2; 8; \( x \) theo thứ tự đó lập thành một cấp số nhân.}{
    \begin{tasks}(4)
        \task \( x = 14 \)
        \task \( x = 32 \)
        \task \( x = 64 \)
...
% --- CÂU 24 ---
\questionLinesManual{5}{24}{Cho một cấp số cộng \( (u_n) \) có số hạng tổng quát là \( u_n = 3n - 5 \). Công sai \( d \) của cấp số cộng trên là:}{
    \begin{tasks}(4)
        \task \( d = 3 \)
        \task \( d = 5 \)
        \task \( d = -5 \)
...
% --- CÂU 25 ---
\questionLinesManual{5}{25}{Cho một cấp số cộng \( (u_n) \) có số hạng thứ tự bằng \(-12\) và số hạng thứ mười bốn bằng 18. Tính tổng 16 số hạng đầu tiên của cấp số cộng \( (u_n) \).}{
    \begin{tasks}(4)
        \task $-24$
        \task $25$
        \task $26$
...
% --- CÂU 26 ---
\questionLinesManual{5}{26}{Cho một cấp số nhân \( (u_n) \) có \( u_1 = 2 \) và \( q = -3 \). Số 162 là số hạng thứ mấy của cấp số nhân đã cho?}{
    \begin{tasks}(4)
        \task Số hạng thứ 2
        \task Số hạng thứ 3
        \task Số hạng thứ 4
...
% --- CÂU 27 ---
\questionLinesManual{5}{27}{Cho một cấp số cộng có 15 số hạng, biết tổng các số hạng của cấp số cộng bằng 225, số hạng cuối bằng 29. Tìm số hạng đầu \( u_1 \) của cấp số cộng đó.}{
    \begin{tasks}(4)
        \task \( u_1 = 5 \)
        \task \( u_1 = 3 \)
        \task \( u_1 = 1 \)
...
% --- CÂU 28 ---
\questionLinesManual{5}{28}{Cho cấp số cộng có \( u_1 = 16 \), \( u_8 = 2 \). Tính \( S_8 \).}{
    \begin{tasks}(4)
        \task \( S_8 = 72 \)
        \task \( S_8 = 144 \)
        \task \( S_8 = 56 \)
...
% --- CÂU 29 ---
\questionLinesManual{5}{29}{Trong các dãy số sau, dãy số nào là cấp số nhân?}{
    \begin{tasks}(4)
...
% --- CÂU 30 ---
\questionLinesManual{5}{30}{Cho dãy số \( (u_n) \) với \( u_n = 3^n \). Số hạng \( u_{n+1} \) bằng}{
    \begin{tasks}(4)
        \task \( 3^n + 1 \)
        \task \( 3^n + 3 \)
        \task \( 3^n \cdot 3 \)
...
% --- CÂU 31 ---
\questionLinesManual{5}{31}{Các số \(-3, -9, a\) theo thứ tự đó lập thành một cấp số nhân. Khi đó \( a \) bằng bao nhiêu?}{
    \begin{tasks}(4)
        \task \( a = 27 \)
        \task \( a = -27 \)
        \task \( a = -3 \)
...
% --- CÂU 32 ---
\questionLinesManual{5}{32}{Xác định công sai của cấp số cộng sau: \( 2; 5; 8; 11; 14; \ldots \)}{
    \begin{tasks}(4)
        \task $2$
        \task $3$
        \task $5$
...
% --- CÂU 33 ---
\questionLinesManual{5}{33}{Cho cấp số nhân, có ba số hạng liên tiếp là \( x - 2 \), \( x \), \( x + 4 \). Công bội của cấp số nhân đó là?}{
    \begin{tasks}(4)
        \task $1$
        \task $2$
        \task $-1$
...
% --- CÂU 34 ---
\questionLinesManual{5}{34}{Trong các dãy số sau đây, dãy số nào là cấp số cộng?}{
    \begin{tasks}(4)
        \task \( u_n = 3n^2 + 2025 \)
        \task \( u_n = 3n + 2024 \)
        \task \( u_n = 3^n \)
...
% --- CÂU 35 ---
\questionLinesManual{5}{35}{Cho cấp số cộng \( (u_n) \) có số hạng tổng quát là \( u_n = 3n - 2 \). Tìm công sai \( d \) của cấp số cộng.}{
    \begin{tasks}(4)
        \task \( d = 3 \)
        \task \( d = 2 \)
        \task \( d = -2 \)
...
% --- CÂU 36 ---
\questionLinesManual{5}{36}{Trong các dãy số sau đây, dãy số nào là một cấp số cộng?}{
    \begin{tasks}(2)
...
% --- CÂU 37 ---
\questionLinesManual{5}{37}{Trong các dãy số \( (u_n) \) sau đây, dãy số nào là cấp số nhân?}{
    \begin{tasks}(4)
        \task \( u_n = 3n \)
        \task \( u_n = 2^n \)
        \task \( u_n = \dfrac{1}{n} \)
...
% --- CÂU 38 ---
\questionLinesManual{5}{38}{Cho cấp số nhân có các số hạng lần lượt là \( \dfrac{1}{4} \); \( \dfrac{1}{2} \); 1; ...; 2048. Tính tổng \( S \) của tất cả các số hạng của cấp số nhân đã cho.}{
    \begin{tasks}(4)
        \task \( S = 2047,75 \)
        \task \( S = 2049,75 \)
        \task \( S = 4095,75 \)
...
% --- CÂU 39 ---
\questionLinesManual{5}{39}{Cho cấp số cộng hữu hạn \( (u_n) : 3, \, a, \, 13, \, b \). Tích \( ab \) bằng}{
    \begin{tasks}(4)
        \task $144$
        \task $39$
        \task $26$
...
% --- CÂU 40 ---
\questionLinesManual{5}{40}{Biết \( x \) thỏa mãn \( x^2 - 2, \, x, \, 5 - 6x \) lập thành cấp số cộng. Tính tổng bình phương các giá trị \( x \) tìm được.}{
    \begin{tasks}(4)
        \task $12$
        \task $17$
        \task $26$
