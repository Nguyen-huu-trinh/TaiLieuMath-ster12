...
% --- CÂU 1 ---
\questionLinesManual{10}{1}{Trong các công thức sau, công thức nào sai?}{
    \begin{tasks}(2)
...
% --- CÂU 2 ---
\questionLinesManual{10}{2}{Chọn đáp án đúng.}{
    \begin{tasks}(2)
...
% --- CÂU 3 ---
\questionLinesManual{10}{3}{Phương trình \( \sin x = 1 \) có một nghiệm là}{
    \begin{tasks}(4)
        \task \( x = \pi \)
        \task \( x = -\dfrac{\pi}{2} \)
        \task \( x = \dfrac{\pi}{2} \)
...
% --- CÂU 4 ---
\questionLinesManual{10}{4}{Nghiệm của phương trình \( \cos x = -\dfrac{1}{2} \) là}{
    \begin{tasks}(2)
...
% --- CÂU 5 ---
\questionLinesManual{10}{5}{Phương trình \( \cos x = 0 \) có nghiệm là:}{
    \begin{tasks}(2)
...
% --- CÂU 6 ---
\questionLinesManual{10}{6}{Nghiệm của phương trình \( \sin \dfrac{x}{2} = 1 \) là}{
    \begin{tasks}(2)
...
% --- CÂU 7 ---
\questionLinesManual{10}{7}{Phương trình \( \cos x = \cos \dfrac{\pi}{3} \) có tất cả các nghiệm là:}{
    \begin{tasks}(2)
...
% --- CÂU 8 ---
\questionLinesManual{10}{8}{Tìm tất cả các nghiệm của phương trình \( \cos \dfrac{x}{3} = 0 \).}{
    \begin{tasks}(2)
        \task \( x = k\pi, \, k \in \mathbb{Z} \)
        \task \( x = \dfrac{\pi}{2} + k\pi, \, k \in \mathbb{Z} \)
...
% --- CÂU 9 ---
\questionLinesManual{10}{9}{Phương trình lượng giác: \( \sqrt{3} \cdot \tan x + 3 = 0 \) có nghiệm là:}{
    \begin{tasks}(4)
...
% --- CÂU 10---
\questionLinesManual{10}{10}{Phương trình \( 2\cot x - \sqrt{3} = 0 \) có nghiệm là}{
    \begin{tasks}(2)
        \task 
        \(\begin{cases} 
        x = \dfrac{\pi}{6} + k2\pi \\ 
