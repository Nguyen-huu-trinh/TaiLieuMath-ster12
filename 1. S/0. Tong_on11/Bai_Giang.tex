...
\titlebox{Chủ đề: Tổng ôn 11}{Lượng giác, cấp số cộng, cấp số nhân, hàm mũ logarit}{Tổng ôn 11}
...
% --- CÂU 2 ---
\questionLinesManual{5}{2}{Trong các dãy số sau, dãy số nào là một cấp số cộng?}{
    \begin{tasks}(4)
        \task $1; -2; -4; -6; -8$
        \task $1; -3; -6; -9; -12$
        \task $1; -3; -7; -11; -15$
...
% --- CÂU 4 ---
\questionLinesManual{5}{4}{Cho một cấp số cộng \( (u_n) \) có \( u_1 = \dfrac{1}{3} \), \( u_8 = 26 \). Tìm công sai \( d \)}{
    \begin{tasks}(4)
        \task \( d = \dfrac{11}{3} \)
        \task \( d = \dfrac{10}{3} \)
        \task \( d = \dfrac{3}{10} \)
...
% --- CÂU 5 ---
\questionLinesManual{5}{5}{Cho cấp số cộng \( (u_n) \) có \( u_1 = -2 \) và công sai \( d = 3 \). Tìm số hạng \( u_{10} \).}{
    \begin{tasks}(4)
...
% --- CÂU 6 ---
\questionLinesManual{5}{6}{Cho cấp số cộng \( (u_n) \) có \( u_1 = 1 \) và công sai \( d = 2 \). Tổng \( S_{10} = u_1 + u_2 + u_3 + \ldots + u_{10} \) bằng:}{
    \begin{tasks}(4)
        \task \( S_{10} = 110 \)
        \task \( S_{10} = 100 \)
        \task \( S_{10} = 21 \)
...
% --- CÂU 7 ---
\questionLinesManual{5}{7}{Dãy số nào sau đây \textbf{không} phải là cấp số nhân?}{
    \begin{tasks}(4)
        \task $1; 2; 4; 8; \ldots$
...
% --- CÂU 8 ---
\questionLinesManual{5}{8}{Cho cấp số nhân \( (u_n) \) có \( u_1 = -3 \) và \( q = \dfrac{2}{3} \). Mệnh đề nào sau đây đúng?}{
    \begin{tasks}(4)
        \task \( u_5 = -\dfrac{27}{16} \)
        \task \( u_5 = -\dfrac{16}{27} \)
        \task \( u_5 = \dfrac{16}{27} \)
...
% --- CÂU 9 ---
\questionLinesManual{5}{9}{Một cấp số nhân có 6 số hạng, số hạng đầu bằng 2 và số hạng thứ sáu bằng 486. Tìm công bội \( q \) của cấp số nhân đã cho.}{
    \begin{tasks}(4)
        \task \( q = 3 \)
        \task \( q = -3 \)
        \task \( q = 2 \)
...
% --- CÂU 11 ---
\questionLinesManual{5}{11}{Với \( a \) là số thực dương tùy ý, biểu thức \( a^{\frac{5}{3}} \cdot a^{\frac{1}{3}} \) là}{
    \begin{tasks}(4)
        \task \( a^5 \)
        \task \( a^{\frac{5}{9}} \)
        \task \( a^{\frac{4}{3}} \)
...
% --- CÂU 12 ---
\questionLinesManual{5}{12}{Với \( a \) là số thực dương tùy ý, \( \sqrt{a^3} \) bằng}{
    \begin{tasks}(4)
        \task \( a^6 \)
        \task \( a^{\frac{3}{2}} \)
        \task \( a^{\frac{3}{3}} \)
...
% --- CÂU 13 ---
\questionLinesManual{5}{13}{Rút gọn biểu thức \( P = x^{\frac{1}{3}} \sqrt[6]{x} \) với \( x > 0 \).}{
    \begin{tasks}(4)
        \task \( P = \sqrt{x} \)
        \task \( P = x^{\frac{1}{8}} \)
        \task \( P = x^{\frac{2}{9}} \)
...
% --- CÂU 14 ---
\questionLinesManual{5}{14}{Với mọi số thực \( a \) dương, \( \log_2 \dfrac{a}{2} \) bằng}{
    \begin{tasks}(4)
...
% --- CÂU 15 ---
\questionLinesManual{5}{15}{Với \( a \) là số thực dương tùy ý, \( 4\log \sqrt{a} \) bằng}{
    \begin{tasks}(4)
        \task \(-4\log a\)
        \task \(8\log a\)
        \task \(2\log a\)
...
% --- CÂU 16 ---
\questionLinesManual{5}{16}{Với \( a \) là số thực dương tùy ý, \( \log(100a) \) bằng}{
    \begin{tasks}(4)
        \task \(1 - \log a\)
        \task \(2 + \log a\)
        \task \(2 - \log a\)
...
% --- CÂU 17 ---
\questionLinesManual{5}{17}{Với \( a, b \) là các số thực dương tùy ý và \( a \neq 1 \), \( \log_a \left( \sqrt[3]{b} \right) \) bằng}{
    \begin{tasks}(4)
        \task \( 3 + \log_a b \)
        \task \( 3 \log_a b \)
...
% --- CÂU 20 ---
\questionLinesManual{5}{20}{Tập xác định của hàm số \( y = \log_3(x - 4) \) là}{
    \begin{tasks}(4)
        \task \( (5; +\infty) \)
        \task \( (-\infty; +\infty) \)
        \task \( (4; +\infty) \)
...
% --- CÂU 19 ---
\questionLinesManual{5}{19}{Tập xác định của hàm số \( y = 5^x \) là}{
    \begin{tasks}(4)
        \task \( \mathbb{R} \)
        \task \( (0; +\infty) \)
...
% --- CÂU 21 ---
\questionLinesManual{5}{21}{Tìm tập xác định \( D \) của hàm số \( y = \log_2 (x^2 - 2x - 3) \).}{
    \begin{tasks}(2)
...
% --- CÂU 22 ---
\questionLinesManual{5}{22}{Nghiệm của phương trình \( \log_3(5x) = 2 \) là}{
    \begin{tasks}(4)
        \task \( x = \dfrac{8}{5} \)
        \task \( x = 9 \)
        \task \( x = \dfrac{9}{5} \)
...
% --- CÂU 23 ---
\questionLinesManual{5}{23}{Nghiệm của phương trình \( \log_2(x+9) = 5 \) là}{
    \begin{tasks}(4)
        \task \( x = 41 \)
        \task \( x = 23 \)
        \task \( x = 1 \)
...
% --- CÂU 24 ---
\questionLinesManual{5}{24}{Nghiệm của phương trình \( 5^{2x-4} = 25 \) là}{
    \begin{tasks}(4)
        \task \( x = 3 \)
        \task \( x = 2 \)
        \task \( x = 1 \)
...
% --- CÂU 25 ---
\questionLinesManual{5}{25}{Nghiệm của phương trình \( 3^{x+2} = 27 \) là}{
    \begin{tasks}(4)
        \task \( x = -2 \)
        \task \( x = -1 \)
        \task \( x = 2 \)
...
% --- CÂU 27 ---
\questionLinesManual{5}{27}{Tập nghiệm \( S \) của bất phương trình \( \log_2 (2x + 3) \geq 0 \) là}{
    \begin{tasks}(4)
        \task \( S = (-\infty; -1] \)
        \task \( S = [-1; +\infty) \)
        \task \( S = (-\infty; -1) \)
...
% --- CÂU 26 ---
\questionLinesManual{5}{26}{Tập nghiệm của bất phương trình \( \log_3 (13 - x^2) \geq 2 \) là}{
    \begin{tasks}(4)
...
% --- CÂU 28 ---
\questionLinesManual{5}{28}{Tập nghiệm của bất phương trình \( 3^{x^2-13} < 27 \) là}{
    \begin{tasks}(4)
        \task \( (4; +\infty) \)
        \task \( (-4; 4) \)
        \task \( (-\infty; 4) \)
...
% --- CÂU 29 ---
\questionLinesManual{5}{29}{Tập nghiệm của bất phương trình \( 2^{x^2-1} < 8 \) là}{
    \begin{tasks}(4)
        \task \( (0; 2) \)
        \task \( (-\infty; 2) \)
        \task \( (-2; 2) \)
