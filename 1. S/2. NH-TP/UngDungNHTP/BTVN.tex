...
% --- CÂU 1 ---
\questionLinesManual{0}{1}{Cho hàm số \( y = f(x) \) xác định và liên tục trên đoạn \([a; b]\). Diện tích hình phẳng giới hạn bởi đồ thị hàm số \( y = f(x) \), trục hoành và hai đường thẳng \( x = a, \, x = b \) được tính theo công thức}{%
    \begin{tasks}(4)
...
% --- CÂU 2 ---
\questionLinesManual{0}{2}{Diện tích \( S \) của hình phẳng giới hạn bởi các đường \( y = 2x^2 \), \( y = -1 \), \( x = 0 \) và \( x = 1 \) được tính bởi công thức nào sau đây?}{%
    \begin{tasks}(4)
...
% --- CÂU 3 ---
\questionLinesManual{0}{3}{Diện tích hình phẳng giới hạn bởi hai đường \( y = x^2 - 4 \) và \( y = 2x - 4 \) bằng}{%
    \begin{tasks}(4)
        \task 36
        \task \( \dfrac{4}{3} \)
        \task \( \dfrac{4\pi}{3} \)
...
% --- CÂU 4 ---
\questionLinesManual{0}{4}{Diện tích hình phẳng giới hạn bởi hai đường \( y = x^2 - 1 \) và \( y = x - 1 \) bằng}{%
    \begin{tasks}(4)
        \task \( \dfrac{\pi}{6} \)
        \task \( \dfrac{13}{6} \)
        \task \( \dfrac{13\pi}{6} \)
...
% --- CÂU 5 ---
\questionLinesManual{0}{5}{Diện tích hình phẳng giới hạn bởi hai đường \( y = x^2 - 3 \) và \( y = x - 3 \) bằng}{%
    \begin{tasks}(4)
        \task \( \dfrac{125\pi}{6} \)
        \task \( \dfrac{1}{6} \)
        \task \( \dfrac{125}{6} \)
...
% --- CÂU 6 ---
\questionLinesManual{0}{6}{Gọi \( S \) là diện tích của hình phẳng giới hạn bởi các đường \( y = 2^x \), \( y = 0 \), \( x = 0 \), \( x = 2 \). Mệnh đề nào dưới đây đúng?}{%
    \begin{tasks}(4)
...
% --- CÂU 7 ---
\questionLinesManual{0}{7}{Gọi \( S \) là diện tích hình phẳng giới hạn bởi các đường \( y = e^x \), \( y = 0 \), \( x = 0 \), \( x = 2 \). Mệnh đề nào dưới đây đúng?}{%
    \begin{tasks}(4)
...
% --- CÂU 8 ---
\questionLinesManual{0}{8}{Cho hàm số \( y = f(x) \) liên tục trên \( \mathbb{R} \). Gọi \( S \) là diện tích hình phẳng giới hạn bởi các đường \( y = f(x), y = 0, x = -1 \) và \( x = 5 \) (như hình vẽ bên).
...
% --- CÂU 9 ---
\questionLinesManual{0}{9}{Cho hàm số \( f(x) \) liên tục trên \( \mathbb{R} \). Gọi S là diện tích hình phẳng giới hạn bởi các đường \( y = f(x), y = 0, x = -1, x = 2 \) (như hình vẽ bên). Mệnh đề nào dưới đây đúng?
...
% --- CÂU 10 ---
\questionLinesManual{0}{10}{Gọi \( S \) là diện tích hình phẳng \( (H) \) giới hạn bởi các đường \( y = f(x) \), trục hoành và hai đường thẳng \( x = -1, \, x = 2 \). Đặt  
...
% --- CÂU 11 ---
\questionLinesManual{0}{11}{Diện tích phần hình phẳng gạch chéo trong hình vẽ bên được tính theo công thức nào dưới đây?
...
% --- CÂU 12 ---
\questionLinesManual{0}{12}{Gọi \( S \) là diện tích hình phẳng giới hạn bởi đồ thị hàm số \( y = f(x) \), trục hoành, đường thẳng \( x = a, x = b \) (như hình vẽ bên). Hỏi cách tính \( S \) nào dưới đây đúng?
...
% --- CÂU 13 ---
\questionLinesManual{0}{13}{Cho hàm số \( y = f(x) \) liên tục trên đoạn \([a; b]\). Gọi \( D \) là diện tích hình phẳng giới hạn bởi đồ thị \( (C) : y = f(x) \), trục hoành, hai đường thẳng \( x = a \), \( x = b \) (như hình vẽ dưới đây). Giả sử \( S_D \) là diện tích hình phẳng \( D \). Đúng trong các phương án A, B, C, D cho dưới đây?
...
% --- CÂU 14 ---
\questionLinesManual{0}{14}{Diện tích hình phẳng giới hạn bởi đồ thị hàm số \( y = (x - 2)^2 - 1 \), trục hoành và hai đường thẳng \( x = 1, x = 2 \) bằng}{%
    \begin{tasks}(4)
        \task \( \dfrac{2}{3} \)
        \task \( \dfrac{3}{2} \)
        \task \( \dfrac{1}{3} \)
...
% --- CÂU 15 ---
\questionLinesManual{0}{15}{Cho hai hàm số \( f(x) \) và \( g(x) \) liên tục trên \([a; b]\). Diện tích hình phẳng giới hạn bởi đồ thị của các hàm số \( y = f(x) \), \( y = g(x) \) và các đường thẳng \( x = a \), \( x = b \) bằng}{%
    \begin{tasks}(4)
...
% --- CÂU 16 ---
\questionLinesManual{0}{16}{Tính diện tích hình phẳng giới hạn bởi đồ thị hàm số \( y = 4x - x^2 \) và trục \( Ox \).}{%
    \begin{tasks}(4)
        \task 11
        \task \( \dfrac{34}{3} \)
        \task \( \dfrac{31}{3} \)
...
% --- CÂU 17 ---
\questionLinesManual{0}{17}{Diện tích của hình phẳng được giới hạn bởi đồ thị hàm số \( y = f(x) \), trục hoành và hai đường thẳng \( x = a \), \( x = b \) (\( a < b \)) (phần tô đậm trong hình vẽ) tính theo công thức nào dưới đây?
...
% --- CÂU 18 ---
\questionLinesManual{0}{18}{Gọi diện tích hình phẳng giới hạn bởi đồ thị hàm số  
\[(C): y = \frac{-3x - 1}{x - 1}\]
...
% --- CÂU 19 ---
\questionLinesManual{0}{19}{Diện tích hình phẳng giới hạn bởi \( y = x^2; y = 0; x = 1; x = 2 \) bằng}{%
    \begin{tasks}(4)
        \task \( \dfrac{4}{3} \)
        \task \( \dfrac{7}{3} \)
        \task \( \dfrac{8}{3} \)
...
% --- CÂU 20 ---
\questionLinesManual{0}{20}{Gọi \( S \) là diện tích hình phẳng giới hạn bởi đồ thị của hàm số  
\[(H): y = \frac{x - 1}{x + 1}\]
...
% --- CÂU 21 ---
\questionLinesManual{0}{21}{Diện tích hình phẳng giới hạn bởi hai đồ thị hàm số \( y = x^3 \), \( y = x^2 - 4x + 4 \) và trục \( Ox \) (tham khảo hình vẽ) được tính theo công thức nào dưới đây?
...
% --- CÂU 22 ---
\questionLinesManual{0}{22}{Viết công thức tính thể tích \( V \) của khối tròn xoay được tạo ra khi quay hình thang cong, giới hạn bởi đồ thị hàm số \( y = f(x) \), trục \( Ox \) và hai đường thẳng \( x = a, x = b (a < b) \), xung quanh trục \( Ox \).}{%
    \begin{tasks}(4)
...
% --- CÂU 23 ---
\questionLinesManual{0}{23}{Cho hàm số \( y = f(x) \) liên tục trên đoạn \([a; b]\). Gọi \( D \) là hình phẳng giới hạn bởi đồ thị hàm số \( y = f(x) \), trục hoành và hai đường thẳng \( x = a, x = b (a < b) \). Thể tích của khối tròn xoay tạo thành khi quay \( D \) quanh trục hoành được tính theo công thức:}{%
    \begin{tasks}(4)
        \task \( \displaystyle V = \pi \int_a^b f(x) dx \)
        \task \( \displaystyle V = \pi \int_a^b f^2(x) dx \)
...
% --- CÂU 24 ---
\questionLinesManual{0}{24}{Gọi \( D \) là hình phẳng giới hạn bởi các đường \( y = e^{3x}, y = 0, x = 0 \) và \( x = 1 \). Thể tích của khối tròn xoay tạo thành khi quay \( D \) quanh trục \( Ox \) bằng:}{%
    \begin{tasks}(4)
...
% --- CÂU 25 ---
\questionLinesManual{0}{25}{Gọi \( D \) là hình phẳng giới hạn bởi các đường \( y = e^{4x}, y = 0, x = 0 \) và \( x = 1 \). Thể tích của khối tròn xoay tạo thành khi quay \( D \) quanh trục \( Ox \) bằng:}{%
    \begin{tasks}(4)
...
% --- CÂU 26 ---
\questionLinesManual{0}{26}{Cho hình phẳng \( (H) \) giới hạn bởi các đường \( y = x^2 + 3 \), \( y = 0 \), \( x = 0 \), \( x = 2 \).  
...
% --- CÂU 27 ---
\questionLinesManual{0}{27}{Cho hình phẳng \( D \) giới hạn bởi đường cong \( y = e^x \), trục hoành và các đường thẳng \( x = 0 \), \( x = 1 \). Khối tròn xoay tạo thành khi quay \( D \) quanh trục hoành có thể tích \( V \) bằng bao nhiêu?}{%
    \begin{tasks}(4)
...
% --- CÂU 28 ---
\questionLinesManual{0}{28}{Cho hình phẳng \( D \) giới hạn với đường cong \( y = \sqrt{x^2 + 1} \), trục hoành và các đường thẳng \( x = 0 \), \( x = 1 \). Khối tròn xoay tạo thành khi quay \( D \) quanh trục hoành có thể tích \( V \) bằng bao nhiêu?}{%
    \begin{tasks}(4)
...
% --- CÂU 29 ---
\questionLinesManual{0}{29}{Tính thể tích V của phần vật thể giới hạn bởi hai mặt phẳng \( x = 1 \) và \( x = 3 \), biết rằng khi cắt vật thể bởi mặt phẳng vuông góc với trục \( Ox \) tại điểm có hoành độ \( x \) (\( 1 \leq x \leq 3 \)) thì được thiết diện là một hình chữ nhật có độ dài hai cạnh là \( 3x \) và \( \sqrt{3x^2 - 2} \).}{%
    \begin{tasks}(4)
        \task \( V = \dfrac{124}{3} \)
...
% --- CÂU 30 ---
\questionLinesManual{0}{30}{Tìm công thức tính thể tích của khối tròn xoay khi cho hình phẳng giới hạn bởi parabol  
...
% --- CÂU 31 ---
\questionLinesManual{0}{31}{Khi cắt vật thể bởi mặt phẳng vuông góc với trục \( Ox \) tại điểm có hoành độ là \( x \), \( (0 \leq x \leq 3) \) ta được mặt cắt là một hình vuông có cạnh là \( \sqrt{9 - x^2} \) (được mô hình hóa bởi hình vẽ bên dưới). Thể tích của vật thể đó bằng
...
% --- CÂU 32 ---
\questionLinesManual{0}{32}{Tính thể tích \( V \) của vật thể giới hạn bởi hai mặt phẳng \( x = 0 \) và \( x = 1 \), biết rằng khi cắt vật thể bởi mặt phẳng tùy ý vuông góc với trục \( Ox \) tại điểm có hoành độ \( x(0 \leq x \leq 1) \) thì được thiết diện là hình vuông có cạnh bằng \( (x + 1) \).}{%
    \begin{tasks}(4)
        \task \( V = \dfrac{3\pi}{2} \)
        \task \( V = \dfrac{7\pi}{3} \)
        \task \( V = \dfrac{7}{3} \)
...
% --- CÂU 33 ---
\questionLinesManual{0}{33}{Cho phần vật thể \( (T) \) giới hạn bởi hai mặt phẳng có phương trình \( x = 0 \) và \( x = 2 \). Cắt phần vật thể \( (T) \) bởi mặt phẳng vuông góc với trục \( Ox \) tại điểm có hoành độ \( x(0 \leq x \leq 2) \), ta được thiết diện là một tam giác đều có độ dài cạnh bằng \( x\sqrt{2 - x} \). Tính thể tích \( V \) của phần vật thể \( (T) \).}{%
    \begin{tasks}(4)
...
% --- CÂU 34 ---
\questionLinesManual{0}{34}{Gọi \( S \) là diện tích của hình phẳng giới hạn bởi các đường \( y = 2x^2 + 3x - 5 \), \( y = 0 \), \( x = -2 \), \( x = 3 \). Mệnh đề nào dưới đây đúng?}{%
    \begin{tasks}(4)
...
% --- CÂU 35 ---
\questionLinesManual{0}{35}{Cho hình phẳng \( (H) \) giới hạn bởi các đường \( y = -x^2 + 1 \), \( y = 0 \), \( x = -2 \), \( x = 3 \). Gọi \( V \) là thể tích của khối tròn xoay được tạo thành khi quay \( (H) \) xung quanh trục \( Ox \). Mệnh đề nào dưới đây đúng?}{%
    \begin{tasks}(4)
...
% --- CÂU 36 ---
\questionLinesManual{0}{36}{Trong hệ trục tọa độ \( Oxy \), diện tích \( S \) của hình phẳng giới hạn bởi đồ thị hàm số \( y = f(x) \), \( f(x) \geq 0, \, \forall x \in [0; 2] \), trục \( Ox, Oy \), đường thẳng \( x = 2 \) là \( 3 \). Tính \( \displaystyle\int_{0}^{2} f(x) dx \).}{%
    \begin{tasks}(4)
        \task \( 9\pi \)
        \task \( 3\pi \)
        \task \( 3 \)
...
% --- CÂU 37 ---
\questionLinesManual{0}{37}{Tính diện tích \( S \) của hình phẳng giới hạn bởi đồ thị hàm số \( y = x^3 - 2 \), trục hoành, trục tung và đường thẳng \( x = 1 \)?}{%
    \begin{tasks}(4)
...
% --- CÂU 38 ---
\questionLinesManual{0}{38}{Cho hình phẳng giới hạn bởi các đường \( y = 1 - \sqrt{x} \), trục hoành và \( x = 9 \) quay xung quanh trục \( Ox \). Tính thể tích khối tròn xoay tạo thành.}{%
    \begin{tasks}(4)
        \task \( V = \dfrac{27\pi}{2} \)
        \task \( V = 13\pi \)
        \task \( V = \dfrac{41\pi}{3} \)
...
% --- CÂU 39 ---
\questionLinesManual{0}{39}{Gọi \( (H) \) là hình phẳng giới hạn bởi hàm số \( y = \sqrt{x+1} \), trục hoành và các đường thẳng \( x = -1, x = 2 \). Thể tích \( V \) của khối tròn xoay tạo thành khi quay \( (H) \) xung quanh trục \( Ox \) được tính bởi công thức nào dưới đây?}{%
    \begin{tasks}(4)
...
% --- CÂU 40 ---
\questionLinesManual{0}{40}{Cho \( (H) \) là hình phẳng giới hạn bởi parabol \( y = \sqrt{3}x^2 \), cung tròn có phương trình \( y = \sqrt{4 - x^2} \) (với \( 0 \le x \le 2 \)) và trục hoành (phần tô đậm trong hình vẽ). Diện tích của \( (H) \) bằng
...
% --- CÂU 41 ---
\questionLinesManual{0}{41}{Diện tích hình phẳng giới hạn bởi đường cong \( y = x \ln x \), trục hoành và đường thẳng \( x = e \) là}{%
    \begin{tasks}(4)
        \task \( \dfrac{e^2 - 1}{2} \)
        \task \( \dfrac{e^2 + 1}{2} \)
        \task \( \dfrac{e^2 - 1}{4} \)
...
% --- CÂU 42 ---
\questionLinesManual{0}{42}{Tính diện tích \( S \) của hình phẳng \( (H) \) giới hạn bởi các đường cong \( y = -x^3 + 12x \) và \( y = -x^2 \).}{%
    \begin{tasks}(4)
        \task \( S = \dfrac{937}{12} \)
        \task \( S = \dfrac{343}{12} \)
        \task \( S = \dfrac{793}{4} \)
...
% --- CÂU 43 ---
\questionLinesManual{0}{43}{Cho hình phẳng \( (H) \) giới hạn bởi parabol \( y = \dfrac{x^2}{12} \) và đường cong có phương trình \( y = \sqrt{4 - \dfrac{x^2}{4}} \) (tham khảo hình vẽ bên)
...
% --- CÂU 44 ---
\questionLinesManual{0}{44}{Gọi \( V \) là thể tích khối tròn xoay tạo thành do quay xung quanh trục hoành một elip có phương trình  
...
% --- CÂU 45 ---
\questionLinesManual{0}{45}{Hình vuông \( OABC \) có cạnh bằng 4 được chia thành hai phần bởi đường cong \( (C) \) có phương trình  
\(y = \dfrac{1}{4}x^2.\)
...
% --- CÂU 46 ---
\questionShortAnswer{0}{46}{Gọi \( (H) \) là phần hình phẳng giới hạn bởi đồ thị \( (C) \) của hàm số đa thức bậc ba với đồ thị \( (P) \) của hàm số bậc hai (phần tô đậm) như hình vẽ bên. Tính diện tích của hình phẳng \( (H) \).
...
\questionShortAnswer{0}{47}{Cho khối tròn xoay như Hình. Tính thể tích của khối tròn xoay được tạo thành bởi hình phẳng cho ở Hình khi quay quanh trục \( Ox \) (viết kết quả dưới dạng số thập phân và làm tròn đến hàng phần mười).
...
\questionShortAnswer{0}{48}{Một khối bê tông cao 2 m được đặt trên mặt đất phẳng. Nếu cắt khối bê tông này bằng mặt phẳng nằm ngang, cách mặt đất \( x(m) \) (\(0 \le x \le 2\)) thì được mặt cắt là hình chữ nhật có chiều dài 5 m, chiều rộng \( (0,5)^x(m) \) (Hình). Tính thể tích của khối bê tông (kết quả làm tròn đến hàng phần trăm của mét khối).
\begin{figure}[htbp]
    \centering
...
\questionShortAnswer{0}{50}{Cho hàm số \( y = x^2 - 2x \) có đồ thị \((C)\). Kí hiệu \( A \) là hình phẳng giới hạn bởi \((C)\), trục hoành và hai đường thẳng \( x = 0, x = 2; B \) là hình phẳng giới hạn bởi \((C)\), trục hoành và hai đường thẳng \( x = 2, x = a (a > 2) \). Tìm giá trị của \( a \) để \( A \) và \( B \) có diện tích bằng nhau.
